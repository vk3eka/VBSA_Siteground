...
<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table align="center" cellpadding="5" cellspacing="5">
    <tr>
        <td align="left" class="red_bold">Update an Email Link </td>
      ...
      <tr>
        <td colspan="2" align="left" class="red_bold">Event ID number - <?php echo $eventID; ?> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" nowrap="nowrap">Email title:</td>
        <td nowrap="nowrap"><input name="attach_name" type="text" id="attach_name" value="<?php echo $row_upload['attach_name']; ?>" size="35" />          
        eg Email the VBSA (Max 35 characters)</td>
      </tr>
      <tr>
        <td align="right" nowrap="nowrap">Email Address</td>
        <td><input name="Attachment" type="text" id="Attachment" value="<?php echo $row_upload['Attachment']; ?>" size="40" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><input type="submit" name="button" id="button" value="Update Email Link" /></td>
      </tr>
    </table>
