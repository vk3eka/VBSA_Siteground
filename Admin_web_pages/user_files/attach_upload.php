...
$targetDir = "../../Front_page_upload/";
//$targetDir = "../../test_Front_page_upload/";
if (!is_dir($targetDir)) {
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $imageFile = $_FILES['up_pdf_name'];
  $fileName = basename($imageFile['name']);
  $targetFilePath = $targetDir . $fileName;
  //$targetFilePath = $fileName;

  //echo("Target " . $targetFilePath . "<br>");
  // Validate file type
  ...
  {
    //echo("Allowed " . $fileType . "<br>");
    // Move uploaded file to target directory
    //echo("Target " . $targetFilePath . "<br>");
    //echo("Temp " . $imageFile['tmp_name'] . "<br>");
...
<!--<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="checkFileUpload(this,'pdf,doc,docx',false,'','','','','','','');return document.MM_returnValue">-->
  <table align="center" width="800">
    ...
    <tr>
      <td class="red_text">After uploading a link to the attachment using the &quot;Attachment title&quot;, the title will appear at the bottom of the page</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
  ...
  <table align="center" width="800">
    ...
    <tr valign="baseline">
      ...
      <td><input name="up_pdf_name" type="file" id="up_pdf_name" /></td>
