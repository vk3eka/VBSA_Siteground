...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" class="greenbg">
  ...
  <table align="center" width="800">
    ...
    <tr>
      <td class="red_bold" nowrap="nowrap">From this page you may create an Email link</td>
    </tr>
    <tr>
      <td class="red_bold"><span class="red_text">After creating the link the &quot;Email title&quot; will appear at the bottom of the page as a link to the email address</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
  ...
  <table align="center" width="800">
    ...
    <tr valign="baseline">
      <td colspan="2" align="left" nowrap="nowrap" class="red_bold">Create an email link for: <?php echo $row_item['Header']; ?></td>
    </tr>
    <tr valign="baseline">
      <td colspan="2" align="left" nowrap="nowrap" class="red_text">Please create a brief title for your email link (Max 35 characters)</td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Email title:</td>
      <td><input type="text" name="up_desc" value="" size="32" />
        eg Email the VBSA</td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Email address:</td>
      <td><input type="text" name="up_pdf_name" value="" size="60" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <p>
    ...
    <input type="hidden" name="up_type" value="Email" />
