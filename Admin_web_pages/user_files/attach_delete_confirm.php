...
<form id="form1" name="form1" method="post" action="">
  <table align="center">
    ...
    <tr>
      <td colspan="2" align="center" class="red_bold">IF YOU PROCEED THIS ATTACHMENT WILL BE PERMANENTLY DELETED FROM THE DATABASE</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="greenbg"><a href="attach_delete.php?up_id=<?php echo $up_id; ?>&item_id=<?PHP echo $item_id; ?>">Yes</a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
