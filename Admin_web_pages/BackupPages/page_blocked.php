...
$query_page_items = "SELECT webpage_items.ID, Header, Comment,`By`, created_on, updated, MAX(upload_on) AS caldate, MAX(up_on) AS FPdate, item_image, event_id, page_front, img_size, OrderFP, OrderRef, OrderJunior, OrderHelp, OrderWomens, OrderRefProfile, OrderRefPoser, OrderPlayerProfile, OrderScores, OrderPolProc, OrderAbout FROM webpage_items LEFT JOIN calendar_attach ON event_number=event_id LEFT JOIN webpage_attach ON item_id = webpage_items.ID WHERE webpage_items.blocked='Yes' GROUP BY webpage_items.ID ORDER BY Header";
...
<table width="1000" align="center">
  <tr>
    <td colspan="3" align="center" class="red_bold">All &quot;Blocked&quot; items - Ordered by Title, alphabetically (these items will not appear on the website)</td>
  </tr>
  <tr>
