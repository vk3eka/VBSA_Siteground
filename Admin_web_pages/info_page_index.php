...
$MM_authorizedUsers = "Webmaster,Treasurer,Administrator,Boardmember,Secretary,Scores,VBSA";
...
$query_page_items = "SELECT webpage_items.ID, Header, Comment,`By`, created_on, updated, MAX(upload_on) AS caldate, MAX(up_on) AS FPdate, item_image, OrderFP, OrderRef, OrderJunior, OrderHelp, OrderWomens, OrderRefProfile, OrderRefPoser, OrderPlayerProfile, OrderAbout, event_id, page_front, page_referee, page_junior, page_help, page_womens, page_refprofile, page_refposer,  page_playerprofile, page_about, page_scores, OrderScores, img_size FROM webpage_items LEFT JOIN calendar_attach ON event_number=event_id LEFT JOIN webpage_attach ON item_id = webpage_items.ID WHERE webpage_items.blocked='No' AND webpage_items.page_about='Y' GROUP BY webpage_items.ID ORDER BY OrderAbout, created_on DESC";
...
<table width="1000" align="center">
  <tr>
    <td colspan="3" align="center" class="red_bold">VBSA About - All items</td>
  </tr>
  <tr>
...
<div class="webpage_content">
  ...
  <!--Open News Item Repeat  - includes table at right of page-->
    ...
    <div class="News_item">
        ...
        <img src="http://vbsa.org.au/../images_frontpage/<?php echo $row_page_items['item_image']; ?>" width="<?php echo $row_page_items['img_size']; ?>" style="float:right; padding:10px" />
        <?php  }  ?>
