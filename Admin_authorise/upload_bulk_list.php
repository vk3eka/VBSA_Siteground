...
else
{
    ...
    echo("<table width='1000' border='0' align='center' cellpadding='8' cellspacing='0'>");
    echo("<tr>");
    echo("<td class='red_bold'>Bulk upload fo team captians list (spreadsheet)</td>");
    echo("<td align='right'><input type='button' value='Return to previous page' onclick='history.go(-1)'/></td>");
    echo("</tr>");
    echo("</table>");

    echo("<table border='0' align='center' cellpadding='0' cellspacing='0'>");
    echo("<tr>");
    echo("<td align=center><h2>Bulk Upload Team Captains from Spreadsheet</h2></td>");
    echo("</tr>");
    echo("<tr>");
