...
include ("../Admin_authorise/header_no_login.php");
...
elseif((isset($_POST['buttonname'])) and ($_POST['buttonname'] = 'Submit'))
{
  ...
  if($num_authorise > 0)
  {
    ...
    if(($_GET['forgot'] == 'password') or ($_POST['forgotwhat'] == 'password'))
    {
      ...
      $message .= "<p>Click <a href='https://vbsa.org.au/'>here </a>to access the VBSA Administrator Portal.</p>";
      $message .= "<p>Thanks.</p>";
      ...
      $message .= "<p><i>Direct all emails to <a href='mailto:webs@vbsa.org.au'>web@vbsa.org.au</a></i></p>";
 ...
 ?>
  ...
  <table width="400" border="0" cellspacing="10" cellpadding="0">
    ...
    <tr>
      <td align="center" colspan="2">&<a class='greenbg' href="" onClick="LogOutButton();">Return to LogIn</a></td>
    </tr>    
  </table>
  <?php
    if($email_caption == 'Your request has been sent to your registered email address. You will be redirected. to the login page.')
    {
      echo("<script>");
      echo("window.location='VBSA_Admin_Login.php'");
      echo("</script>");
    }
  ?>
  </form>   
