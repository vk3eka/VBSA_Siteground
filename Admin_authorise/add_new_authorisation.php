...
<form name="authorise" method="post" action="../Admin_authorise/add_new_authorisation.php">
...
<table border="0" align="center" cellpadding="2" class="greenbg">
    <tr>
        <td colspan=7 align=center><h3>Authorisation</h3></td>
    </tr>
    <tr>
        <td>
            ...
            <br />
            <div align='center'>
                <a class='greenbg' href="" onclick="GetPW();">Generate Password</a>
                <a class='greenbg' href="" onclick="SaveButton();">Save Record Only</a>
                <a class='greenbg' href="" onclick="SaveEmailButton();">Save Record & Email User</a>
            </div>
        </td>                  
    </tr>
</table>
