...
$query_Clubs = "SELECT * FROM clubs WHERE Club_Aff_Assoc = 'Club' AND clubs.CityClubTeam=1 AND inactive=1 ORDER BY ClubTitle ASC";
...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Victorian Club Directory - City Clubs  </div>
  </div>  	
