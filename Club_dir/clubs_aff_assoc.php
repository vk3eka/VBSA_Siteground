...
$query_Clubs = "SELECT * FROM clubs WHERE clubs.Club_Aff_Assoc='Association' AND inactive=1 ORDER BY ClubTitle ASC";
...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Victorian Club Directory - Affiliates & Associations  </div>
  </div>  	
...
<?php do { ?>
   ...
   <div class="table-responsive center-block" style="max-width:600px; margin-top:10px; clear:both"> <!-- class table-responsive -->
   <table class="table no-border">
  		<thead>
   		...
   		<tbody>    
    		<tr>
      			<td>Phone: <a href="tel:<?php echo $row_Clubs['ClubPhone1']; ?>"><?php echo $row_Clubs['ClubPhone1']; ?></td>
      			<td rowspan="4"><img src="http://www.vbsa.org.au/ClubImages/<?php echo $row_Clubs['ClubLogo']; ?>" class="img-responsive pull-right" style="max-height:120px" /></td>
      		</tr>
    		<tr>
    		...
    		<tr>
      			<td>Web Address: 
                <?php if(isset($row_Clubs['ClubLink'])) { ?>
                <a href="<?php echo $row_Clubs['ClubLink']; ?>" target="_blank"><?php echo $row_Clubs['ClubLink']; ?></a></td>
                <?php } else { ?>
                <a href="<?php echo $row_Clubs['aff_URL']; ?>" target="_blank"><?php echo $row_Clubs['aff_URL']; ?></a></td>
                <?php } ?>
     		</tr>
    	</tbody>
   </table>
