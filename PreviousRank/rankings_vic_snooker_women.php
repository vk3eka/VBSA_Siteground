...
rank_S_womens.ranknum, 
rank_S_womens.previous_rank    
FROM rank_aa_snooker_master 
LEFT JOIN members T1 ON T1.MemberID = rank_aa_snooker_master.memb_id 
LEFT JOIN rank_S_womens ON rank_S_womens.memb_id = T1.MemberID 
where Gender = 'Female' ORDER BY (weekly_percent+total_tourn) DESC";
...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Victorian Rankings - Snooker (Womens)</div>
  </div>  	
   ...
   <table class="table">
      ...
      <?php 
        ...
        do { 
          ...
          {
            $query_Previous = "Select previous_rank, memb_id, total_rp, date_format(last_update,'%D %b %Y') AS last_update FROM temp_womens_snooker_ranking Where memb_id = " . $row_RPall['memb_id'];
        ...
        <tr>
          ...
          <td class="text-center" nowrap="nowrap"><a href="rankings_vic_snooker_detail.php?rank=<?php echo $row_RPall['memb_id']; ?>&cohort=woman">How awarded</a></td>
        </tr>
        <?php }
