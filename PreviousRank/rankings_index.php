  ...
  <table class="table">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="../pdfjs/web/viewer.html?file=<?= $url ?>/Rankings/files/<?= $row_rank_snooker['rank_exp_pdf'] ?>" title="View"><span class="glyphicon glyphicon-eye-open"></span></a></td>
        <!--<td><a href="../pdfjs/web/viewer.html?file=<?= $url ?>/Rankings/files/<?= $row_rank_snooker['rank_exp_pdf'] ?>" title="Download"><span class="glyphicon glyphicon-download"></span></a></td>-->
        <td><a href="../Rankings/files/<?php echo $row_rank_snooker['rank_exp_pdf']; ?>" title="Download"><span class="glyphicon glyphicon-download"></a></td>
      </tr>
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="../pdfjs/web/viewer.html?file=<?= $url ?>/Rankings/files/<?= $row_rank_bill['rank_exp_pdf'] ?>" title="View"><span class="glyphicon glyphicon-eye-open"></span></a></td>
        <!--<td><a href="../pdfjs/web/viewer.html?file=<?= $url ?>/Rankings/files/<?= $row_rank_bill['rank_exp_pdf'] ?>" title="Download"><span class="glyphicon glyphicon-download"></span></a></td>-->
        <td><a href="../Rankings/files/<?php echo $row_rank_bill['rank_exp_pdf']; ?>" title="Download"><span class="glyphicon glyphicon-download"></a></td>
