...
if (!function_exists("GetSQLValueString")) {
  ...
  rank_a_billiards_master.memb_id, FirstName, LastName, junior, Female,
  rank_B_womens.ranknum, 
  rank_B_womens.previous_rank   
  FROM rank_a_billiards_master 
  LEFT JOIN members T1 ON T1.MemberID = rank_a_billiards_master.memb_id 
  LEFT JOIN rank_B_womens ON rank_B_womens.memb_id = T1.MemberID 
  where Gender = 'Female' ORDER BY total_rp DESC";

/*$query_RPall = "Select total_rp, memb_id, ranknum, previous_rank, FirstName, LastName, Female FROM rank_B_womens
LEFT JOIN members ON members.MemberID = rank_B_womens.memb_id Where Gender = 'Female'
...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Victorian Rankings - Billiards (Womens)</div>
  </div>  	
...
<div class="table-responsive center-block" style="max-width:250px" > 
  ...
  <tr>
    <td><form id="RP_sname" name="RP_sname" method="get" action="rankings_vic_billiards_name_srch_res.php">
        ...
        <input type='hidden' name='cohort' id='cohort' value='woman'>
   ...
   <table class="table">
      ...
      <?php 
        ...
        { 
          ...
          if($row_RPall['total_rp'] > 0)
          {
            $query_Previous = "Select previous_rank, memb_id, total_rp, date_format(last_update,'%D %b %Y') AS last_update FROM temp_womens_billiards_ranking Where memb_id = " . $row_RPall['memb_id'];
          ...
          ?>
            <tr>
              ...
              <td class="text-center"><?php echo $row_RPall['previous_rank']; ?></td>
              ...
              <td class="text-center" nowrap="nowrap"><a href="rankings_vic_billiards_detail.php?rank=<?php echo $row_RPall['memb_id']; ?>&cohort=woman">How awarded</a></td>
            </tr>
        <?php 
          }
