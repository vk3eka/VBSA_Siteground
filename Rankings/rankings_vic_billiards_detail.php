...
//echo("RP curr year " . $query_rp_curr . "<br>");
...
//echo("Season 1 Breaks Current " . $query_brks_S1curr . "<br>");
...
//echo("Season 2, 2 year, breaks " . $query_brks_S2_2yr . "<br>");
...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Victorian Rankings - Billiards <?= $title ?>, Player detail</div>
  </div>  	
...
//$total_tourn_points = Round(ROUND($row_rp_curr['rank_pts'])+(ROUND($row_rp_1yr['rank_pts']*65/100))+(ROUND($row_rp_2yr['rank_pts']*35/100)));
...
//echo("Total Breaks RP = " . $total_break_points . "<br>");

$total_points = Round($total_ranking_points+$total_break_points);

//echo("Totals (Pennant+Break) = " . $total_points . "<br>");
?>
<div class="table-responsive center-block" style="max-width:600px" > 
    ...
    <tr>
      <td class="text-center"> Total Points =  <strong><?php echo ($row_RPall['total_rp']); ?></strong></td>
    </tr>
  </table>
</div>
<div class="table-responsive center-block" style="max-width:600px" > 
...
<table class="table">
    <tr>
    	<td class="text-right"><span class="italic">Total Tournament Ranking Points</span> &nbsp;&nbsp;&nbsp; <strong><?php echo ($row_RPall['total_rp']-$total_points); ?></strong></td>
    </tr>
</table>
</div>
...
<div class="table-responsive center-block" style="max-width:600px" > 
	<table class="table">
        ...
        <tr>
          ...
          <td class="text-center"><?php echo ($row_brks_S1_1yr['brks_1yr_S1']/.65); ?></td>
          <td class="text-center">x</td>
          <td class="text-center">65%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_brks_S1_1yr['brks_1yr_S1'])) echo round($row_brks_S1_1yr['brks_1yr_S1']); else echo "0"; ?></td>
        </tr>
        <tr>
          <td><span class="red_bold"><?php echo date("Y", strtotime(date("Y-m-d")." -1 year")); ?></span> - S2 Best total Ranking Points </td>
          <td class="text-center"><?php if(isset($row_S2_1year['total_RP'])) echo ($row_S2_1year['total_RP']); else echo "0"; ?></td>
          <td class="text-center">x</td>
          <td class="text-center">65%</td>
          <td class="text-center">=</td>
        ...
        <tr>
          <td><span class="red_bold"><?php echo date("Y", strtotime(date("Y-m-d")." -1 year")); ?></span> - S2 Breaks Points</td>
          <td class="text-center"><?php echo ($row_brks_S2_1yr['brks_1yr_S2']/.65); ?></td>
          <td class="text-center">x</td>
          <td class="text-center">65%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_brks_S2_1yr['brks_1yr_S2'])) echo round($row_brks_S2_1yr['brks_1yr_S2']); else echo "0"; ?></td>
        </tr>
        <!-- year-2 -->
        <tr>
        ...
        <tr>
          ...
          <td class="text-center"><?php echo ($row_brks_S1_2yr['brks_2yr_S1']/.35); ?></td>
          <td class="text-center">x</td>
          <td class="text-center">35%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_brks_S1_2yr['brks_2yr_S1'])) echo round($row_brks_S1_2yr['brks_2yr_S1']); else echo "0"; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="text-center"><?php echo ($row_brks_S2_2yr['brks_2yr_S2']/.35); ?></td>
          <td class="text-center">x</td>
          <td class="text-center">35%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_brks_S2_2yr['brks_2yr_S2'])) echo round($row_brks_S2_2yr['brks_2yr_S2']); else echo "0"; ?></td>
        </tr>
      </table>
</div>
<div class="table-responsive center-block" style="max-width:600px" > 
<table class="table">
    <tr>
      <td class="text-right"><span class="italic">Total Weekly Ranking Points <?php echo $total_ranking_points+$total_break_points; ?></span></strong></td>
    </tr>
</table>
</div>
