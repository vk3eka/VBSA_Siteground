...
{
  //echo("Cohort " . $_GET['cohort'] . ", Name " . $colname_tournRP . "<br>");
  $cohort = $_GET['cohort'];
  switch ($cohort)
  {
      case 'all':
        $query_tournRP = "Select 
          Round((ROUND(tourn_2)) + 
          (ROUND(tourn_1)) + 
          tourn_curr + 
          brks_curr + 
          ...
          LEFT JOIN rank_Billiards ON rank_Billiards.memb_id = rank_a_billiards_master.memb_id
          WHERE LastName LIKE '%" . $colname_tournRP . "%' ORDER BY FirstName, LastName";
          $previous_rank = "temp_open_billiards_ranking";
         break;
      case 'woman':
          $query_tournRP = "Select 
          Round((ROUND(tourn_2)) + 
          ...
          LEFT JOIN members ON MemberID = rank_a_billiards_master.memb_id 
          LEFT JOIN rank_Billiards ON rank_Billiards.memb_id = rank_a_billiards_master.memb_id
          WHERE Gender = 'Female' and LastName LIKE '%" . $colname_tournRP . "%' ORDER BY FirstName, LastName";
          $previous_rank = "temp_womens_billiards_ranking";
          break;
      case 'junior': 
          $query_tournRP = "Select 
          Round((ROUND(tourn_2)) + 
          ...
          LEFT JOIN members ON MemberID = rank_a_billiards_master.memb_id 
          LEFT JOIN rank_Billiards ON rank_Billiards.memb_id = rank_a_billiards_master.memb_id
          WHERE Junior != 'na' and LastName LIKE '%" . $colname_tournRP . "%' ORDER BY FirstName, LastName";
          $previous_rank = "temp_junior_billiards_ranking";
          break;
      }
    }
    else
  ...
  <table class="table">
      ...
      <tr>
        ...
        <tr>
          ...
          <td class="text-center"><?php echo ($row_tournRP['total_rp']); ?></td>
          <td nowrap="nowrap"><a href="rankings_vic_billiards_detail.php?rank=<?php echo $row_tournRP['memb_id']; ?>&cohort=all">how these points were awarded</a></td>
        </tr>
