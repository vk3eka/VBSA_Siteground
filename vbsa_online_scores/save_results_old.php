...
foreach($fixture_array as $fixture_no)
{
    ...
    if($build_fix[$fixture_no] != '')
    {
        ...
        if($build_fix[$fixture_no] == 'Bye')
        {
            ...
            // get home team data
            $sql_home_team = "Select team_id, team_club_id, team_club from Team_entries where team_name = '" . $home_team . "' and team_grade = '" . $teamgrade . "' and team_cal_year = " . $current_year . " and team_season = '" . $season . "' Order By team_id DESC LIMIT 1";
