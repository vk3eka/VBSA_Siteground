...
$sql = "Select *, Concat(FirstName, ' ', LastName) as FullName FROM members WHERE Deceased = 0 and Concat(FirstName, ' ', LastName) Like '%" . $fullname . "%' OR Email = '" . $email . "' OR MobilePhone = " . $mobilephone;
//echo($sql . "<br>");
