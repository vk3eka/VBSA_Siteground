...
elseif((isset($_POST['buttonname'])) and ($_POST['buttonname'] = 'Submit'))
{
  ...
  if($num_authorise > 0)
  {
    ...
    if(($_GET['forgot'] == 'password') or ($_POST['forgotwhat'] == 'password'))
    {
      ...
      $message .= "<p>Click <a href='https://vbsa.org.au/vbsa_online_scores/index.php'>here </a>to access the Scores Entry Webpage System (SEWS).</p>";
      $message .= "<p>Thanks.</p>";
    ...
    $email_caption = "Your request has been sent to your registered email address. You will be redirected in 2 seconds.";
...
<?php
if ($email_caption === 'Your request has been sent to your registered email address. You will be redirected in 2 seconds.') {
?>
<script>
  setTimeout(function() {
