...
$NoOfRounds = $build_grades['no_of_rounds']; // no finals
    ...
    if($num_rows > 0)
    {
        ...
        { // number of rows per season
            ...
            for ($i = 0; $i < $NoOfRowsPerRound; $i++) { //no of rounds per row
                ...
                {
                    if((($i + 1) + $x) == ($final_start-1))
                    {
                        $final_title = "Elimination Final";
                        $save_button_text = "Save results for Elimination Final";
                        $clear_button_text = "Clear results for Elimination Final";
                    }
                    else if((($i + 1) + $x) == $final_start)
                    {
                        $final_title = "Semi Final";
                        $save_button_text = "Save results for Semi Finals";
                        $clear_button_text = "Clear results for Semi Finals";
