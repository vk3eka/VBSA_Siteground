...
<table class='table table-striped table-bordered dt-responsive nowrap display' width='90%'>
  ...
  <table class='table table-striped table-bordered dt-responsive nowrap display' width='90%'>
    ...
    <?php
      ...
      echo("<td align='center'><input id='gradeAB_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeBB_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeCB_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeDB_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeAS_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeBS_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeCS_games' type='text' style='width : 30px;'></td>");
      echo("<td align='center'><input id='gradeDS_games' type='text' style='width : 30px;'></td>");
      echo("</tr>");
      echo("</table>");
      echo("</tr>");
...
<div class='text-center'>
    <a class='btn btn-primary btn-xs' href="javascript:;" onclick="SaveSettings();">Save Settings</a>
</div>
</form>
</center>  
<?php
