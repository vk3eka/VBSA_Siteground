    ...
    $.fn.get_grades = function () {
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                output += ("<tr>"); 
                output += ("<td align='center'>Grade Code</td>");
                output += ("<td align='center'>Grade Name</td>");
                output += ("<td align='center'>Season</td>");
                output += ("<td align='center'>Type</td>");
                output += ("<td align='center' style='width : 60px;'>Finals Teams</td>");
                output += ("<td align='center' style='width : 60px;'>Day Played</td>");
                output += ("<td align='center' style='width : 60px;'>Alloc. Rank Points</td>");
                output += ("<td align='center' style='width : 60px;'>Min. Break Points</td>");
                output += ("<td align='center' style='width : 60px;'>No. of Matches</td>");
                output += ("<td align='center' style='width : 60px;'>No. of Rounds (inc Finals)</td>");
                output += ("<td align='center' style='width : 60px;'>No. of Players</td>");
                output += ("<td align='center' style='width : 60px;'>Games per Match</td>");
                output += ("<td align='center' style='width : 60px;'>Current</td>");
                output += ("</tr>");
                for(k = 0; k < obj.length; k++)
                {
                    fullobj = obj[k].split(', ');
                    //alert(fullobj[16]);
                    output += ("<input type='hidden' id='id_" + k + "' value=" + fullobj[16] + ">");
                    output += ("<tr>"); 
                    output += ("<td align='center'><input type='text' id='grade_" + k + "' value='" + fullobj[0] + "' style='width : 100px;'></td>");
                    output += ("<td align='center'><input type='text' id='grade_name_" + k + "' value='" + fullobj[1] + "'style='width : 200px;'></td>");
                    output += ("<input type='hidden' id='year_" + k + "' value=" + fullobj[7] + ">");
                    output += ("<td align='center'><input type='text' id='season_" + k + "' value='" + fullobj[2] + "' style='width : 50px;'></td>");
                    output += ("<td align='center'><input type='text' id='type_" + k + "' value='" + fullobj[3] + "' style='width : 100px;'></td>");
                ...
                output += ("<table class='table table-striped table-bordered dt-responsive nowrap display' width='90%'>");
                output += ("<tr>");
                output += ("<td colspan=15 align=center>");
