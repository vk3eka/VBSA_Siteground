...
elseif((isset($_POST['buttonname'])) and ($_POST['buttonname'] = 'Submit'))
{
  ...
  if($num_authorise > 0)
  {
    ...
    if(($_GET['forgot'] == 'password') or ($_POST['forgotwhat'] == 'password'))
    {
      ...
      $message .= "<p><a href='http://vbsa.cpc-world.com/'>Click here to access the scoring site.</a></p>";
      $message .= "<p>Thanks.</p>";
    ...
    $email_caption = "Your request has been sent to your registered email address.";
  }
  else
  {
