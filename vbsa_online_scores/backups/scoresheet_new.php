...
//echo("Select * from tbl_scoresheet where team = '" . $team . "' AND round = " . $round . " AND season = '" . $season . "' AND year = " . $current_year . " Order By playing_position<br>");
...
$(document).ready(function()
{
  ...
  $.fn.add_emergency = function () {
   ...
   //var team_name = $('#team_name').val();
    ...
    var type = $('#type').val();
    $.ajax({
      url:"<?= $url ?>/add_new_player.php?clubname=" + team_name + "&firstname=" + firstname + "&surname=" + surname + "&team_grade=" + team_grade + "&type=" + type + "&year=" + year + "&season=" + season + "&email=" + email + "&mobile=" + mobile + "&previous=" + previous,
      method: 'POST',
