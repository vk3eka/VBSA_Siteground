...
//echo($playing_date . "<br>");
//echo($_SESSION['season'] . "<br>");
//echo($_SESSION['year'] . "<br>");
//echo($_POST['HomeTeam'] . "<br>");
//echo($_POST['AwayTeam'] . "<br>");
//echo($_POST['FixtureDate'] . "<br>");
...
<table class='table table-striped table-bordered dt-responsive nowrap display'>
  ...
  <tr>
    <td colspan=2 align='center' valign='top'><b><?php echo($team); ?></b></td>  
    <td class='text-center'><b>V</b></td>
    <td colspan=2 align='center' valign='top'><b><?php echo($opposition); ?></b></td>  
  </tr>
</table>
<table class='table table-striped table-bordered dt-responsive nowrap display'>
    <tr> 
