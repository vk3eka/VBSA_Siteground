  ...
  $.fn.getexistingarray = function (type, team, home_away) {
    ...
    $.ajax({
      ...
      success : function(data){
        ...
        console.log("Existing Existing Arr fn " + obj);
        console.log("Current Existing Arr fn " + currForm);
...
$(document).ready(function()
{
  ...
  $.fn.save_approval = function (team, opposition, venue, event) 
  {
    ...
    $.ajax({
      url:"<?= $url ?>/save_approvals.php?Home_Approve=" + home_ok + "&Away_Approve=" + away_ok + "&Round=" + Round + "&Year=" + Year + "&Season=" + Season + "&DatePlayed=" + DatePlayed + "&TeamGrade=" + TeamGrade + "&Type=" + Type + "&Home=" + team + "&Away=" + opposition + "&GamesWonHome=" + GamesWonHome + "&GamesWonAway=" + GamesWonAway + "&GamesDrawHome=" + GamesDrawHome + "&GamesDrawAway=" + GamesDrawAway + "&Venue=" + venue+ "&PackedData=" + PackedData + "&RoundTitle=" + RoundTitle,
      method: 'POST',
      success:function(response)
      {
        $.ajax({
...
<br>
<form name="edit_scoresheet" id="edit_scoresheet" method="post" action="scoresheet.php" onsubmit="return edit_scoresheet(event)">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class='text-center'>
                If you have forgotten your password<br>Please login to <a href="http://vbsa.org.au">VBSA</a> on your own device<br>Choose 'Forgotten Password' from the log in screen.
              </div>
