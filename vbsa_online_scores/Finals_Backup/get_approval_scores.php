...
if ($num_rows_home != 0) 
{
  ...
  {
    $players_home[$i] = $build_data_home['players_name']  . ", " . $build_data_home['capt_home'] . ", " . $build_data_home['score_1'] . ", " . $build_data_home['score_2'] . ", " . $build_data_home['score_3'] . ", " . $build_data_home['break_1'] . ", " . $build_data_home['break_2'] . ", " . $build_data_home['break_3'];
    $i++;
  }
  //  . ", " . $build_data_home['capt_home'] . ", " . $build_data_home['capt_away']
...
if ($num_rows_away != 0) 
{
  ...
  {
    $players_away[$i] = $build_data_away['players_name']  . ", " . $build_data_away['capt_home'] . ", " . $build_data_away['score_1'] . ", " . $build_data_away['score_2'] . ", " . $build_data_away['score_3'] . ", " . $build_data_away['break_1'] . ", " . $build_data_away['break_2'] . ", " . $build_data_away['break_3'];
    $i++;
  }
  // . ", " . $build_data_away['capt_home'] . ", " . $build_data_away['capt_away']
