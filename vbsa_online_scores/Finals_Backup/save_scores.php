...
//if((sizeof($packedscoredata) == 1) && ($score1[0] == 'Team Forfeit'))
//{
...
// check if away data already entered
$sql_club = "Select * from tbl_club_results where club = '" . $opposition. "' AND round = " . $round . " AND season = '" . $season . "' AND year = " . $current_year . " AND team_grade = '" . $team_grade . "'";
//echo("Club Select - " . $sql_club . "<br>");
$result_count_club = $dbcnx_client->query($sql_club) or die("Couldn't execute query. " . mysqli_error($dbcnx_client));
$num_rows_club_count = $result_count_club->num_rows;
$result_count_club->free_result();
