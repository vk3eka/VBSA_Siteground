...
function ImportExcel($filename, $current_year, $season) 
{
    ...
    for ($row = 1; $row < $highestRow; $row++) {
        ...
        if($rowData[$row][1] != '') // stop before the last entry
        {
            ...
            //Insert INTO tbl_fixtures (date, type, grade, round, fix1home, fix1away, fix2home, fix2away, fix3home, fix3away, fix4home, fix4away, fix5home, fix5away, fix6home, fix6away, year, season, team_grade, dayplayed, title) Values ('2025-02-12', 'Snooker', 'A', 1, 'Dandy RSL Ball Breakers', 'YCBSC Break Builders', 'NBC Mustangs', 'Brunswick Titan', 'Brunswick Taylor', 'Brunswick Eagles', '', '', '', '', '', '', , '', '2025', 'S1', 'APS')
