...
function show_fixtures($names) {
    ...
    //print "<p>Second half is mirror of first half</p>"; // (Set 2)
    ...
    //print "<p>Second half is mirror of first half</p>"; // (Set 4)
    $round_counter = sizeof($rounds) + 1;
    for ($i = 0; $i < sizeof($rounds); $i++) {
        print "<p>Round " . ($round_counter + 6) . "</p>\n";
        $round_counter += 1;
        foreach ($rounds[$i] as $r) {
            print flip($r) . "<br />";
        }
    ...
    // Display the fixtures (Set 5)
    for ($i = 0; $i < sizeof($rounds); $i++) {
        print "<p>Round " . ($i + 13) . "</p>\n";
        foreach ($rounds[$i] as $r) {
            print $r . "<br />";
        }
        print "<br />";
