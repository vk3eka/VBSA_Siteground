...
{
  $('#team_rego').on('click', function(event)
  {
    //event.preventDefault();
    alert("Team registrations for this season not yet opened.");
  });
});
</script>
      ...
      <ul class="nav navbar-nav">
         ...
         if(date('m') < 8)
          ...
          if($_SESSION['login_rights'] == 'Administrator')
          {
            ...
            // need to check when season is open.............
            //$sql_select = "Select * from tbl_team_select_visible where year=" . $_SESSION['year'] . " and season = '" . $_SESSION['season'] . "'";

             //.............................. Hard Coded

            $sql_select = "Select * from tbl_team_select_visible where year=2026 and season = 'S1'";
            ...
            {
              echo("<li><a href='" . $_SERVER['PHP_SELF'] . "' id='team_rego'><font color=grey >Pennant Team Registration</font></a></li>");
            }
            ...
            echo("<li><a href='" . $url . "/captain_authorise.php" . "'>Add Authoriser</a></li>");
            ...
            //echo("<ul class='dropdown-menu'>");
            //echo("<li><a href='" . $url . "/fixture_grid_wed.php" . "'>Generate Fixtures (Wed)</a></li>");
            //echo("</ul>");
          ...
          if($_SESSION['login_rights'] == 'Team Administrator')
          {
            ...
            echo("<ul class='dropdown-menu'>");
            echo("<li><a href='" . $url . "/captain_authorise.php" . "'>Add Authoriser</a></li>");
            //$sql_select = "Select * from tbl_team_select_visible where year=YEAR(CURDATE()) and season = 'S2'";
          ...
          if(($_SESSION['login_rights'] == 'Team Captain') || ($_SESSION['login_rights'] == 'Team Authoriser'))
          {
            ...
            else
            {
              ...
              //.............................. Hard Coded
              //$sql_select = "Select * from tbl_team_select_visible where year=YEAR(CURDATE()) and season = '$season'";
              $result_select = $dbcnx_client->query($sql_select);
              $build_select = $result_select->fetch_assoc();
              /*
              if(($build_select['start_date'] == '0000-00-00'))
