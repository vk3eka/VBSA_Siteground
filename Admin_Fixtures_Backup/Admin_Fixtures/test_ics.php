...
function ImportExcel($filename, $current_year, $season) 
{
    ...
    $sql = "Select DTSTART From tbl_ics_dates";
    ...
    if($data_exists)
    {
        $sql_delete = "Delete from tbl_ics_date Where TYPE = 'public'";
...
if($_FILES['excel_file']['name'])
{
    if(!$_FILES['excel_file']['error'])
    {
        ...
        if($valid_file)
        {
            ...
            {
        */        echo("File name ". $_FILES['excel_file']['tmp_name'] . ", Year 2025, Season S2<br>");
...
{
    echo("<form action='test_ics.php' method='post' enctype='multipart/form-data'>");
    echo("<center>");
    echo("<table border='0' align='center' cellpadding='0' cellspacing='0'>");
    echo("<tr>");
    ...
    echo("</tr>");
    echo("<tr>");
    echo("<td align=center><b><font color=red>Please note: any existing fixture data for season S2, in 2025 will be deleted.</b></font></td>");
    echo("</tr>");
    echo("<tr>");
    echo("<td align=center>&nbsp;</td>");
    echo("</tr>");
