...
{
    alert("Here");
    //document.fixture.Action = 'generate_fixtures_d.php?DayPlayed=<?= $dayplayed ?>&season=<?= $season ?>'; 
    document.go_to_database.submit();
}
*/
...
?>
<form name='reset_fixture' method='post' action='generate_fixtures_a.php?DayPlayed=<?= $dayplayed ?>&season=<?= $season ?>'>
...
<table class='table dt-responsive nowrap display' align='center' width='800px'>
  ...
  <tr>
    <td colspan="4" align="center"><span class="red_bold"><h3>Generate Fixtures <?= $title_caption ?> <?= $season ?> (Database)</h3></span></td>
  </tr>
  <tr>
...
<form name='go_to_database' method='post' action='generate_fixtures_d.php?DayPlayed=<?= $dayplayed ?>&season=<?= $season ?>'>
<table class='table dt-responsive nowrap display' align='center' width='800px'>
  <tr>
<?php
...
<tr>
    <th colspan=<?= ($i) ?> class='text-center'><button type='button' class='btn btn-primary' onclick='GoToD();' style='width:300px'>Position Swap</button></th>
</tr>
<tr>
    <th colspan=<?= $i ?>>&nbsp;</th>
</tr>
...
echo("<form name='fixture' method='post' action='generate_fixtures_a.php?DayPlayed=" . $dayplayed . "&season=" . $season . "'>");
