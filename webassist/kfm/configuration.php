...
$kfm_db_host = $hostname_connvbsa;
$kfm_db_name = $database_connvbsa;
$kfm_db_username = $username_connvbsa;
$kfm_db_password = $password_connvbsa;
$kfm_db_port     = '';
$use_kfm_security = false;
$kfm_userfiles_address = '../../images_frontpage';
