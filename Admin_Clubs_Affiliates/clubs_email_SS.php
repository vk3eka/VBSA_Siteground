...
$query_Clubs_cont = "SELECT cont_id, club_id, ClubTitle, cont_memb_id, FirstName, LastName, cont_type, cont_title, Email, MobilePhone FROM clubs_contact LEFT JOIN members ON cont_memb_id=MemberID LEFT JOIN clubs ON ClubNumber = club_id WHERE cont_type='Team organiser' AND Club_Aff_Assoc='Club' ORDER BY ClubTitle";
...
<table align="center">
  ...
  <tr>
    <td align="center" valign="middle" class="red_bold">This list comes from the &quot;clubs_contact&quot; table. Only Clubs that have a contact listed as Team organiser will appear. </td>
  </tr>
  <tr>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td class="greenbg"><a href="user_files/upload_attach.php?attach_redirect=SS">Please upload it now</a></td>
