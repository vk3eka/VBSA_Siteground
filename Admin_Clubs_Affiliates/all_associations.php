...
$query_Clubs = "SELECT ClubNumber, ClubTitle, Club_Aff_Assoc, ClubStreet, ClubSuburb, ClubPcode, ClubPhone1, ClubEmail, ClubContact, VBSAteam, ChurchBill, CityClubTeam, DVSAteam, MSBAteam, Over55team, RSLteam, SouthernTeam, affiliate, aff_URL FROM clubs WHERE clubs.Club_Aff_Assoc='Association' ORDER BY ClubTitle";
...
<table width="769" align="center">
  ...
  <tr>
    ...
    <form id="form6" name="form6" method="get" action="clubs_srch_res.php">
  ...
  <tr>
    ...
    <td align="right">Total Associations:<?php echo $totalRows_Clubs ?></td>
  </tr>
</table>
<table width="800" align="center">
  ...
  <tr>
    <td align="center" valign="middle" class="red_bold">All Associations- contact details are as per the &quot;Club Directory&quot; (Public view)</td>
  </tr>
  <tr>
  ...
  <?php do { ?>
    <tr>
      <td align="center"><?php echo $row_Clubs['ClubNumber']; ?></td>
        ...
        <td align="center"><a href="user_files/clubs_detail.php?club_id=<?php echo $row_Clubs['ClubNumber']; ?>&redirect=<?php echo $redirect; ?>"><img src="../Admin_Images/detail.fw.png" width="20" height="20" title="Detail" /></a></td>
    </tr>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td class="greenbg"><a href="user_files/upload_attach.php?attach_redirect=assoc">Please upload it now</a></td>
