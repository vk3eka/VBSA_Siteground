    ...
    $.fn.drawAnalysisData = function(grades, teams, rounds, max_no_of_rounds)
    {
        ...
        $.each(grades, function(_, r) {
            ...
            {   
                ...
                {
                    //console.log("Analysis " + (grade + '_fix_' + (j+1) + '_pos_' + (y+1)));
        ...
        $.each(clubs_sorted, function(_, r) {
            ...
            $.each(teamData2, function(_, g) {
                ...
                for(var i = 0; i < max_no_of_rounds; i++)
                {
                    ...
                    $.each(roundList, function(_, h) {
                        ...
                        //console.log("Home " + h.home + ", Away " + h.away + ", round " + (i+1) + ", grade " + grade);
                    ...
                    // teams with a fixture in this round
            ...
            $.each(teamData1, function(_, g) {
                ...
                for(var i = 0; i < max_no_of_rounds; i++)
                {
                    ...
                    // count of teams in the club with a fixture
...
function resolveFixtures(initialFixtures, teams, clubs, maxAttempts = 2000) {
    ...
    $.fn.shuffle_teams = function(recursions = 0)
    {
        ...
        $.each(grades, function(_, r) {
            ...
            //console.log("Home Teams Array (Before)  " + JSON.stringify(all_home_teams, null, 2)); 
...
;
            let HomeTeamNames = all_home_teams.map(m => m.home_team.team);
            //console.log("Home List  " + JSON.stringify(HomeTeamNames, null, 2));
            let displayString = HomeTeamNames.join(", ") + ", ";
            //console.log("Fixtures  " + displayString); 
            main(displayString, teamGrade, form_no, <?= $year ?>, '<?= $season ?>', startdate);
            ...
            //console.log("Home Teams Array  (After) " + JSON.stringify(all_home_teams, null, 2));

            // get home team count for grade window display
            let teamCounts = {};
            ...
            //main(all_home_teams, teamGrade, form_no, <?= $year ?>, '<?= $season ?>', startdate);
    ...
    //var rounds = <?php echo json_encode($data['rounds']); ?>;
    //var max_no_of_rounds = <?= $max_no_of_rounds ?>;
    //console.log("All Home Teams Array  " + JSON.stringify(all_home_teams, null, 2));
    //$.fn.drawAnalysisData(grades, all_home_teams, rounds, max_no_of_rounds); // same as initial display
