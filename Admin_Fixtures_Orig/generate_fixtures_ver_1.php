...
*/
    ...
    elseif($teams == 12)
    {
        ...
        $rounds1to11 = $rounds;                         // full single round-robin
        $rounds12to15 = array_slice($rounds, 0, 4);     // pick first 4 rounds to repeat
        $rounds = array_merge($rounds1to11, $rounds12to15);
        //echo($rounds . "<br>");

        // set 1
        echo("<table class='table table-striped table-bordered dt-responsive nowrap style='display: none' float-container' width='1000px'>");
        echo("<tbody class='row_position_10'>");
        echo("<tr><td colspan=3 align='center'>(Algorithm)</td></tr>");
        ...
        for ($i = 0; $i < count($rounds); $i++) {
            ...
            foreach ($rounds[$i] as $r) { 
                ...
                {
                    echo("<tr>");
                    echo("<td align='center'><input class='float-child' type='text' id='A_" . $team_grade . "_home_" . ($i+1) . "_" . ($x+1) . "' value='" . $round_data[1] . "' style='width:200px'></td>");
                    echo("<td align='center'>v</td>");
                    echo("<td align='center'><input class='float-child' type='text' id='A_" . $team_grade . "_away_" . ($i+1) . "_" . ($x+1) . "' value='" . $round_data[0] . "' style='width:200px'></td>");
                    echo("</tr>");
                }
                else
                {
