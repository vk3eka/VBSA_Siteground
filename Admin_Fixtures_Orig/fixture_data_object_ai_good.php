...
$(document).ready(function()
{
    ...
    $.fn.drawAnalysisData = function(grades, teams, rounds, max_no_of_rounds, index)
    {
        console.log("Algorithym Index " + index);
        console.log("Original Teams " + JSON.stringify(teams, null, 2));
        // anaylsis data page
        $('#algorithym').empty();
    ...
    var rounds = <?php echo json_encode($data['rounds']); ?>;
    var max_no_of_rounds = <?= $max_no_of_rounds ?>;
    //$.fn.drawAnalysisData(grades, teams, rounds, max_no_of_rounds, 1); // initial display
    ...
    */
    ...
    $.fn.shuffle_teams = function(recursions = 0)
    {
        ...
        $.each(grades, function(_, r) {
            ...
            //console.log("Teams Array  " + JSON.stringify(teams, null, 2));
            console.log("All Teams Array  " + JSON.stringify(all_home_teams, null, 2));
            ...
            //$.fn.drawAnalysisData(grades, all_home_teams, rounds, max_no_of_rounds);
