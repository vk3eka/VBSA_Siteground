...
{ 
    $sql_sort_order = 'Select * from Team_entries where team_cal_year = ' . $year . ' and team_grade = "' . $grade . '" and team_season = "' . $season . '"  Order By RAND()';
    //echo($sql_sort_order . "<br>");
    ...
    //elseif(($teams == 8) || ($teams == 10) || ($teams == 4) || ($teams == 12))
    {
        ...
        for ($i = 0; $i < sizeof($rounds); $i++) {
            ...
            foreach ($rounds[$i] as $r) {
                ...
                echo("Home " . $round_data[0] . "<br>");
                echo("Away " . $round_data[1] . "<br>");
                $x++;
            }
        }
        // Second half is mirror of first half
        ...
        //for ($b = (sizeof($rounds) - 1); $b >= 0; $b--) {
            ...
            foreach ($rounds[$b] as $r) {
                $round_data = explode(" v ", $r);
                echo("Grade " . $team_grade . "<br>");
                echo("Home " . $round_data[1] . "<br>");
                echo("Away " . $round_data[0] . "<br>");
                $y++;
            }
        }
    }
...
echo("Fixtures have been shuffled.");
