...
$totalRP = ROUND(round($row_S1curr['Totals']) + round($row_S2curr['Totals']) + round($row_S1_1year['Totals']*65/100) + round($row_S2_1year['Totals']*65/100) + round($row_S1_2year['Totals']*35/100) + round($row_S2_2year['Totals']*35/100));
...
<div class="table-responsive center-block" style="max-width:600px" > 
	<table class="table">
        ...
        <tr>
          ...
          <td class="text-center"><?php echo $row_S1curr['Totals']; ?></td>
        ...
        <tr>
          ...
          <td class="text-center"><?php echo $row_S2curr['Totals']; ?></td>
          <td class="text-center">x</td>
          <td class="text-center">100%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php echo $row_S2curr['Totals']; ?></td>
        ...
        <tr>
          ...
          <td class="text-center"><?php echo $row_S1_1year['Totals']; ?></td>
          <td class="text-center">x</td>
          <td class="text-center">65%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_S1_1year['Totals'])) echo round($row_S1_1year['Totals']*65/100); else echo "0"; ?></td>
          </tr>
        <tr>
          <td><span class="red_bold"><?php echo date("Y", strtotime(date("Y-m-d")." -1 year")); ?></span> - S2 Best total Ranking Points </td>
          <td class="text-center"><?php echo $row_S2_1year['Totals']; ?></td>
          <td class="text-center">x</td>
          <td class="text-center">65%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_S2_1year['Totals'])) echo round($row_S2_1year['Totals']*65/100); else echo "0"; ?></td>
          </tr>
        <tr>
          <td><span class="red_bold"><?php echo date("Y", strtotime(date("Y-m-d")." -2 year")); ?></span> - S1 Best total Ranking Points </td>
          <td class="text-center"><?php echo $row_S1_2year['Totals']; ?></td>
          <td class="text-center">x</td>
          <td class="text-center">35%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_S1_2year['Totals'])) echo round($row_S1_2year['Totals']*35/100); else echo "0"; ?></td>
          </tr>
        <tr>
          <td><span class="red_bold"><?php echo date("Y", strtotime(date("Y-m-d")." -2 year")); ?></span> -  S2 Best total Ranking Points</td>
          <td class="text-center"><?php echo $row_S2_2year['Totals']; ?></td>
          <td class="text-center">x</td>
          <td class="text-center">35%</td>
          <td class="text-center">=</td>
          <td class="text-center"><?php if(isset($row_S2_2year['Totals'])) echo round($row_S2_2year['Totals']*35/100); else echo "0"; ?></td>
        </tr>
        <tr>
