...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <table class="table">
    ...
    <tr>
      <td><a href="rankings_vic_snooker.php"><?php echo date("Y"); ?> Snooker Tournament Rankings</a></td>
    ...
    <tr>
      <td><a href="rankings_vic_billiards.php"><?php echo date("Y"); ?> Billiard Tournament Rankings</a></td>
      <td colspan="3"><span class="italic">Last Update:
