...
else
{
  ...
  brks_2, 
  brks_curr, 
  Round((ROUND(tourn_2)*35/100) + 
  (ROUND(tourn_1)*65/100) + 
  tourn_curr + 
  brks_curr + 
  (ROUND(brks_2)*35/100) + 
  (ROUND(brks_1)*65/100) +
  (ROUND(scr_curr_s2)*35/100) + 
  (ROUND(scr_curr_s1)*65/100)) 
  as total_points,
  ranknum, 
 ...
 <div class="table-responsive center-block" style="max-width:1000px; padding-left:3px">
   <table class="table" border =1>
    ...
    <tr>
      ...
      <td class="text-center"><?php echo $row_RPall['brks_2']; ?></td>
      <td class="text-center"><?php echo $row_RPall['brks_1']; ?></td>
