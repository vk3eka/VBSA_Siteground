...
<p>&nbsp;</p>
  ...
  <table width="1100" align="center" cellpadding="2" cellspacing="2">
	  ...
	  <?php do { ?>
      <tr>
        <td width="150" align="left"><?php echo $row_coaches['FirstName']; ?> <?php echo $row_coaches['LastName']; ?></td>
        <td width="200" align="left" class="page"><a href="mailto:<?php echo $row_coaches['Email']; ?>"><?php echo $row_coaches['Email']; ?></a></td>
        <td width="100" align="left" class="page"><a href="tel:<?php echo $row_coaches['MobilePhone']; ?>"><?php echo $row_coaches['MobilePhone']; ?></a></td>
        <td width="50" align="left"><?php echo $row_coaches['class']; ?></td>
        <td width="50" align="center"><?php echo $row_coaches['coach_order']; ?></td>
        <td width="50" align="center"><?php if($row_coaches['active_coach'] == 1) echo "Yes"; else echo "No"; ?></td>
        
        <td width="180" class="page">
        <?php
		if (isset ($row_coaches['URL']))
		{
		?>
        <a href="<?php echo $row_coaches['URL']; ?>" target="_blank"><?php echo $row_coaches['URL']; ?></a>
        <?php
		}
		else;
		echo '&nbsp;';
        ...
        <td width="120" align="center" nowrap="nowrap" class="greenbg"><a href="user_files/coach_edit.php?coach_edit=<?php echo $row_coaches['coach_id']; ?> ">Edit Coach Details</a></td>
        <td width="120" align="center" nowrap="nowrap" class="greenbg"><a href="../A_common/vbsa_member_edit.php?memb_id=<?php echo $row_coaches['MemberID']; ?>">Edit Personal</a></td>
        <td width="30"><a href="user_files/coach_delete.php?coach_del=<?php echo $row_coaches['memb_id']; ?>"><img src="../Admin_Images/Trash.fw.png" width="25" height="25" /></a></td>
      </tr>
      <tr>
        <td colspan="9" style="border-bottom: 1px solid #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_coaches['comment']; ?></td>
        </tr>
