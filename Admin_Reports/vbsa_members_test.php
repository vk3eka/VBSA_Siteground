...
/*$query_memb_display = "Select * from test_members order by MemberID";
...
*/
$query_memb = 'Select * from test_members where Email != "" order by MemberID';
echo($query_memb . "<br>");
...
<!--<form name='sort'  method="post" action='vbsa_members_test.php'>-->
