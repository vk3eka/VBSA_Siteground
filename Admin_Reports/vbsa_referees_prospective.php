...
$page = "../Admin_DB_VBSA/vbsa_referees_prospective.php";
$_SESSION['page'] = $page;
...
$query_History = "SELECT members.MemberID, members.LastName, members.FirstName, members.HomePhone, members.WorkPhone, members.MobilePhone, members.Email, members.ReceiveEmail, members.Club, members. Club2, members.Referee, members.Ref_Class, prospective_ref FROM members WHERE prospective_ref = 1 ORDER BY {$sqlorderby_History}";
    ...
    <tr>
      <td colspan="3"><p>To insert a person as a referee or as a Prospective Referee:</p>
        <ul>
          ...
          <li>Check the appropriate checkboxes and put in the ref class if reqired</li>
        </ul></td>
    </tr>
    <tr>
...
<table align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td class="red_bold">Lists all Prospective Referees</td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_History['FirstName']; ?></td>
        ...
        <td align="center"><?php if ($row_History['prospective_ref']==1)
			echo "Yes";
			else
			echo "No"; 
			?></td>
...
<table width="885" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td nowrap="nowrap">Would you like to send an attachment?</td>
    <td>&nbsp;</td>
    <td class="greenbg"><a href="attach_upload.php">Please upload it now</a></td>
    <td align="right" class="greenbg" nowrap="nowrap"><a href="Bulk_email_help.pdf">Bulk Email help</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>To Send a group email: </td>
      <td width="11">&nbsp;</td>
      <td width="686" colspan="2">1. Type your email address in the &quot;From&quot; field</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<form action="" method="post" name="editor_form" id="editor_form">
    <br />
    <?php $myRecordset=$History; $myTotalRecords=$totalRows_History; ?>
