...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "address-form")) 
{
  ...
  else
  {
    ...
    $insertSQL = sprintf("Insert INTO tbl_membership_online (LastName, FirstName, HomeAddress, HomeSuburb, HomeState, HomePostcode, Country, HomePhone, MobilePhone, ReceiveSMS, Email, ReceiveEmail, promo_optin_out, promo_pref, memb_occupation, entered_on, cue, Gender, Overseas, Referee, Ref_Class, dob_day, dob_mnth, dob_year, new_renewal, other_person) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  <tr>
    <td>
      <table class='table dt-responsive display'>
        ...
        <tr>
          <td align="left">·&nbsp;&nbsp;Junior (under the age of 19)</td>
        </tr>
        <tr>
          <td align="left">·&nbsp;&nbsp;Identify as a female</td>
        </tr>
        <tr>
