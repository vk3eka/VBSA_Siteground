...
$page = "../Admin_DB_VBSA/vbsa_members_playingbygame.php?comptype=$comptype";
$_SESSION['page'] = $page;
...
$query_curr_play = "SELECT scrsID, scrs.MemberID, FirstName, LastName, MobilePhone, Email, SUM(count_played) AS TotPlayed, game_type FROM scrs LEFT JOIN members ON members.MemberID=scrs.MemberID WHERE game_type='$comptype' AND current_year_scrs = YEAR( CURDATE( ) ) AND (scrs.MemberID!=1 AND scrs.MemberID!=100 AND scrs.MemberID!=1000) GROUP BY scrs.MemberID ORDER BY LastName, FirstName";
...
<?php include '../admin_xx_includes/db_srch.php';?>
    ...
    <table align="center">
      ...
      <tr>
        <td class="red_bold">All players playing  <?php echo $comptype." in ".date("Y"); ?></td>
...
<table align="center" cellpadding="2" cellspacing="2" class="page">
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="center"><?php echo $row_curr_play['TotPlayed']; ?></td>
