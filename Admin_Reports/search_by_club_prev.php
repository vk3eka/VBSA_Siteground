...
$page = "../Admin_DB_VBSA/search_by_club_prev.php?searchthis=$searchthis"  ;
$_SESSION['page'] = $page;
...
$query_srchres = "SELECT scrs.MemberID, scrs.scrsID, members.LastName, members.FirstName, MobilePhone, Email, scrs.team_grade, team_club, scr_season, scrs.team_id, game_type, count_played, Team_entries.day_played, memb_by FROM scrs LEFT JOIN Team_entries ON Team_entries.team_id = scrs.team_id LEFT JOIN members ON members.MemberID = scrs.MemberID WHERE current_year_scrs = YEAR(NOW())-1 AND scrs.MemberID !=1 AND scrs.MemberID !=500 AND scrs.MemberID !=1000  AND Team_entries.team_club LIKE CONCAT('$searchthis','%') ORDER BY LastName, FirstName, scr_season, Team_grade";
...
<table width="1000" border="0" align="center">
    ...
    <tr>
      <td colspan="3" align="left" class="red_bold"> Search by Club in <?php echo date("Y") -1 ?> - Results for "<?php echo $searchthis ?>"</td>
      <td align="right">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4" align="left" class="greenbg">NOTE: Players may appear multiple times if they have played in more than 1 grade</td>
    </tr>
    <tr>
...
<table border="1" align="center" cellpadding="3" cellspacing="3">
  ...
  <?php do { ?>
    <tr>
      ...
      <td class="page"><a href="../A_common/vbsa_member_edit.php?memb_id=<?php echo $row_srchres['MemberID']; ?>&amp;pagename=<?php echo $pagename; ?>"><img src="../Admin_Images/edit_butt.fw.png" alt="" width="20" title="edit"  /></a></td>
      ...
      <td align="center" nowrap="nowrap"><span class="greenbg"><a href="../A_common/vbsa_member_edit_form.php?memb_id=<?php echo $row_srchres['MemberID']; ?>&amp;pagename=<?php echo $pagename; ?>" title="Insert / update membership form details">Memb</a></span></td>
    </tr>
