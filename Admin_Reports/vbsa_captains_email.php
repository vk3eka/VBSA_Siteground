...
/*
$query_memb_display = "Select members.MemberID, LastName, FirstName, MobilePhone, Email, captain_scrs, Team_entries.team_id, Team_entries.team_grade, Team_entries.team_club, Team_entries.team_name, day_played, comptype FROM members LEFT JOIN scrs ON scrs.MemberID=members.MemberID LEFT JOIN Team_entries on Team_entries.team_id=scrs.team_id WHERE captain_scrs=1 AND team_cal_year = YEAR( CURDATE( ) ) AND scr_season='$season' ORDER BY Team_entries.team_grade, Team_entries.team_club";
...
<table align="center" cellpadding="5" cellspacing="5">
  ...
  <tr>
    <td class="greenbg">Total Captains accepting emails <?php echo $season; ?>: <?php echo $totalRows_memb ?></td>
    <td>&nbsp;</td>
    <td align="right">&nbsp;</td>
  </tr>
  <tr>
