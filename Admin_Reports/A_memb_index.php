...
<table align="center">
  ...
  <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_members.php">Members</a></td>
    <td>&nbsp;</td>
    <td class="greenbg" nowrap="nowrap">Lists all players that satisfy the member criteria. <a href="vbsa_members_email.php">Bulk Email</a></td>
  </tr>
  <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_captains.php?season=S1">Captains S1 <?php echo date("Y") ?></a></td>
    <td>&nbsp;</td>
    <td class="greenbg">A List of all Captains (&amp; team members) - <a href="vbsa_captains_email.php?season=S1">Bulk Email</a></td>
  </tr>
  <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_captains.php?season=S2">Captains S2 <?php echo date("Y") ?></a></td>
    <td>&nbsp;</td>
    <td class="greenbg">A List of all Captains (&amp; team members) - <a href="vbsa_captains_email.php?season=S2">Bulk Email</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_ALL.php">All records</a></td>
    <td>&nbsp;</td>
    <td nowrap="nowrap">All membership records active or not</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="10">&nbsp;</td>
    <td width="742">View the complete history of VBSA members, lists all players that have been included in the database</td>
  </tr>
  <tr>
    <td align="left" class="greenbg_menu"><a href="Members_AA_Female.php">Female</a></td>
    <td>&nbsp;</td>
    <td>View all players in the database that are listed as female - Bulk Email</td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_BoardMemb.php">Board</a></td>
    <td>&nbsp;</td>
    <td>View all Board members</td>
  </tr>
  <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_hist_IS_players.php">Interstate Players</a></td>
    <td>&nbsp;</td>
    <td>View all players in the database that are listed as interstate players - Bulk Email</td>
  </tr>
  <tr>
    <td align="left" class="greenbg_menu"><a href="vbsa_hist_OS_players.php">Overseas Players</a></td>
    <td>&nbsp;</td>
    <td>View all players in the database that are listed as Overseas players - Bulk Email</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td nowrap="nowrap">Lists all players that have been de-activated. <span class="page" ><a href="user_files/member.php">When is a person considered a member?</a></span></td>
  </tr>
