...
$page = "../Admin_DB_VBSA/vbsa_hist_IS_players.php";
$_SESSION['page'] = $page;
...
$query_members = "SELECT members.MemberID, members.LastName, members.FirstName, members.HomePhone, members.WorkPhone, members.MobilePhone, members.Email, members.ReceiveEmail, members.HomeState FROM members WHERE HomeState <> 'Vic' ORDER BY FirstName";
...
<table align="center">
  <tr>
    <td class="red_bold">All players that are listed as &quot;Interstate&quot; Players (Where home state does not equal &quot;Vic&quot;)</td>
...
<table align="center" cellpadding="2" cellspacing="2">
      <tr>
        <td colspan="9" align="center">Total interstate players: <?php echo $totalRows_members ?></td>
      </tr>
      <tr>
