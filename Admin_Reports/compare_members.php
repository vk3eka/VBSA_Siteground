...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("Update members SET LastName=%s, FirstName=%s, HomeState=%s, HomePostcode=%s, HomePhone=%s, MobilePhone=%s, ReceiveSMS=%s, Email=%s, memb_occupation=%s, ReceiveEmail=%s, Overseas=%s, Referee=%s, Ref_Class=%s, dob_day=%s, dob_mnth=%s, dob_year=%s, promo_pref=%s, promo_optin_out=%s, memb_submit_date=%s, memb_by=%s WHERE MemberID=%s",
                       ...
                       GetSQLValueString(isset($_POST['Overseas']) ? "true" : "", "defined","1","0"),
    ...
    <td>
      <table style='width:250px' align="left" class="tableborder" >
        ...
        <tr>
          ...
          <td><input type="checkbox" <?= $ref_checked ?>/></td>
          <td align="right">Receive Promo.</td>
