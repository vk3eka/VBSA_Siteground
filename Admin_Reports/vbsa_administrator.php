...
<?php include '../admin_xx_includes/db_srch.php';?>
      ...
      <table align="center">
        <tr>
          <td align="center"> <?php echo $_SESSION['MM_Username']; ?> <?php echo $row_getusername['usertype']; ?></td>
        </tr>
        <tr>
          <td align="center">Please select an area from the above menu to work in, or execute a search</td>
        </tr>
        <tr>
          <td align="center" class="red_text">Any problems accessing any area or updating your access permissions please contact the <span class="page"><a href="mailto:web@vbsa.org.au">webmaster</a></span></td>
        </tr>
      </table>
