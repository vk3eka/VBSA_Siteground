...
$page = "../Admin_DB_VBSA/vbsa_players_email_2years.php";
$_SESSION['page'] = $page;
...
<table align="center">
  <tr>
    <td align="center"><p class="red_bold">This list contains all players that are financial or have played at least 1 match in any season, </p>
    <p class="red_bold">have an email and have &quot;Receive Email&quot; set as &quot;Yes&quot; from <span class="header_red"><?php echo date("Y")-1 ?></span> and <span class="header_red"><?php echo date("Y") ?></span></p></td>
  </tr>
  <tr>
    <td align="center">Scroll to the bottom of the page to send an email to all that are listed here. Total email contacts:<?php echo $totalRows_memb ?></td>
  </tr>
</table>
<table align="center" cellpadding="2" cellspacing="2">
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="left">&nbsp;</td>
          <td align="left"><?php echo $row_memb['LastName']; ?>, <?php echo $row_memb['FirstName']; ?></td>
          <td align="left" class="page"><a href="mailto:<?php echo $row_memb['Email']; ?>"><?php echo $row_memb['Email']; ?></a></td>
