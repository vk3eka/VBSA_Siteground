...
$query_S1players = "SELECT scrsID, scrs.MemberID, members.FirstName, members.LastName, members.Email, members.MobilePhone, SUM(scrs.played_bill_S1) AS S1bill FROM scrs, members, Team_entries WHERE members.MemberID=scrs.MemberID   AND scrs.team_id=Team_entries.team_id  AND scrs.S1 is not null  AND scrs.MemberID<>'1'   AND scrs.MemberID<>'500'  AND scrs.MemberID<>'1000'   AND scrs.current_year_scrs = YEAR( CURDATE( ) )  AND scrs.S1 =1 AND email is not null GROUP BY scrs.MemberID HAVING SUM(scrs.played_bill_S1)>1  ORDER BY FirstName, LastName";
...
<table align="center">
      ...
      <tr>
        <td colspan="2" class="red_bold">All players currently playing Billiards in season S1 and have played more than 1 match, scroll to bottom of page to send email</td>
      </tr>
      <tr>
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td align="right" class="greenbg"><span class="greenbg"><a href="Bulk_email_help.pdf">Bulk Email help</a></span></td>
    </tr>
    <tr>
