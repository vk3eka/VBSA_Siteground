...
<table width="1000" align="center">
  ...
  <tr>
    <td colspan="4" align="center" nowrap="nowrap"><span class="red_bold" >Players that have been deactivated in <?php echo date("Y") ?></span><span class="greenbg">&nbsp;&nbsp;&nbsp; <a href="user_files/member.php">When is a person considered a member?</a></span></td>
  </tr>
  <tr>
    <td class="greenbg">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <?php 
	...
	?>
	    <tr>
	      ...
	      <td align="center"><?php echo ($row_memb_display['CSnooker']+$row_memb['CBilliards']); ?></td>
