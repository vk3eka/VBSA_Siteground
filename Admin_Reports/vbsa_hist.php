...
$query_History = "Select members.MemberID, members.LastName, FirstName, HomePhone, MobilePhone, Email, ReceiveEmail, HomeState FROM members WHERE (MemberID != 1 AND MemberID != 10 AND MemberID != 100 AND MemberID != 500 AND MemberID != 1000) AND contact_only = 0 " . $filter . " ORDER BY LastName, FirstName";
...
$query_memb = "Select members.MemberID, members.LastName, FirstName, HomePhone, MobilePhone, Email, ReceiveEmail, HomeState FROM members WHERE (MemberID != 1 AND MemberID != 10 AND MemberID != 100 AND MemberID != 500 AND MemberID != 1000) AND contact_only = 0 and (ReceiveEmail = 1 AND Email != '') " . $filter . " ORDER BY LastName, FirstName";
...
<table border="1" align="center" cellpadding="1" class="page">
  ...
  <table width="885" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="188"><h2 align="center">&nbsp;</h2></td>
      <td>&nbsp;</td>
