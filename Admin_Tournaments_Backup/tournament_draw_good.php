...
if(isset($_GET['tourn_id']))
{
  ...
  //echo("Here<br>");
  //include "test_draw_order.php&tournament=" . $tournamntID;
  ...
  */
  ...
  if($total_players == 0)
  {
    //include 'draw_order_include.php';
...
?>
  ...
  while($build_tourn = $result_tourn_players->fetch_assoc())
  {
    ...
    $image_src = 'change_player_1.png';
    echo("<div class='team-item' style='width:200px'><input type='text' id='R" . $total_players . "_seed_" . ($x+1) . "' value='" . $build_tourn['ranknum'] . "' style='width:35px'><input type='text' value='" . $fullname . "' id='R" . $total_players . "_name_" . ($x+1) . "' style='width:120px'><input type='text' id='R" . $total_players . "_score_" . ($x+1) . "' style='width:20px' readonly value=''><img src='$image_src' id='R" . $total_players . "_user_" . ($i+1) . "'  width='30' height='30'>");
  ...
  if($total_players > 64)
  {
    ...
    for($i = 0; $i < 64; $i++)
    {
      echo("<div class='team-item' style='width:200px'><input type='text' id='R64_name_" . ($i+1) . "'  value='' style='width:120px'><input type='text' id='R64_score_" . ($i+1) . "' value='' style='width:20px'><img src='$image_src' id='R64_user_" . ($i+1) . "'  width='30' height='30'>");
  ...
  if($total_players > 16)
  {
    ...
    for($i = 0; $i < 16; $i++)
    {
      ...
      echo("<img src='change_player_1.png' id='R16_user_" . ($i+1) . "'  width=30 height=30>");
      echo("<input type='hidden' value='' id='R16_id_" . ($i+1) . "'><br><time><input type='text' class='time' id='R16_time_" . ($i+1) . "' value='' style='width:50px'></time></div>");
    }
    echo("</div>");
  }
  ...
  if($total_players > 8)
  {
    ...
    for($i = 0; $i < 8; $i++)
    {
      echo("<div class='team-item' style='width:200px'><input type='text' id='R8_name_" . ($i+1) . "' style='width:120px' value=''><input type='text' id='R8_score_" . ($i+1) . "' value='' style='width:20px'><img src='$image_src' id='R8_user_" . ($i+1) . "'  width=30 height=30><input type='hidden' value='' id='R8_id_" . ($i+1) . "' style='width:20px'><br><time><input type='text' id='R8_time_" . ($i+1) . "' value='' style='width:50px'></time></div>");
    }
    echo("</div>");
  }
  ...
  if($total_players > 4)
  {
    ...
    for($i = 0; $i < 4; $i++)
    {
      echo("<div class='team-item' style='width:200px'><input type='text' id='R4_name_" . ($i+1) . "' style='width:120px' value=''><input type='text' id='R4_score_" . ($i+1) . "' value='' style='width:20px'><img src='$image_src' id='R4_user_" . ($i+1) . "'  width=30 height=30><input type='hidden' value='' id='R4_id_" . ($i+1) . "' style='width:20px'><br><time><input type='text' id='R4_time_" . ($i+1) . "' value='' style='width:50px'></time></div>");
    }
    echo("</div>");
  }
  ...
  if($total_players > 2)
  {
    ...
    for($i = 0; $i < 2; $i++)
    {
      echo("<div class='team-item' style='width:200px'><input type='text' id='R2_name_" . ($i+1) . "' style='width:120px' value=''><input type='text' id='R2_score_" . ($i+1) . "' value='' style='width:20px'><img src='$image_src' id='R2_user_" . ($i+1) . "'  width=30 height=30><input type='hidden' value='' id='R2_id_" . ($i+1) . "' style='width:20px'><br><time><input type='text' id='R2_time_" . ($i+1) . "' value='' style='width:50px'></time></div>");
    }
    echo("</div>");
  }
