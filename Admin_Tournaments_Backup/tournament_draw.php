...
function DeleteDraw() {
    ...
    alert(document.tournament_draw.TournamentID.value);
    document.tournament_draw.submit();
}
...
<table align="center" cellpadding="5" cellspacing="5" width='50%'>
  ...
  <!--<tr>
    <td colspan='3' align="center" class="greenbg"><a href="" onclick="DeleteDraw()">Reset all Data for This Tournament Draw</a></td>
  </tr>-->
</table>
<?php
...
$(document).ready(function()
{
  ...
  $.fn.getNewData = function (tourn_id)
  {
    alert("Here");
    $.ajax({
      url:"get_draw_order.php?tournament=" + tourn_id,
      method: 'GET',
...
*/
  ...
  else
  {
    ...
    /*
    echo("Day 1 (Players) " . $matches_day1 . "<br>");
    echo("Day 2 (Players) " . $matches_day2 . "<br>");
    echo("Day 3 (Players) " . $matches_day3 . "<br>");
    echo("Day 4 (Players) " . $matches_day4 . "<br>");
    echo("Total Matches (Players) " . ($total_players*2) . "<br>");
    */
    ...
    while($build_scores_table = $result_score_table->fetch_assoc())
    {
      ...
      if(($build_scores_table['id'] <= 32))
    //if(($build_scores_table['id'] > 64) && ($build_scores_table['id'] < (64+32+1)))
      {
        $rounds = 32;
      ...
      if(($build_scores_table['id'] > 32) && ($build_scores_table['id'] < (32+16+1)))
    //if(($build_scores_table['id'] > (64+32)) && ($build_scores_table['id'] < (64+32+16+1)))
      {
        $rounds = 16;
      ...
      if(($build_scores_table['id'] > (32+16)) && ($build_scores_table['id'] < (32+16+8+1)))
    //if(($build_scores_table['id'] > (64+32+16)) && ($build_scores_table['id'] < (64+32+16+8+1)))
      {
        $rounds = 8;
      ...
      if(($build_scores_table['id'] > (32+16+8)) && ($build_scores_table['id'] < (32+16+8+4+1)))
    //if(($build_scores_table['id'] > (64+32+16+8)) && ($build_scores_table['id'] < (64+32+16+8+4+1)))
      {
        $rounds = 4;
      ...
      if(($build_scores_table['id'] > (32+16+8+4)) && ($build_scores_table['id'] < (32+16+8+4+2+1)))
        //if(($build_scores_table['id'] > (64+32+16+8+4)) && ($build_scores_table['id'] < (64+32+16+8+4+2+1)))
      {
        $rounds = 2;
      ...
      if(($build_scores_table['id'] > (32+16+8+4+2)) && ($build_scores_table['id'] < (32+16+8+4+2+1+1)))
        //if(($build_scores_table['id'] > (64+32+16+8+4+2)) && ($build_scores_table['id'] < (64+32+16+8+4+2+1+1)))
      {
        $rounds = 1;
        echo("document.getElementById('R" . $rounds . "_time_" . ($p+1) . "').value = '" . $build_scores_table['time'] . "';");
        echo("document.getElementById('R" . $rounds . "_day_" . ($p+1) . "').value = '" . $build_scores_table['day'] . "';");
        $p++;
      }
      ...
      //$rounds = 64;
      //for($i = 0; $i < ($matches_day1); $i++)
      //{
        /*if(($build_scores_table['id'] < ($rounds)))
        //if($build_scores_table['matches_day_1'] == ($i+1) . "_1")
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($i+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($i+1) . "').value = '" . $build_scores_table['day'] . "';");
        }*/
        //else if($build_scores_table['matches_day_1'] == ($i+1) . "_2")
        /*{
          echo("document.getElementById('R" . $rounds . "_time_" . ($i+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($i+1) . "').value = '" . $build_scores_table['day_1'] . "';");
        }*/
        //echo("console.log(" . ($i+1) . ");");
      //}

      /*for($i = $matches_day1; $i < ($matches_day1+$matches_day2); $i++)
      {
        if(($build_scores_table['id'] == ($i+1)))
        //if($build_scores_table['matches_day_2'] == ($i+1) . "_1")
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($i+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($i+1) . "').value = '" . $build_scores_table['day'] . "';");
        }*/
        /*if($build_scores_table['matches_day_2'] == ($i+1) . "_2")
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($i+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($i+1) . "').value = '" . $build_scores_table['day_2'] . "';");
        }*/
      //}

      /*for($i = ($matches_day1+$matches_day2); $i < $matches_day3; $i++)
      {
        if(($build_scores_table['id'] == ($i+1)))
        //if($build_scores_table['matches_day_3'] == ($i+1) . "_1")
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($i+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($i+1) . "').value = '" . $build_scores_table['day'] . "';");
        }*/
        /*if($build_scores_table['matches_day_3'] == ($i+1) . "_2")
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($i+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($i+1) . "').value = '" . $build_scores_table['day'] . "';");
        }*/
      }
      //echo("console.log('i Index " . ($i+1) . "');");
      //echo("console.log('x Index " . ($x+1) . "');");
      
/*
      $rounds = 32;
      for($y = 0; $y < ($matches_day1); $y++)
      {
        echo("console.log('Round Index " . ($x+1) . "');");
        if($build_scores_table['id'] == ($x+1))
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($y+1) . "').value = '" . $build_scores_table['time'] . "';");
          echo("document.getElementById('R" . $rounds . "_day_" . ($y+1) . "').value = '" . $build_scores_table['day'] . "';");
        }
      }
      for($y = $matches_day1; $y < ($matches_day1+$matches_day2); $y++)
      {
        if(($build_scores_table['id'] == ($x+1)))
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($y+1) . "').value = '" . $build_scores_table['time'] . "';");
      ...
      for($y = ($matches_day1+$matches_day2); $y < $matches_day3; $y++)
      {
        if(($build_scores_table['id'] == ($x+1)))
        {
          echo("document.getElementById('R" . $rounds . "_time_" . ($y+1) . "').value = '" . $build_scores_table['time'] . "';");
      ...
      echo("console.log('Rounds " . ($rounds) . "');");
      echo("console.log('Index " . ($x+1) . "');");
      $x++;
    }
*/
    /*mysqli_data_seek($result_score_table,0);
    $x = 1;
    while($build_scores_table = $result_score_table->fetch_assoc())
    {
      $rounds = 32;
      echo("document.getElementById('R" . $rounds . "_time_" . $x . "').value = '" . $build_scores_table['r_' . $rounds . '_time'] . "';");
      echo("document.getElementById('R" . $rounds . "_day_" . $x . "').value = '" . $build_scores_table['r_' . $rounds. '_day'] . "';");
      $x++;
    }
    */
    ...
    /*
    // fill day and time from tourn scores table
    ...
    while($build_scores_table = $result_score_table->fetch_assoc())
    {
        while ($rounds > 1)
        {
            for($i = 1; $i <= $rounds; $i++)
            {
                //echo("console.log(R" . $rounds . "_time_" . $i . ");");
                echo("document.getElementById('R" . $rounds . "_time_" . $i . "').value = '" . $build_scores_table['r_' . $rounds . '_time'] . "';");
                echo("document.getElementById('R" . $rounds . "_day_" . $i . "').value = '" . $build_scores_table['r_' . $rounds . '_day'] . "';");
            }
            $rounds = $rounds/2;
        }
    }
    */
    ...
    while($build_scores = $result_scores->fetch_assoc())
    {
      ...
      if($build_scores['r_128_position'] != 0)
      {
        ...
        //echo("document.getElementById('R128_time_" . $R128_Pos . "').value = '" . $build_scores['r_128_time'] . "';");
        //echo("document.getElementById('R128_day_" . $R128_Pos . "').value = '" . $build_scores['r_128_day'] . "';");
        // modal R128
      ...
      if($build_scores['r_64_position'] != 0)
      {
        ...
        //echo("document.getElementById('R64_time_" . $R64_Pos . "').value = '" . $build_scores['r_64_time'] . "';");
        //echo("document.getElementById('R64_day_" . $R64_Pos . "').value = '" . $build_scores['r_64_day'] . "';");
        // modal R64
      ...
      if($build_scores['r_32_position'] != 0)
      {
        ...
        //echo("document.getElementById('R32_day_" . $R32_Pos . "').value = '" . $build_scores['r_32_day'] . "';");
        // modal R32
      ...
      //if(($total_players > 8) && ($total_players <= 16))
      {
        ...
        //echo("document.getElementById('R16_time_" . $R16_Pos . "').value = '" . $build_scores['r_16_time'] . "';");
        //echo("document.getElementById('R16_day_" . $R16_Pos . "').value = '" . $build_scores['r_16_day'] . "';");
        // modal R16
...
?>
  ...
  else
  {
    ...
    //$query_tourn_players = 'Select * FROM tournament_scores LEFT JOIN members on member_id=MemberID LEFT JOIN tournaments on tournament_scores.tourn_id=tournaments.tourn_id where tournament_scores.tourn_id = ' . $tournament_id . ' and LastName != "" Order by ranknum = 0 ASC, ranknum ASC';
  ...
  if($total_players > 16)
  {
    echo("<div class='bracket bra                                                                                                                                                                                                                                                                                                                                                                                                     cket-2'>");
    for($i = 0; $i < 16; $i++)
    {
  ...
  if($total_players > 1)
  {
    ...
    echo("<div class='team-item' style='width:200px'><input type='text' id='R1_name_1' style='width:120px' value=''><input type='hidden' value='' id='R1_id_1' style='width:20px'><br><time><input type='text' id='R2_day_1' value='' style='width:50px'><input type='text' id='R2_time_1' value='' style='width:50px'></time></div>");
    echo("</div>");
  }
