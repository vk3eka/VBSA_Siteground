...
//$tournament_id = $_GET['tourn_id']; 
    ...
    while($build_players = $result_tourn_zero->fetch_assoc())
    {
        ...
        //echo("Zero " . "Round: 1, Index: " . ($zero_index+1) . ", MemberID: " . $build_players['MemberID'] . ", Rank: " . $rank_num . ", Time: " . $build_players['time_' . $total_players] . "<br>");
