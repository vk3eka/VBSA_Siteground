...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateCalSQL = sprintf("Update calendar SET event=%s, venue=%s, `state`=%s, aust_rank=%s, ranking_type=%s, startdate=%s, finishdate=%s, entry_close=%s, about=%s, tourn=%s, visible=%s, footer1=%s, footer2=%s, footer3=%s, footer4=%s WHERE tourn_id=%s",
...
//echo("Update Cal " . $updateCalSQL . "<br>");
  ...
  $updateTournSQL = sprintf("Update tournaments SET tourn_name=%s, tourn_year=%s, site_visible=%s, tourn_type=%s, ranking_type=%s, tourn_class=%s, how_seed=%s, move_top_seed=%s, matches_day_1=%s, matches_day_2=%s, matches_day_3=%s, matches_day_4=%s, best_of_128=%s, best_of_64=%s, best_of_32=%s, best_of_16=%s, best_of_8=%s, best_of_4=%s, best_of_2=%s, ave_time_best_of_128=%s, ave_time_best_of_64=%s, ave_time_best_of_32=%s, ave_time_best_of_16=%s, ave_time_best_of_8=%s, ave_time_best_of_4=%s, ave_time_best_of_2=%s, time_128=%s, time_64=%s, time_32=%s, time_16=%s, time_8=%s, time_4=%s, time_2=%s, status=%s WHERE tourn_id=%s",
                      GetSQLValueString($_POST['event'], "text"),
                      ...
                      GetSQLValueString($_POST['ave_time_best_of_128'], "double"),
                      GetSQLValueString($_POST['ave_time_best_of_64'], "double"),
                      GetSQLValueString($_POST['ave_time_best_of_32'], "double"),
                      GetSQLValueString($_POST['ave_time_best_of_16'], "double"),
                      GetSQLValueString($_POST['ave_time_best_of_8'], "double"),
                      GetSQLValueString($_POST['ave_time_best_of_semis'], "double"),
                      GetSQLValueString($_POST['ave_time_best_of_finals'], "double"),
...
function doOnLoad() {
  ...
  var myclosedate;  
  myclosedate = new dhtmlXCalendarObject("entry_close");
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td>&nbsp;</td>
        <td><input type="text" name="event" value="<?php echo htmlentities($row_tourn1['tourn_name'], ENT_COMPAT, 'utf-8'); ?>" size="50" /> 50 Characters Max</td>
      </tr>
      <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select name="venue">
        ...
        echo("<option value='" . $row_Cal_edit['venue'] . "'>" . $row_Cal_edit['venue'] . "</option>");
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="entry_close" id="entry_close" value="<?php echo $row_Cal_edit['entry_close']; ?>" size="15" />
    ...
    <tr valign="baseline">
        ...
        <td><select name="top_seed">
          <option value="<?= $row_tourn1['move_top_seed'] ?>"><?= $row_tourn1['move_top_seed'] ?></option>
