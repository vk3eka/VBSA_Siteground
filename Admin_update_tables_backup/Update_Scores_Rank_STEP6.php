...
<body>
  ...
  <table align="center">
    ...
    <tr>
      <td colspan="4" align="center">STEP 6 of the calculation process</td>
    </tr>
    <tr>
...
function BilliardRP($year, $current_season)
{
  ...
  { 
    ...
    if($row_RPindividual['scrsID'] > 0)
    {
      ...
      //$update = mysql_query($querytoexecute, $connvbsa); 
      //if(!$update )
      //{
    ...
    $query = "Update scrs set total_RP = (Select SUM(" . $tier_rp . ") as total_RP) WHERE MemberID=" . $row_RPall['MemberID'] . " AND current_year_scrs = YEAR(CURDATE( ))-1  AND game_type='Billiards' AND scr_season='S2'";
    echo($query . "<br>");
...
*/
  echo '<br/>'.'<br/>';
  echo "<font face='arial'>End of Test Victorian Billiard Rankings";
  mysql_close ($connvbsa);
}
else
{
  echo '<center/>';
  echo "<form id='form1' name='form1' method='post' action='../Admin_update_tables/Update_Scores_Rank_STEP6.php?submit=1'>";
