                ...
                if($num_rows > 0)
                {
                    ...
                    if($num_rows > 0)
                    {
                        while ($build_data_player = $result_players->fetch_assoc())
                        {
                            ...
                            echo("</td>");
                            echo("<td align='center'><a id='savebutton_" . $i . "' class='btn btn-primary btn-xs'  href='javascript:;' onclick='$.fn.SaveButton(" . $build_data_player['MemberID'] . ", " . $i . "); 'style='width:200px'>Add as New Captain</a></td>");
                            echo("</tr>"); 
                            $i++;
                        } 
                    }
