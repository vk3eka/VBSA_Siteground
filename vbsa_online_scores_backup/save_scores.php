...
elseif($_GET['Type'] == "Billiards")
{
  for($i = 0; $i < sizeof($packedscoredata); $i++)
  {
    ...
    $sql_tier = "Select * from tbl_team_grade where grade = '" . $team_grade . "' AND season = '" . $season . "' AND fix_cal_year = " . $current_year;
    //echo($sql_tier . "<br>");
    ...
    $tier_rp = $build_data['tier' . substr($score1[18],0,1) . '_rp'];
    //echo($tier_rp . "<br>");
