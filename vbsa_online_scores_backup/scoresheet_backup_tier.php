...
//$sql = "Select distinct members.MemberID, members.FirstName, members.LastName, scrs.count_played from members, scrs WHERE scrs.MemberID=members.MemberID group by memberid Order By LastName";
