...
if($num_rows_check == 0)
{
	...
	$sql_rp = "Select grade, RP from tbl_team_grade where grade = '" . $team_grade . "'";
...
if($memberID == 2)
{
	// send email to if Robin Beggs appears
	$subject = 'VBSA New Player (Robin Beggs)';  
	$message = '<html><body>';
	$message .= "<p>Scores Registrar</p>";
	$message .= "<p>&nbsp;</p>";
	$message .= "<p>A new player has been added.</p>";
	$message .= "<p>Added on: - " . date('Y-m-d') . ".</p>";
	$message .= "<p>MemberID: - " . $memberID . ".</p>";
	$message .= "<p>Grade: - " . $team_grade . ".</p>";
	$message .= "<p>Playing for: - " . $clubname . ".</p>";
	$message .= "<p>&nbsp;</p>";
	$message .= "<p>Thanks.</p>";
