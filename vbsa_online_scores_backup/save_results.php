...
$sql_grades = "Select * From tbl_team_grade Where grade = '" . $team_grade . "' AND fix_cal_year = " . $current_year . " AND season = '" . $current_season . "'";
...
// get settings from grade settings table
$sql_grades = "Select * From tbl_team_grade Where grade = '" . $teamgrade . "' AND fix_cal_year = " . $current_year . " AND season = '" . $season . "'";
    ...
    //{
        ...
        while($build_forfeit = $result_forfeit->fetch_assoc())
        {
            ...
            if($type == "Snooker")
            {
                ...
                //echo('Games ' . $no_of_games . "<br>");
                //echo('Max Pts ' . $max_points_available . "<br>");
                $home_points_available = ($no_of_players*2); //8
                //echo('Home Pts ' . $home_points_available . "<br>");
                $away_points_available = -4;
                //echo('Away Pts ' . $away_points_available . "<br>");
                $adjustment_score = ($max_points_available+$away_points_available); // 8
                //echo('Adjust. Pts ' . $adjustment_score . "<br>");
            }
            elseif($type == "Billiards")
            {
            ...
            WHERE team_id=" . $team_id . " and team_grade='" . $teamgrade . "'";  
            //echo("Team Entries adjustment Update " . $sql_team_forfeit ."<br>");
