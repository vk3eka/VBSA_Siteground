...
<div class="italic">
      ...
      <p class="text-center right_title">Referees</p>
      <p class="text-center">Want to be a referee?</p>
      ...
      <p class="text-center">Or, <a href="mailto:larry147@optusnet.com.au" target="_blank">Email Larry</a></p>
      <p class="text-center">&nbsp;</p>
  		</div>
...
<?php include '../includes/buttons_left.php';?> 
  ...
  <div ID="News_container">
    ...
    <div class="Page_heading_container">
 		<div class="index_title"><span class="h4">Referee Profiles </span></div>
