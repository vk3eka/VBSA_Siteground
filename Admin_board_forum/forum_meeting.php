...
$MM_authorizedUsers = "Webmaster,Treasurer,Administrator,Secretary,Boardmember,scoring";
...
$query_forum_topic = "SELECT date_format( post_date, '%b %e, %Y, %r' ) AS PostOn, date_format( post_edit_on, '%b %e, %Y, %r' ) AS PostEdit, post_ID, post_order, post_category, post_topic, post_content, post_by, post_date, post_edit_on, post_edit_by, post_current, last_post, date_format( last_reply, '%b %e, %Y, %r' ) AS Most_Recent_reply, CASE WHEN last_post >= last_reply THEN last_post WHEN last_reply IS NULL THEN last_post ELSE last_reply END AS MostRecentDate, forum_posts.admin_comment FROM forum_posts WHERE Blocked = 'No' AND post_category='Meeting' ORDER BY post_date DESC";
...
<table width="870" align="right">
  ...
  <tr>
    <td colspan="2" align="left" class="red_bold">Meetings</td>
  </tr>
  </table>
  ...
  <?php do { ?>
    ...
    <div class="post_bg">
      ...
      <div class="content_header">
		...
		echo '<em>' . $row_forum_topic['Most_Recent_reply'] . '</em>';
		}
		?>
