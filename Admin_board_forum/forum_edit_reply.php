...
<table width="870" align="right">
  ...
  <tr>
    <td colspan="2" align="left" class="red_bold"><span class="red_bold">Edit your reply - if a reply is edited it will then appear at the top.</span></td>
  </tr>
  </table>
...
<div id="ContentDB">
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="1000" align="center" class="table_text">
      ...
      <tr valign="baseline">
        <td width="179" height="26" align="right" valign="top" nowrap="nowrap">:</td>
        <td width="809" rowspan="2"><?php
