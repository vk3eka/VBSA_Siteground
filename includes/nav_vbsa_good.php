	...
	<!-- VBSA -->	
    	<li class="vbsa"><a class="dropdown-toggle" data-toggle="dropdown" href="#">VBSA<span class="caret"></span></a>
        	<ul class="dropdown-menu">
                ...
                <!--<li><a href="<?= $url ?>/Rankings/rankings_index.php">Rankings</a></li>-->
                ...
                <li><a href="<?= $url ?>/Admin_Tournaments/tournament_index_test.php">Tournament Draw</a></li>
                <li><a href="<?= $url ?>/CityClubs/CC_index.php">City Clubs</a></li>
                <li><a href="<?= $url ?>/VBSA/vbsa_contact.php">Contact</a></li>
     ...
     <!-- Referees -->
        <li referees class="referees"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Referees<span class="caret"></span></a>
        	<ul class="dropdown-menu">
            	...
            	<li><a href="<?= $url ?>/Referees/referee_profile.php">Referee Profiles</a></li>
                <li><a href="<?= $url ?>/Referees/referee_contact.php">Referees Contact / list of qualified</a></li>
        	</ul>
        </li>
      <!-- Testing Menus -->
