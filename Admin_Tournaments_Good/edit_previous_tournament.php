...
$query_tourn1 = "Select calendar.*, tournaments.tourn_id as tournID, tournaments.tourn_type as tourn_type, tournaments.status as status FROM calendar left join tournaments On tournaments.tourn_id=calendar.tourn_id WHERE calendar.event_id = $event_id";
//echo($query_tourn1 . "<br>");
$tourn1 = mysql_query($query_tourn1, $connvbsa) or die(mysql_error());
$row_tourn1 = $tourn1->fetch_assoc();
$totalRows_tourn1 = mysql_num_rows($tourn1);

//echo("Event " . $row_tourn1['event'] . "<br>");
//echo("Event ID " . $row_tourn1['event_id'] . "<br>");
//echo("Tourn ID " . $row_tourn1['tournID'] . "<br>");
//echo("Tourn Type " . $row_tourn1['tournType'] . "<br>");

$tourn_id = $row_tourn1['tourn_id'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $updateCalSQL = sprintf("Update calendar SET event=%s, venue=%s, `state`=%s, aust_rank=%s, ranking_type=%s, startdate=%s, finishdate=%s, closedate=%s, about=%s, tourn=%s, visible=%s, footer1=%s, footer2=%s, footer3=%s, footer4=%s, special_dates=%s, next_venue=%s, tourn_director=%s, director_of_refs=%s, referee_early=%s, referee_later=%s, dress_code=%s, current_trophy_numbers=%s, current_trophy_costs=%s, next_trophy_numbers=%s, next_trophy_costs=%s, comments=%s WHERE event_id=%s",
                       ...
                       GetSQLValueString($_POST['director_of_refs'], "text"),
                       GetSQLValueString($_POST['referee_early'], "text"),
                       GetSQLValueString($_POST['referee_later'], "text"),
                       GetSQLValueString($_POST['dress_code'], "text"),
                       ...
                       GetSQLValueString($event_id, "int"));
  //echo("Update Cal " . $updateCalSQL . "<br>");
  $Result1 = mysql_query($updateCalSQL, $connvbsa) or die(mysql_error());

  $updateTournSQL = sprintf("Update tournaments SET tourn_name=%s, tourn_year=%s, site_visible=%s, tourn_type=%s, status=%s, ranking_type=%s, tourn_class=%s, how_seed=%s, move_top_seed=%s, matches_day_1=%s, matches_day_2=%s, matches_day_3=%s, matches_day_4=%s, best_of_128=%s, best_of_64=%s, best_of_32=%s, best_of_16=%s, best_of_8=%s, best_of_4=%s, best_of_2=%s, time_day_1=%s, time_day_2=%s, time_day_3=%s, time_day_4=%s, status=%s, previous_winner=%s WHERE tourn_id=%s",
                      GetSQLValueString($_POST['event'], "text"),
...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" class="greenbg">
  ...
  <table align="center" cellpadding="5" cellspacing="5">
    <tr>
      <td align="center"><span class="red_bold">Edit selected event/tournament</span></td>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    <table align="center">
      <tr valign="baseline">
        ...
        <td>&nbsp;</td>
        <td><input type="text" name="event_id" value="<?php echo $event_id; ?>"></td>
        <td> </td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right" valign="top">Tournament ID</td>
        <td>&nbsp;</td>
        <td><input type="text" name="tourn_id" value="<?php echo $tourn_id; ?>"></td>
        <td> </td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right" valign="top">Name of event or Tournament</td>
        <td>&nbsp;</td>
        <td><input type="text" name="event" value="<?php echo htmlentities($row_tourn1['event'], ENT_COMPAT, 'utf-8'); ?>" size="50" /> 50 Characters Max</td>
      </tr>
      <tr valign="baseline">
        ...
        $CKEditor_initialValue = $row_tourn1['about'];
    ...
    <tr valign="baseline">
      ...
      <td><select name="venue">
        ...
        echo("<option value='" . $row_tourn1['venue'] . "' " . $selected . ">" . $row_tourn1['venue'] . "</option>");
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="startdate" id="startdate" value="<?php echo $row_tourn1['startdate']; ?>" size="15" />
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="finishdate" id="finishdate" value="<?php echo $row_tourn1['finishdate']; ?>" size="15" />
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="closedate" id="closedate" value="<?php echo $row_tourn1['closedate']; ?>" size="15" />
    ...
    <tr valign="baseline">
      ...
      <td><select name="state">
        <option value="" <?php if (!(strcmp("", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No Entry</option>
          <option value="ACT" <?php if (!(strcmp("ACT", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>ACT</option>
          <option value="NSW" <?php if (!(strcmp("NSW", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>NSW</option>
          <option value="NT" <?php if (!(strcmp("NT", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>NT</option>
          <option value="Qld" <?php if (!(strcmp("Qld", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Qld</option>
          <option value="SA" <?php if (!(strcmp("SA", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>SA</option>
          <option value="Tas" <?php if (!(strcmp("Tas", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Tas</option>
          <option value="Vic" <?php if (!(strcmp("Vic", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Vic</option>
          <option value="WA" <?php if (!(strcmp("WA", htmlentities($row_tourn1['state'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>WA</option>
      </select></td>
    <tr>  
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">National Ranking event (Used in Calendar ranking filter)</td>
      <td>&nbsp;</td>
      <td><select name="aust_rank">
        <option value="Yes" <?php if (!(strcmp("Yes", htmlentities($row_tourn1['aust_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Yes</option>
          <option value="No" <?php if (!(strcmp("No", htmlentities($row_tourn1['aust_rank'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
      </select></td>
    </tr>
    ...
    <tr valign="baseline">
      ...
      <td><select name="tourn">
       <option value="Yes" <?php if (!(strcmp("Yes", htmlentities($row_tourn1['tourn'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Yes</option>
          <option value="No" <?php if (!(strcmp("No", htmlentities($row_tourn1['tourn'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
      </select></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
          <td nowrap="nowrap" align="right">Victorian Ranking Points this Tournament Attracts (used in Vic rankings calculation & Calendar ranking filter) </td>
           <td>&nbsp;</td>
    ...
    <tr valign="baseline">
      ...
      <td><select name="visible">
        <option value="Yes" <?php if (!(strcmp("Yes", htmlentities($row_tourn1['visible'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Yes</option>
          <option value="No" <?php if (!(strcmp("No", htmlentities($row_tourn1['visible'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
      </select></td>
    </tr>
    <tr valign="baseline">
    ...
    <table align="center" class="page">
      <tr valign="baseline">
        <td colspan='8' align='center'><b>Used to create tournament draw</b></td>
      </tr>
    </table>
    ...
    <tr>
      <td>
        <table width="800" align="center" class="page">
          <tr valign="baseline">
            <td colspan="7" nowrap="nowrap" align="right">&nbsp;</td>
          </tr>
          <?php 
          ...
          ?>
          <tr valign="baseline">
              <td colspan='2' nowrap="nowrap" align="right">If moving the top seeds, enter how many:&nbsp;&nbsp;</td>
          ...
          <tr valign="baseline">
            <td colspan='2' nowrap="nowrap" align="right">Previous Winner&nbsp;&nbsp;</td>
            ...
            //echo($sql_previous_winner . "<br>");
            $result_previous_winner = mysql_query($sql_previous_winner, $connvbsa) or die(mysql_error());
            $winner_rows = mysql_num_rows($result_previous_winner);
            //echo("Rows " . $winner_rows . "<br>");
            if($winner_rows > 0)
            {
            ...
            {
              echo("<option value=''>No Previous Winners</option>");
            }
            ?>
            </select></td>
            <td colspan='3'>&nbsp;</td>
          ...
          <tr valign="baseline">
            <td colspan='2' nowrap="nowrap" align="right">Entered Players:&nbsp;&nbsp;</td>
            <td><?= $total_players ?></td>
            <td colspan="4" >&nbsp;</td>
          </tr>
          <tr valign="baseline">
            <td colspan='2' nowrap="nowrap" align="right">Tournament Draw Size:&nbsp;&nbsp;</td>
            <td><?= $tourn_size ?></td>
            <td colspan="4" >&nbsp;</td>
          </tr>
          <!--<tr valign="baseline">
            <td colspan='2' nowrap="nowrap" align="right">Matches to Play:</td>
            <td><?= $no_of_matches ?></td>
            <td colspan="4" >&nbsp;</td>
          </tr>-->
          <tr valign="baseline">
            <td colspan='2' nowrap="nowrap" align="right">Matches per Day:&nbsp;&nbsp;</td>
            <td colspan="5" >Day 1&nbsp;<input type='text' name="matches_day_1" size='2' value="<?= $row_tourn1['matches_day_1'] ?>">&nbsp;Day 2&nbsp;<input type='text' name="matches_day_2" size='2' value="<?= $row_tourn1['matches_day_2'] ?>">&nbsp;Day 3&nbsp;<input type='text' name="matches_day_3" size='2' value="<?= $row_tourn1['matches_day_3'] ?>">&nbsp;Day 4&nbsp;<input type='text' name="matches_day_4" size='2' value="<?= $row_tourn1['matches_day_4'] ?>"> &nbsp;Total should equal the tournament size.</td>
          </tr>
          <tr valign="baseline">
            <td  colspan="7" nowrap="nowrap" align="right">&nbsp;</td>
          </tr>
          ...
          <tr valign="baseline">
            <td colspan='2' nowrap="nowrap" align="right">Default Start Times:&nbsp;&nbsp;</td>
            <td colspan="5" >Day 1&nbsp;<input type="text" class="timepicker" name="time_day_1" value="<?= $row_tourn1['time_day_1'] ?>" size="10" />
        ...
        <table width="800" align="center" class="page">
          <tr>
            <td align="center" colspan="7"><b>Matches 'Best of' Tournament Size</b></td>
          </tr>
          <tr>
  ...
  <table width="800" style='border: 1px solid black; border-collapse: collapse' align="center" class="page">
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="special_dates" value="<?= $row_tourn1['special_dates'] ?>" size="49" /></td>
    <tr>  
    <tr valign="baseline">
      ...
      <td><select name="next_venue">
        ...
        echo("<option value='" .  $row_tourn1['next_venue'] . "'>" . $row_tourn1['next_venue'] . "</option>");
        echo("<option value='Multiple Venues'>Multiple Venues</option>");
        echo("<option value=''>--------------</option>");
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="tourn_director" value="<?= $row_tourn1['tourn_director'] ?>" size="49" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Director of Referees</td>
      <td>&nbsp;</td>
      <td><input type="text" name="director_of_refs" value="<?= $row_tourn1['director_of_refs'] ?>" size="49" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Referee standard Match, Roving, Self (early rounds)</td>
      <td>&nbsp;</td>
      <td><input type="text" name="referee_early" value="<?= $row_tourn1['referee_early'] ?>" size="49" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Referee standard Match, Roving, Self (later rounds)</td>
      <td>&nbsp;</td>
      <td><input type="text" name="referee_later" value="<?= $row_tourn1['referee_later'] ?>" size="49" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Dress code(e.g., Pennant in early rounds, formal in finals rounds)</td>
      <td>&nbsp;</td>
      <td><input type="text" name="dress_code" value="<?= $row_tourn1['dress_code'] ?>" size="49" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Current Year Trophy Numbers</td>
      <td>&nbsp;</td>
      <td><input type="text" name="current_trophy_numbers" value="<?= $row_tourn1['current_trophy_numbers'] ?>" size="10" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Current Year Trophy Costs ($)</td>
      <td>&nbsp;</td>
      <td><input type="text" name="current_trophy_costs" value="<?= $row_tourn1['current_trophy_costs'] ?>" size="10" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Next Year Trophy Numbers</td>
      <td>&nbsp;</td>
      <td><input type="text" name="next_trophy_numbers" value="<?= $row_tourn1['next_trophy_numbers'] ?>" size="10" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Next Year Trophy Costs ($)</td>
      <td>&nbsp;</td>
      <td><input type="text" name="next_trophy_costs" value="<?= $row_tourn1['next_trophy_costs'] ?>" size="10" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Comments</td>
      <td>&nbsp;</td>
      <td valign='top'><textarea name="comments" rows="4" cols="50"><?= $row_tourn1['comments'] ?></textarea></td>
    </tr>
    <tr valign="baseline">
      <td colspan='3' align='center'>&nbsp;</td>
    </tr>
  ...
  <table align="center" class="page">
    ...
    <tr>
      <td>VBSA</td>
      <td><input type="checkbox" name="footer1" value="Y" id="footer1" <?php if (!(strcmp(htmlentities($row_tourn1['footer1'], ENT_COMPAT, 'utf-8'),"Y"))) {echo "checked=\"checked\"";} ?> /></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="checkbox" name="footer2" value="Y" id="footer2" <?php if (!(strcmp(htmlentities($row_tourn1['footer2'], ENT_COMPAT, 'utf-8'),"Y"))) {echo "checked=\"checked\"";} ?> /></td>
    ...
    <tr>
      ...
      <td width="20"><input type="checkbox" name="footer3" value="Y" id="footer3" <?php if (!(strcmp(htmlentities($row_tourn1['footer3'], ENT_COMPAT, 'utf-8'),"Y"))) {echo "checked=\"checked\"";} ?> /></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="checkbox" name="footer4" value="Y" id="footer4" <?php if (!(strcmp(htmlentities($row_tourn1['footer4'], ENT_COMPAT, 'utf-8'),"Y"))) {echo "checked=\"checked\"";} ?> /></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align='center'><input type="submit" value="Update Event/Tournament" /></td>
    </tr>
  </table>
