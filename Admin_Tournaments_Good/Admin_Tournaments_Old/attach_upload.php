...
$ppu->redirectURL = "../Admin_Tournaments/aa_tourn_index.php";
...
<?php include '../admin_xx_includes/db_srch.php';?>
        ...
        <tr>
          <td width="630" class="red_bold">Upload an email attachment</td>
        ...
        <tr>
          <td colspan="2" align="center" class="tst_red_text">IMPORTANT - Selected file must be a pdf file and less than 600kb or file will not upload</td>
        </tr>
      </table>
