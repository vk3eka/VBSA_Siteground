...
$query_tourn1 = "Select * FROM calendar WHERE event_id = '$event_id'";
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    <table align="center">
      <!--<tr valign="baseline">
        ...
        <td>&nbsp;</td>
        <td><input type="text" name="tourn_id" value="<?php echo $row_tourn1['event_id']; ?>"></td>
        <td> </td>
      </tr>
      <tr valign="baseline">
...
<!--
  ...
  <table width="700" style='border: 1px solid black; border-collapse: collapse' align="center" class="page">
    ...
    <tr valign="baseline">
      ...
      <td><select name="tourn_director">
        ...
        {
           echo("<option value='" . $build_member['MemberID'] . "'>" . $build_member['FirstName'] . " " . $build_member['LastName'] . "</option>");
        }
        ?>
      </select></td>
    </tr>
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td valign='top'><textarea id="comments" name="comments" rows="4" cols="50"></textarea></td>
    </tr>
    <tr valign="baseline">
      <td colspan='3' align='center'>&nbsp;</td>
    </tr>
  ...
  <table align="center" class="page">
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align='center'><input type="submit" value="Insert Event/Tournament" /></td>
    </tr>
  </table>
