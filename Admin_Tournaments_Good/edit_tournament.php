...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" class="greenbg">
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    ...
    <tr valign="baseline">
          <td nowrap="nowrap" align="right">Victorian Ranking Points this Tournament Attracts <b>(used in Vic rankings calculation & Calendar ranking filter)</b></td>
           <td>&nbsp;</td>
  ...
  <table width="800" style='border: 1px solid black; border-collapse: collapse' align="center" class="page">
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><input type="text" name="director_of_refs" value="<?= $row_Cal_edit['director_of_refs'] ?>" size="49" /></td>
    </tr>
    <tr valign="baseline">
