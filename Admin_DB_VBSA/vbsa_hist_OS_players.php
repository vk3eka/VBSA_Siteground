...
$page = "../Admin_DB_VBSA/vbsa_hist_OS_players.php";
$_SESSION['page'] = $page;
...
//$query_members = "SELECT MemberID, LastName, FirstName, HomePhone, MobilePhone, Email, ReceiveEmail, Overseas FROM members WHERE Overseas is not null ORDER BY LastName, FirstName";
$query_members = "Select MemberID, LastName, FirstName, HomePhone, MobilePhone, Email, ReceiveEmail, Overseas FROM members WHERE Overseas != '' ORDER BY LastName, FirstName";
...
<table align="center">
  <tr>
    <td class="red_bold">All players that are listed as &quot;Overseas&quot; Players (Where &quot;Overseas&quot; is not NULL)</td>
    <td class="red_bold">&nbsp;</td>
    <td class="greenbg"><a href="A_memb_index.php">Return to Members index</a></td>
  </tr>
  <tr>
    <td align="left">Scroll to the bottom of the page to send an email to all that are listed here</td>
    <td align="center">&nbsp;</td>
    <td align="right">&nbsp;</td>
  </tr>
</table>
...
<table align="center" cellpadding="2" cellspacing="2">
      <tr>
        <td colspan="9" align="center">Total Overseas players: <?php echo $totalRows_members ?></td>
      </tr>
      <tr>
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="left" class="page"><a href="tel:<?php echo $row_members['MobilePhone']; ?>"><?php echo $row_members['MobilePhone']; ?></a></td>
          <td align="center"><?php echo $row_members['ReceiveEmail']; ?></td>
          <td align="center"><?php echo $row_members['HomeState']; ?></td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4">Total interstate players with an email address:<?php echo $totalRows_to_email ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
