...
$query_History = "Select MemberID, LastName, FirstName, HomePhone, MobilePhone, Email, ReceiveEmail, Junior, dob_day, dob_mnth, dob_year, HomeState FROM members WHERE (Junior != 'na' AND Junior != 'U21') ORDER BY LastName";
...
$query_memb = "Select MemberID, LastName, FirstName, HomePhone, MobilePhone, Email, ReceiveEmail, Junior, dob_day, dob_mnth, dob_year, Homestate FROM members WHERE (Junior != 'na' AND Junior != 'U21') AND ReceiveEmail = 1 AND Email != '' ORDER BY LastName";
...
<table border="1" align="center" cellpadding="1" class="page">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center"><?php echo $row_History['Junior']; ?></td>
