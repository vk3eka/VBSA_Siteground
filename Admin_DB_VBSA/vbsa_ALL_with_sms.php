...
$page = "../Admin_DB_VBSA/vbsa_ALL_with_sms.php";
$_SESSION['page'] = $page;
...
$query_memb = "Select MemberID, FirstName, LastName, MobilePhone, Email, ReceiveEmail, ReceiveSMS, memb_by, curr_memb FROM members WHERE (ReceiveSMS != 0 and MemberID != 1 AND MemberID != 100 AND MemberID != 500 AND MemberID != 1000 AND Deceased !=1) ORDER BY LastName, FirstName ";
...
<table width="1000" align="center">
  ...
  <tr>
    <td colspan="4" align="center" nowrap="nowrap"><span class="red_bold" >All VBSA records (active or inactive members) who approved SMS messages.</td>
  </tr>
  <tr>
    <td class="greenbg">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2" class="greenbg" align="center"><a href="export_csv.php?page=vbsa_all_sms">Export Current Data To CSV File</a></td>
