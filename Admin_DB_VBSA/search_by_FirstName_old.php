...
//$page = "../Admin_DB_VBSA/search_by_FirstName.php?searchthis=$searchthis"  ;
//$_SESSION['page'] = $page;
$MM_authorizedUsers = "";
...
$query_History = "SELECT MemberID, LastName, FirstName, HomePhone, WorkPhone, MobilePhone, Email, ReceiveEmail, Club, LastUpdated, UpdateBy, entered_on, memb_by FROM members WHERE FirstName LIKE CONCAT('$searchthis','%') ORDER BY LastName ASC";
...
<?php include '../admin_xx_includes/db_srch.php';?>
  ...
  <table width="1000" border="0" align="center">
    <tr>
      <td colspan="3" align="left"><span class="red_bold">Search Results by First Names beginning with "<?php echo $searchthis ?>"</span></td>
      <td align="center">&nbsp;</td>
    </tr>
    <tr>
