...
$page = "../Admin_DB_VBSA/vbsa_members_playing.php";
$_SESSION['page'] = $page;
...
<?php
/*
$tfm_orderby =(!isset($_GET["tfm_orderby"]))?"LastName, FirstName":$_GET["tfm_orderby"];
$tfm_order =(!isset($_GET["tfm_order"]))?"ASC":$_GET["tfm_order"];
$sql_orderby = $tfm_orderby." ".$tfm_order;
$sql_orderby = tfm_cleanOrderBy($sql_orderby, "LastName, FirstName");
*/
?>
<?php
...
/*$sqlorderby_curr_play = "LastName, FirstName";
...
while (list($key,$val) = each($tfm_saveParams)) {
	...
	if(isset($_POST[$val]))$tfm_keepParams .= ($val)."=".urlencode($_POST[$val])."&pagename=".$pagename;
}
...
<?php include '../admin_xx_includes/db_srch.php';?>
    ...
    <table align="center">
      ...
      <tr>
        <td colspan="2" class="red_bold">All players playing in <?php echo date("Y") ?> (players may appear multiple times if playing in more than one grade) </td>
      </tr>
      <tr>
...
<table align="center" cellpadding="2" cellspacing="2">
      <tr class="page">
        ...
        <td align="left" nowrap="nowrap">Team Name</td>
        <td align="left" nowrap="nowrap">Team Club</td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="left" class="page"><a href="tel:<?php echo $row_curr_play['MobilePhone']; ?>" ><?php echo $row_curr_play['MobilePhone']; ?></a></td>
          <td align="left" class="page"><a href="mailto:<?php echo $row_curr_play['Email']; ?>" target="_blank"><?php echo $row_curr_play['Email']; ?></a></td>
          ...
          <td align="center" nowrap="nowrap" class="greenbg"><a href="../A_common/vbsa_member_edit_form.php?memb_id=<?php echo $row_curr_play['MemberID']; ?>" title="Insert / update membership form details">Memb</a></td>
