...
$page = "../Admin_DB_VBSA/vbsa_ALL.php";
$_SESSION['page'] = $page;
...
$query_memb = "Select MemberID, FirstName, LastName, MobilePhone, Email, ReceiveEmail, ReceiveSMS, curr_memb FROM members WHERE (MemberID != 1 AND MemberID != 100 AND MemberID != 500 AND MemberID != 1000 AND Deceased !=1) ORDER BY LastName, FirstName";
...
<table width="1000" align="center">
  ...
  <tr>
    <td colspan="4" align="center" nowrap="nowrap"><span class="red_bold" >All VBSA records (active or inactive members)</td>
  </tr>
  <tr>
    <td class="greenbg">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2" class="greenbg" align="center"><a href="export_csv.php?page=vbsa_all">Export Current Data To CSV File</a></td>
