...
if ($_POST['ButtonName'] == "CopySelected")
{
  ...
  for ($i = 0; $i < count($keys); $i++) 
  {
    ...
    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        GetSQLValueString($applications[18], "text"),
        GetSQLValueString($applications[19], "date"),
        'NULL',
        '"Online"',
        GetSQLValueString($applications[18], "date"),
        '"Online"',
        GetSQLValueString($applications[18], "date"),
        GetSQLValueString($applications[20], "text"),
        GetSQLValueString($applications[21], "text"));
    //mysql_select_db($database_connvbsa, $connvbsa);
    echo($insertSQL . "<br>");
    $Result1 = mysql_query($insertSQL, $connvbsa) or die(mysql_error());

    // move original entry to archive
    $updateArchive = "Update tbl_membership_online set archive = 1 where id  = " . $applications[22];  
    mysql_select_db($database_connvbsa, $connvbsa);
    echo($updateArchive . "<br>");; 
...
if ($_POST['ButtonName'] == "Delete")
{
  ...
  $packeddata = json_decode(stripslashes($_POST['PackedData']), true);
  foreach($packeddata as $item => $id) {
    $updateSQL = "Delete From tbl_membership_online where id  = " . $id;  
    //mysql_select_db($database_connvbsa, $connvbsa);
    //echo($updateSQL); 
    $result = mysql_query($updateSQL, $connvbsa) or die(mysql_error());
  }
  ...
  for(var i = 0; i < no_of_applications; i++) // get number of applications received
  {
    ...
    {    
      transferdata[i] = document.getElementById("lastname_" + i).innerHTML + ", " +
                        ...
                        document.getElementById("country_" + i).innerHTML + ", " +
                        ...
                        document.getElementById("junior_" + i).innerHTML + ", " +
...
function DeleteSelectedButton(no_of_applications)  
{
  //alert("Here");
  var transferdata = {};
  for(var i = 0; i < no_of_applications; i++) // get number of applications
...
<table align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td align="center"><button style='width:300px' onclick="CopySelectedButton(<?= $totalRows_memb ?>)">Save Selected to Members.</button></td>
    ...
    <td align="center"><button style='width:300px' onclick="DeleteSelectedButton(<?= $totalRows_memb ?>)">Delete Selected.</button></td>
  </tr>
  <tr>
    <td colspan="4" class="greenbg" align="center"><a href="export_csv.php?page=vbsa_online">Export Archive Data To CSV File</a></td>
  </tr>
</table>
...
?>
   <tr>
    <td colspan="24" align="center" nowrap="nowrap"><b>Pending Membership Applications.</b></td>
  </tr>
  <tr>
    ...
    <td align="left" nowrap="nowrap">Country</td>
    ...
    <td align="center" nowrap="nowrap">Junior</td>
    <td align="center" nowrap="nowrap">New/Renewal</td>
    <td align="center" nowrap="nowrap">How Heard.</td>
    <td align="center" nowrap="nowrap">Pennant</td>
    <td align="center" nowrap="nowrap">City Club Pennant</td>
    <td align="center" nowrap="nowrap">Tournament</td>
  ...
  do {
    ...
    <tr>
      ...
      <td nowrap="nowrap" id='country_<?= $i ?>'><?php echo $row_memb['Country']; ?></td>
      ...
      echo("<td align='center' id='junior_" . $i . "'>" . $row_memb['Junior'] . "</td>");
      echo("<td align='center' id='renewal_" . $i . "'>" . $row_memb['new_renewal'] . "</td>");
      echo("<td align='center' id='how_hear_" . $i . "'>" . $row_memb['how_hear'] . "</td>");

      //echo("<td align='center' id='reason_" . $i . "'>" . $row_memb['reason'] . "</td>");
      if($row_memb['pennant'] == 1)
      {
        echo("<td align='center'><input type='checkbox' id='pennant_" . $i . "' checked disabled></td>");
      }
      else
      {
        echo("<td align='center'><input type='checkbox' id='pennant_" . $i . "' disabled></td>");
      }
      if($row_memb['cc_pennant'] == 1)
      {
        echo("<td align='center'><input type='checkbox' id='cc_pennant_" . $i . "' checked disabled></td>");
      }
      else
      {
        echo("<td align='center'><input type='checkbox' id='cc_ennant_" . $i . "' disabled></td>");
      }
      if($row_memb['tournament'] == 1)
      {
        echo("<td align='center'><input type='checkbox' id='tournament_" . $i . "' checked disabled></td>");
      }
      else
      {
        echo("<td align='center'><input type='checkbox' id='tournament_" . $i . "' disabled></td>");
      }
...
?>
   <tr>
    <td colspan="24" align="center" nowrap="nowrap"><b>Archived Membership Applications.</b></td>
  </tr>
  <tr>
    <td align="left" nowrap="nowrap">Last Name</td>
    <td align="left" nowrap="nowrap">First Name</td>
  ...
  ?>
    <tr>
      ...
      <td nowrap="nowrap" id='country_<?= $i ?>'><?php echo $row_archive['Country']; ?></td>
      ...
      echo("<td align='center' id='junior_" . $y . "'>" . $row_archive['Junior'] . "</td>");
      echo("<td align='center' id='renewal_" . $y . "'>" . $row_archive['new_renewal'] . "</td>");
      echo("<td align='center' id='how_hear_" . $y . "'>" . $row_memb['how_hear'] . "</td>");
      //echo("<td align='center' id='reason_" . $i . "'>" . $row_memb['reason'] . "</td>");
      if($row_archive['pennant'] == 1)
      {
        echo("<td align='center'><input type='checkbox' id='pennant_" . $y . "' checked disabled></td>");
      }
      else
      {
        echo("<td align='center'><input type='checkbox' id='pennant_" . $yi . "' disabled></td>");
      }
      if($row_archive['cc_pennant'] == 1)
      {
        echo("<td align='center'><input type='checkbox' id='cc_pennant_" . $y . "' checked disabled></td>");
      }
      else
      {
        echo("<td align='center'><input type='checkbox' id='cc_ennant_" . $y . "' disabled></td>");
      }
      if($row_archive['tournament'] == 1)
      {
        echo("<td align='center'><input type='checkbox' id='tournament_" . $y . "' checked disabled></td>");
      }
      else
      {
        echo("<td align='center'><input type='checkbox' id='tournament_" . $y . "' disabled></td>");
      }
      ...
      ?>
      <td align="center"><input type="radio" name="action_<?= $y ?>"  id="copy_to_members_<?= $y ?>" disabled /></td>
      <td align="center"><input type="radio" name="action_<?= $y ?>"  id="clear_<?= $y ?>" disabled /></td>
    </tr>
    <?php 
    $y++;
