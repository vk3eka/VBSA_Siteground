...
//echo("Name " . $score_3[0] . "<br>");

$sql = "Select *, Concat(FirstName, ' ', LastName) as FullName FROM members WHERE Concat(FirstName, ' ', LastName) Like '%" . trim($score_1[1]) . "%'";
echo($sql . "<br>");
...
$sql = "Select *, Concat(FirstName, ' ', LastName) as FullName FROM members WHERE Concat(FirstName, ' ', LastName) Like '%" . trim($score_2[1]) . "%'";
echo($sql . "<br>");
$result_member = mysql_query($sql, $connvbsa) or die(mysql_error());
$build_member = $result_member->fetch_assoc();
...
r_" . $score_1[0] . "_to_break_1 = '" .  $score_1[17] . "',
r_" . $score_1[0] . "_to_break_2 = '" .  $score_1[18] . "',
r_" . $score_1[0] . "_to_break_3 = '" .  $score_1[19] . "',
r_" . $score_1[0] . "_to_break_4 = '" .  $score_1[20] . "',
r_" . $score_1[0] . "_to_break_5 = '" .  $score_1[21] . "',
r_" . $score_1[0] . "_to_break_6 = '" .  $score_1[22] . "',
r_" . $score_1[0] . "_to_break_7 = '" .  $score_1[23] . "',
r_" . $score_1[0] . "_position = '" . $score_1[24] . "'
Where tourn_id = " . $tourn_id . " and member_id = " . $member_id_1;  
echo($sql_players . "<br>");
...
r_" . $score_2[0] . "_to_break_1 = '" .  $score_2[17] . "',
r_" . $score_2[0] . "_to_break_2 = '" .  $score_2[18] . "',
r_" . $score_2[0] . "_to_break_3 = '" .  $score_2[19] . "',
r_" . $score_2[0] . "_to_break_4 = '" .  $score_2[20] . "',
r_" . $score_2[0] . "_to_break_5 = '" .  $score_2[21] . "',
r_" . $score_2[0] . "_to_break_6 = '" .  $score_2[22] . "',
r_" . $score_2[0] . "_to_break_7 = '" .  $score_2[23] . "',
r_" . $score_2[0] . "_position = '" . $score_2[24] . "'
Where tourn_id = " . $tourn_id . " and member_id = " . $member_id_2;  
echo($sql_players . "<br>");
//$update = mysql_query($sql_players, $connvbsa) or die(mysql_error());

//$score_3 = explode(",", $packedscoredata_3);
$sql_players = "Update tournament_scores Set r_" . trim($score_3[1]) . "_position = " . $score_3[2] . " Where tourn_id = " . $tourn_id . " and member_id = " . $member_id_1;  
echo($sql_players . "<br>");
//$update = mysql_query($sql_players, $connvbsa) or die(mysql_error());
