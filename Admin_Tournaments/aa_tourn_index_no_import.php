...
//$tourn_page = "http://www.vbsa.org.au/Admin_Tournaments/aa_tourn_index.php";
//$tourn_page = "http://vbsa.cpc-world.com/Admin_Tournaments/aa_tourn_index.php";
//$tourn_page = "http://172.16.10.32/VBSA_Siteground/Admin_Tournaments/aa_tourn_index_old.php";
...
$query_calendar = "Select * FROM vbsa3364_vbsa2.calendar where tourn_id != '' order by tourn_id";
...
<table width="1000" align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td colspan="5" class="red_bold">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" class="red_bold"><?php echo $cal_year; ?> Tournaments, Administrators have access to all views, cannot edit or insert financials. Treasurer has access/ edit/ insert from all views</td>
  </tr>
  <tr>
    <!--<td align="center" class="greenbg"><a href="user_files/tournament_insert.php">Insert a new tournament</a></td>-->
    <td align="center" class="greenbg"><a href="insert_tournament.php">Insert a new tournament</a></td>
    <td align="center" class="greenbg"><a href="../Admin_rankings/rankings_Vic_snooker.php">Tournament Rankings</a></td>
    <td align="center" class="greenbg"><a href="Tournament_last_50_entries.php">Last 50 entries</a></td>
    <td align="center" class="greenbg"><a href="../Admin_update_tables/Update_Scores_Rank.php">Update the Victorian Tournament Rankings</a></td>
    <td align="center" class="greenbg"><a href="../Admin_Treasurer/A_fin_index.php">Return to Treasurer index</a></td>
  </tr>
  <tr>
    <!--<td class="red_bold">&nbsp;</td>    
    <td align="center" class="greenbg"><a href="tournament_draw.php">Tournament Draw (test)</a></td>
    <td align="center" class="greenbg"><a href="insert_tournament.php">Insert New Tournament (test)</a></td>
    <td align="center" class="greenbg"><a href="edit_tournament.php?tourn_id=202283">Edit Existing Tournament (test)</a></td>-->
    <td align="center" class="greenbg" colspan='5'><a href="../Admin_DB_VBSA/export_tournament_csv.php">Export Calendar/Tournament List (test)</a></td>
    <td class="red_bold">&nbsp;</td>
  </tr>  
</table>
    <table align="center" cellpadding="5" cellspacing="5">
      ...
      <?php do { ?>
        ...
        <!--<td align="center"><?php echo $row_tourn2['tourn_id'];?></td>-->
          ...
          <td><a href="tournament_detail.php?tourn_id=<?php echo $row_tourn1['tourn_id']; ?>&tourn_type=<?php echo $row_tourn1['tourn_type']; ?>"><img src="../Admin_Images/detail.fw.png" width="20" height="20" title="View all entries" /></a></td>
          ...
          <td><a href="edit_tournament.php?tourn_id=<?php echo $row_tourn1['tourn_id']; ?>"><img src="../Admin_Images/edit_butt.png" width="20" height="20" title="Edit tournament details" /></a></td>
          
          <td class="page"><a href="test_draw_order.php?tourn_id=<?php echo $row_tourn1['tourn_id']; ?>"><img src="../images/draw.jpeg" width="20" height="20" title="Create/Edit Draw" /></a></td>

          <!--<td class="page"><a href="draw_order_calc.php?tourn_id=<?php echo $row_tourn1['tourn_id']; ?>"><img src="../images/draw.jpeg" width="20" height="20" title="Create/Edit Draw" /></a></td>-->
          ...
          <td class="page"><a href="user_files/player_edit_all.php?tourn_id=<?php echo $row_tourn1['tourn_id']; ?>">Edit All</a></td>
          <td align="center"><a href="user_files/tournament_delete_confirm.php?tournID=<?php echo $row_tourn1['tourn_id']; ?>&cal_year=<?php echo $cal_year; ?>"><img src="../Admin_Images/Trash.fw.png" height="20" /></a></td>
...
<table align="center" cellpadding="5" cellspacing="5">
      ...
      <tr>
        ...
        <td><a href="tournament_detail.php?tourn_id=<?php echo $row_tourn2['tourn_id']; ?>&tourn_type=<?php echo $row_tourn2['tourn_type']; ?>"><img src="../Admin_Images/detail.fw.png" width="20" height="20" title="View all entries" /></a></td>
        <td><a href="edit_tournament.php?tourn_id=<?php echo $row_tourn2['tourn_id']; ?>"><img src="../Admin_Images/edit_butt.png" width="20" height="20" title="Edit tournament details" /></a></td>
        
        <td class="page"><a href="test_draw_order.php?tourn_id=<?php echo $row_tourn2['tourn_id']; ?>"><img src="../images/draw.jpeg" width="20" height="20" title="Create/Edit Draw" /></a></td>
        ...
        <td class="page"><a href="user_files/player_edit_all.php?tourn_id=<?php echo $row_tourn2['tourn_id']; ?>">Edit All</a></td>
        <td align="center"><a href="user_files/tournament_delete_confirm.php?tournID=<?php echo $row_tourn2['tourn_id']; ?>&cal_year=<?php echo $cal_year; ?>"><img src="../Admin_Images/Trash.fw.png" height="20" /></a></td>
...
<table align="center" cellpadding="5" cellspacing="5">
  ...
  <tr>
    ...
    <td><?php echo $row_tourn_closed['tourn_type']; ?></td>
    <td align="center"><?php echo $row_tourn_closed['ranking_type']; ?></td>
    <td><?php echo $row_tourn_closed['status']; ?></td>
    <td><a href="tournament_detail.php?tourn_id=<?php echo $row_tourn_closed['tourn_id']; ?>&tourn_type=<?php echo $row_tourn_closed['tourn_type']; ?>"><img src="../Admin_Images/detail.fw.png" width="20" height="20" title="View all entries" /></a></td>
    <td><a href="edit_tournament.php?tourn_id=<?php echo $row_tourn_closed['tourn_id']; ?>"><img src="../Admin_Images/edit_butt.png"  width="20" height="20" title="Edit tournament details" /></a></td>


    <td class="page"><a href="test_draw_order.php?tourn_id=<?php echo $row_tourn_closed['tourn_id']; ?>"><img src="../images/draw.jpeg" width="20" height="20" title="Create/Edit Draw" /></a></td>

    <!--<td class="page"><a href="draw_order_calc.php?tourn_id=<?php echo $row_tourn_closed['tourn_id']; ?>"><img src="../images/draw.jpeg" width="20" height="20" title="Create/Edit Draw" /></a></td>-->
    ...
    <!--<td class="page"><a href="tournament_draw.php?tourn_id=<?php echo $row_tourn_closed['tourn_id']; ?>"><img src="../images/draw.jpeg" width="20" height="20" title="Create/Edit Draw" /></a></td>-->
     <td class="page"><a href="user_files/player_edit_all.php?tourn_id=<?php echo $row_tourn_closed['tourn_id']; ?>">Edit All</a></td>
    <td align="center"><a href="user_files/tournament_delete_confirm.php?tournID=<?php echo $row_tourn_closed['tourn_id']; ?>&cal_year=<?php echo $cal_year; ?>"><img src="../Admin_Images/Trash.fw.png" height="20" /></a></td>
