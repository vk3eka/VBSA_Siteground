...
<center>
<br>
<table align="center" cellpadding="5" cellspacing="5" width='1200'>
  <tr>
    <td align="center"><span class="red_bold"><h3>Tournament Draw Creation Template - <?= $tourn_size ?> Player</h3></span></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
...
<table border="1" cellpadding="0" cellspacing="0" width="1000" valign='top'>
 <tr>
  ...
  if($tourn_size > 64)
  {
    ...
    <td id='title_1'>Round 1</td>
    <td>&nbsp;</td>
    <td rowspan="2">Day</td>
    <td rowspan="2">Time</td>
    <td id='title_2'>Round 2</td>
    <td>&nbsp;</td>
    <td rowspan="2">Day</td>
    <td rowspan="2">Time</td>
    <td id='title_3'>Round 3</td>
    <td>&nbsp;</td>
    <td rowspan="2">Day</td>
    <td rowspan="2">Time</td>
    <td id='title_4'>Round 4</td>
  <?php
  }
  ?>
  <td>&nbsp;</td>
  <td rowspan="2">Day</td>
  <td rowspan="2">Time</td>
  <td id='title_5'>Round 5</td>
  <td>&nbsp;</td>
  <td rowspan="2">Day</td>
  <td rowspan="2">Time</td>
  <td id='title_6'>Round 6</td>
  <td>&nbsp;</td>
  <td rowspan="2">Day</td>
  <td rowspan="2">Time</td>
  <td id='title_7'>Round 7</td>
  <td>&nbsp;</td>
  <td id='title_8'>Round 8</td>
  <td>&nbsp;</td>
  <td id='title_9'>Round 9</td>
  <td>&nbsp;</td>
  <td id='title_10'>Round 10</td>
 </tr>
 <tr>
  <?php
  if($tourn_size > 64)
