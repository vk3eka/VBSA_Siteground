...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" class="greenbg">
  ...
  <table width="800" style='border: 1px solid black; border-collapse: collapse' align="center" class="page">
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td>Day 1&nbsp;<input type='text' name="matches_day_1" size='2' value="">&nbsp;Day 2&nbsp;<input type='text' name="matches_day_2" size='2' value="">&nbsp;Day 3&nbsp;<input type='text' name="matches_day_3" size='2' value="">&nbsp;Day 4&nbsp;<input type='text' name="matches_day_4" size='2' value=""> &nbsp;Total should equal the tournament size.</td>
    </tr>
    <tr valign="baseline">
     ...
     <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td>Day 1&nbsp;<input type="text" class="timepicker" name="time_day_1" value="" size="10" />
      &nbsp;Day 2&nbsp;<input type="text" class="timepicker" name="time_day_2" value="" size="10" />
      &nbsp;Day 3&nbsp;<input type="text" class="timepicker" name="time_day_3" value="" size="10" />
      &nbsp;Day 4&nbsp;<input type="text" class="timepicker" name="time_day_4" value="" size="10" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td>&nbsp;</td>
