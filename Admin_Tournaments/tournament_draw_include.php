...
if(isset($_GET['tourn_id']))
{
  ...
  */
  ...
  $query_score_table = 'Select * FROM tournament_day_time where tourn_id = ' . $tournament_id;
...
$(document).ready(function()
{
  ...
  $('#save_modal_button').click(function()
  {
    ...
    $.ajax({
      url:"../Admin_Tournaments/save_score_data.php?tourn_id=" + tourn_id + "&score_data_1=" + scoredata_player_1 + "&score_data_2=" + scoredata_player_2 + "&score_data_3=" + scoredata_player_3 + "&score_data_4=" + scoredata_player_4,
      method: 'GET',
  ...
  $('#save_time_button').click(function()
  {
    ...
    $.ajax({
      url:"../Admin_Tournaments/save_time_data.php?tourn_id=" + tourn_id + "&player_id=" + player + "&new_day=" + new_day + "&new_time=" + new_time + "&round_no=" + col_no,
      method: 'GET',
      success:function(data)
      {
...
function generatePDF() 
{
    ...
    var widthRatio = pageWidth / contentWidth;
    var heightRatio = pageHeight / contentHeight;
