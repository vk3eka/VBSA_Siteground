...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1"  onsubmit="return doit()" >
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="seed" value="<?php echo htmlentities($row_players1['seed'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Wildcard:</td>
      <td><input type="text" name="wcard" value="<?php echo htmlentities($row_players1['wcard'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="junior_cat" value="<?php echo $junior; ?>" size="15" /></td>
<!--
