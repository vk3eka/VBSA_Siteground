	...
	<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
      <table align="center" cellpadding="5" cellspacing="5">
        <tr valign="baseline">
          ...
          <td><input type="text" name="tourn_memb_id" id="tourn_memb_id" value="" size="10" /></td>
          <td rowspan="3">
          <!--------- Nested table starts-------------------------->
        <table>
          <tr>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="seed" value="" size="10" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Tournament Type:</td>
          <td><?php echo $row_tourn1['tourn_type']; ?> (auto inserted)</td>
          <td>&nbsp;</td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="junior_cat" id="junior_cat" value="" size="12" />&nbsp;&nbsp;(Use for Junior tournaments only) </td>
...
<script type="text/javascript">
    $(function(){
      ...
      $('#tourn_memb_id').focusout(function(e)
      {
        e.preventDefault();
        var input = $(this).val();
        //console.log(input);
