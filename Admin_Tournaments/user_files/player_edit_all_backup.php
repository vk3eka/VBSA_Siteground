...
$query_players1 = "SELECT members.MemberID, members.LastName, tourn_entry.rank_pts, members.FirstName, tourn_entry.ID, tourn_entry.tourn_memb_id, tourn_entry.tournament_number, tourn_entry.amount_entry, tourn_entry.entered_by, tourn_entry.how_paid, tourn_entry.seed, tourn_entry.junior_cat, tourn_entry.tourn_date_ent, tourn_entry.ranked, tourn_entry.wcard, members.Email, members.MobilePhone FROM tourn_entry, members WHERE tournament_number ='$tourn_id' AND members.MemberID=tourn_memb_id ORDER BY tourn_entry.junior_cat, members.FirstName";
...
<form method="post" name="form1" id="form1"  onsubmit="return doit()" >
  <table align="center" cellpadding="2" cellspacing="2">
    <tr valign="baseline">
      ...
      <td align="center" valign="baseline">Ranked</td>
...
<!-- New Rank Points Column position -->
        ...
        <td align="center"><input type="text" name="seed_<?php echo $RepeatSelectionCounter_1; ?>" value="<?php echo htmlentities($row_players1['seed'], ENT_COMPAT, 'utf-8'); ?>" size="10" /></td>
        <td align="center"><input type="text" name="wcard_<?php echo $RepeatSelectionCounter_1; ?>" value="<?php echo htmlentities($row_players1['wcard'], ENT_COMPAT, 'utf-8'); ?>" size="10" /></td>
        <td align="center"><input type="text" name="ranked_<?php echo $RepeatSelectionCounter_1; ?>" value="<?php echo htmlentities($row_players1['ranked'], ENT_COMPAT, 'utf-8'); ?>" size="10" /></td>
