...
*/
  ...
  function Header(index, tourn_size) 
  {
    ...
    html_Header += "<td class='DT_column_5'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_5'><b>Score</b></td>";
    html_Header += "<td class='DT_column_6'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_6'><b>Score</b></td>";
    html_Header += "<td class='DT_column_7'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_7'><b>Score</b></td>";
    html_Header += "<td class='DT_column_8'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_8'><b>Score</b></td>";
    html_Header += "<td class='DT_column_9'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_9'><b>Score</b></td>";
    html_Header += "<td class='DT_column_10'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_10'><b>Score</b></td>";
    html_Header += "<td class='DT_column_11'><b>Day/Time</b></td>";
    html_Header += "<td class='DT_column_11'><b>Score</b></td>";
...
for (let r = 1; r <= rounds; r++) 
{
  ...
  {
    html += "<td colspan='2' align='center'><b>Round of 16 (Best of 5)</b></td>";
  }
  else if((tourn_size === 128) && (r === 8))
  {
    html += "<td colspan='2' align='center'><b>Round of 8 <b>(Best of 5)</b></td>";
  }
  ...
  if(tourn_size === 64)
  {
    if(r === 1)
    {
      html += "<td colspan='2' align='center' class='round' value=" + r + "><b>Round of 64 (Best of " + <?= $build_best_of['best_of_1'] ?> + ")</b></td>";
    }
    else if(r === 2)
    {
      html += "<td colspan='2' align='center' class='round' value=" + r + "><b>Round of 32 (Best of " + <?= $build_best_of['best_of_2'] ?> + ")</b></td>";
    }
    else if(r === 3)
    {
      html += "<td colspan='2' align='center' class='round' value=" + r + "><b>Round of 16 (Best of " + <?= $build_best_of['best_of_3'] ?> + ")</b></td>";
    }
    else if(r === 4)
    {
      html += "<td colspan='2' align='center' class='round' value=" + r + "><b>Round of 8 (Best of " + <?= $build_best_of['best_of_4'] ?> + ")</b></td>";
    }
    else if(r === 5)
    {
...
for (let r = 1; r <= rounds; r++) 
{
  if((tourn_size === 128) && (r <= 4))
  {
      html += "<th colspan='2'  style='text-align: center' class='column_" + (r+1) + "'><b>Round of 128 (Best of 5)</b></th>";
  }
  else if((tourn_size === 128) && (r > 4) && (r <= 6))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_" + (r+1) + "'><b>Round of 64 (Best of 5)</b></th>";
  }
  else if((tourn_size === 128) && (r > 4) && (r <= 6))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_6'><b>Round of 32 (Best of 5)</b></th>";
  }
  else if((tourn_size === 128) && (r === 7))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_7'><b>Round of 16 (Best of 5)</b></th>";
  }
  else if((tourn_size === 128) && (r === 8))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_8'><b>Round of 8 <b>(Best of 5)</b></th>";
  }
  else if((tourn_size === 128) && (r === 9))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_9'><b>Quarter Finals <b>(Best of 5)</b></th>";
  }
  else if(((tourn_size === 128) && r === 10))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_10'><b>Semi Finals (Best of 5)</b></th>";
  }
  else if((tourn_size === 128) && (r === 11))
  {
    html += "<th colspan='2'  style='text-align: center' class='column_11'><b>Finals (Best of 7)</b></th>";
  }
  else if((tourn_size === 128) && (r === 12))
  {
  ...
  if(tourn_size === 64)
  {
    if(r === 1)
    {
      html += "<th colspan='2'  style='text-align: center;' class='column_5' value=" + r + "><b>Round of 64 (Best of " + <?= $build_best_of['best_of_1'] ?> + ")</b></th>";
    }
    else if(r === 2)
    {
      html += "<th colspan='2'  style='text-align: center;' class='column_6' value=" + r + "><b>Round of 32 (Best of " + <?= $build_best_of['best_of_2'] ?> + ")</b></th>";
    }
    else if(r === 3)
    {
      html += "<th colspan='2'  style='text-align: center;' class='column_7' value=" + r + "><b>Round of 16 (Best of " + <?= $build_best_of['best_of_3'] ?> + ")</b></th>";
    }
    else if(r === 4)
    {
      html += "<th colspan='2'  style='text-align: center;' class='column_8' value=" + r + "><b>Round of 8 (Best of " + <?= $build_best_of['best_of_4'] ?> + ")</b></th>";
    }
    else if(r === 5)
    {
