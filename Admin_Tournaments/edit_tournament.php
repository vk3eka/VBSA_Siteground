...
$query_Cal_edit = "Select * FROM calendar Left Join tournaments ON calendar.tourn_id = tournaments.tourn_id WHERE calendar.tourn_id= '$tourn_id'";
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    ...
    <tr valign="baseline">
      ...
      <td><select name="tourn_year">
        ...
        //}
        ?>
        <option value="<?= $row_Cal_edit['tourn_year'] ?>" selected><?= $row_Cal_edit['tourn_year'] ?></option>
    ...
    <tr valign="baseline">
      ...
      <td><select name="non_dates">
        <option value="Y" <?php if (!(strcmp("Y", htmlentities($row_Cal_edit['special_dates'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Yes</option>
        <option value="N" <?php if (!(strcmp("N", htmlentities($row_Cal_edit['special_dates'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
      </select></td>
    </tr>
    <tr valign="baseline">
