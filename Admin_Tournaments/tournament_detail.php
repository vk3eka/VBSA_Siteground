...
{
  // Snooker Tournaments
  $query_players_confirmed = "Select ID, tournament_number AS TournID, MemberID, CONCAT(FirstName, ' ', LastName) AS FullName, Email, MobilePhone, Gender, amount_entry, dob_year, how_paid, entry_confirmed, HomeState, memb_by, seed, tourn_date_ent, entered_by, ranknum, wcard, Junior, rank_S_open_tourn.total_tourn_rp as rank_pts FROM tourn_entry, members  LEFT JOIN rank_S_open_tourn ON memb_id=MemberID WHERE tournament_number = '$tourn_id' AND MemberID=tourn_memb_id AND entry_confirmed=1 ORDER BY FirstName, Junior";
...
<table align="center" cellpadding="5" cellspacing="5">
  ...
  <?php do { 
    ...
    if(isset($row_players_confirmed['memb_by']))
    {
      $font_color = "";
    } 
    else
  ...
  ?>
  <tr class="page">
    <td align="center"><font <?= $font_color ?> ><?php echo $row_players_confirmed['TournID']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['MemberID']; ?></font></td>
    <td align="left"><font <?= $font_color ?>><?php echo $row_players_confirmed['FullName']; ?></font></td>
    ...
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['amount_entry']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['how_paid']; ?></font></td>
<?php
    $dob_year = $row_players_confirmed['dob_year'];
...
?>
    <td align="center"><font <?= $font_color ?>><?php echo $junior; ?></font></td>

    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['Gender']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['HomeState']; ?></font></td>
    <td align="center"><?php if(isset($row_players_confirmed['memb_by'])) echo "<font color=green>Yes</font>"; else echo "<font color=red>No</font>"; ?></td>

    <!--<td align="center"><?php echo $row_players_confirmed['memb']; ?></td>-->
    
    <td align="left"><font <?= $font_color ?>><?php $date = $row_players_confirmed['tourn_date_ent']; echo date("d M", strtotime($date)); ?></font></td>
    <td align="left"><font <?= $font_color ?>><?php echo $row_players_confirmed['entered_by']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['rank_pts']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_confirmed['ranknum']; ?></font></td>
...
<table align="center" cellpadding="5" cellspacing="5">
  ...
  <?php do { 
    if(isset($row_players_unconfirmed['memb_by']))
    {
      $font_color = "";
    } 
    else
  ...
  ?>
  <tr class="page">
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['TournID']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['MemberID']; ?></font></td>
    <td align="left"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['FullName']; ?></font></td>
    ...
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['amount_entry']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['how_paid']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['memb_id']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['seed']; ?></font></td>
    <td align="left"><font <?= $font_color ?>><?php $date = $row_players_unconfirmed['tourn_date_ent']; echo date("d M H:i", strtotime($date)); ?></font></td>
    <td align="left"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['entered_by']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['wcard']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['rank_pts']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['ranknum']; ?></font></td>
    <td align="center"><font <?= $font_color ?>><?php echo $row_players_unconfirmed['junior_cat']; ?></font></td>
