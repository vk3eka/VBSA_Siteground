...
r_" . $score_1[0] . "_to_breaks_1 = '" .  $score_1[17] . "',
r_" . $score_1[0] . "_to_breaks_2 = '" .  $score_1[18] . "',
r_" . $score_1[0] . "_to_breaks_3 = '" .  $score_1[19] . "',
r_" . $score_1[0] . "_to_breaks_4 = '" .  $score_1[20] . "',
r_" . $score_1[0] . "_to_breaks_5 = '" .  $score_1[21] . "',
r_" . $score_1[0] . "_to_breaks_6 = '" .  $score_1[22] . "',
r_" . $score_1[0] . "_to_breaks_7 = '" .  $score_1[23] . "',
...
r_" . $score_2[0] . "_to_breaks_1 = '" .  $score_2[17] . "',
r_" . $score_2[0] . "_to_breaks_2 = '" .  $score_2[18] . "',
r_" . $score_2[0] . "_to_breaks_3 = '" .  $score_2[19] . "',
r_" . $score_2[0] . "_to_breaks_4 = '" .  $score_2[20] . "',
r_" . $score_2[0] . "_to_breaks_5 = '" .  $score_2[21] . "',
r_" . $score_2[0] . "_to_breaks_6 = '" .  $score_2[22] . "',
r_" . $score_2[0] . "_to_breaks_7 = '" .  $score_2[23] . "',
