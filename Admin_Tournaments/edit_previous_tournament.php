...
$query_tourn1 = "Select calendar.*, tournaments.tourn_id as tournID, tournaments.tourn_year as tourn_year, tournaments.tourn_type as tournType FROM calendar left join tournaments On tournaments.tourn_id=calendar.tourn_id WHERE calendar.event_id = $event_id";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $updateTournSQL = sprintf("Update tournaments SET tourn_name=%s, tourn_year=%s, site_visible=%s, tourn_type=%s, ranking_type=%s, tourn_class=%s, how_seed=%s, status=%s WHERE tourn_id=%s",
                      GetSQLValueString($_POST['event'], "text"),
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    ...
    <tr valign="baseline">
      ...
      <td><select name="tourn_year">
        <option selected value="<?= $row_tourn1['tourn_year'] ?>"><?= $row_tourn1['tourn_year'] ?></option>
    ...
    <tr valign="baseline">
      ...
      <td><select name="non_dates">
        <option value="Y" <?php if (!(strcmp("Y", htmlentities($row_tourn1['special_dates'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Yes</option>
        <option value="N" <?php if (!(strcmp("N", htmlentities($row_tourn1['special_dates'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
      </select></td>
    </tr>
    <tr valign="baseline">
