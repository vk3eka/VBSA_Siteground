...
$colname_update = "-1";
if (isset($_GET['cont_edit'])) {
  $colname_update = $_GET['cont_edit'];
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("Update " . $affiliate . "_contact SET contact_name=%s, contact_phone=%s, contact_position=%s, contact_email=%s, contact_order=%s, contact_current=%s WHERE contact_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_update = sprintf("Select * FROM " . $affiliate . "_contact WHERE contact_id = %s", GetSQLValueString($colname_update, "int"));
...
<table width="800" align="center">
  <tr>
    <td><span class="red_bold">Update the selected contact on the <?= $affiliate ?> &quot;Contact Us&quot; page</span></td>
