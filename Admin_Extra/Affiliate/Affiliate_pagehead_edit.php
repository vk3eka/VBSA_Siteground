...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("Update " . $affiliate . " SET pagezone_header=%s WHERE " . $affiliate . "_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_pghead_edit = sprintf("Select " . $affiliate . "_id, pagezone_header_desc, pagezone_header FROM " . $affiliate . " WHERE " . $affiliate . "_id = %s", GetSQLValueString($colname_pghead_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  ...
  <input type="hidden" name="<?= $affiliate ?>_id" value="<?php echo $row_pghead_edit[$affiliate . '_id']; ?>" />
