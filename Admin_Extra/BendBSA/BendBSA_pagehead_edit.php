...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE BendBSA SET pagezone_header=%s WHERE BendBSA_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_pghead_edit = sprintf("SELECT BendBSA_id, pagezone_header_desc, pagezone_header FROM BendBSA WHERE BendBSA_id = %s", GetSQLValueString($colname_pghead_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  ...
  <input type="hidden" name="BendBSA_id" value="<?php echo $row_pghead_edit['BendBSA_id']; ?>" />
