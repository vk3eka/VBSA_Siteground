...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE BendBSA_contact SET contact_name=%s, contact_phone=%s, contact_phone2=%s, contact_fax=%s, contact_position=%s, contact_email=%s, contact_current=%s, contact_order=%s WHERE contact_id=%s",
