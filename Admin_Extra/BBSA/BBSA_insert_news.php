...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO BBSA (BBSA_id, BBSA_type, item_title, `current`, uploaded_on, news_content) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "BBSA_index_admin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr valign="baseline">
      <td colspan="3" align="left" nowrap="nowrap" class="red_bold">Insert an item into the  &quot;News&quot; column on the left side of the Ballarat BSA Page</td>
    </tr>
    <tr valign="baseline">
  ...
  <p>&nbsp;</p>
  <p>
    <input type="hidden" name="BBSA_id" value="" />
    <input type="hidden" name="BBSA_type" value="b_news" />
