...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO BBSA_contact (contact_name, contact_phone, contact_position, contact_email, contact_current) VALUES (%s, %s, %s, %s, %s)",
...
<table width="800" align="center">
  <tr>
    <td><span class="red_bold">Insert a new member into the BBSA &quot;Contact Us&quot; page on the VBSA website</span></td>
