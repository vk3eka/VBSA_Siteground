...
$query_contact = "SELECT * FROM BBSA_contact WHERE BBSA_contact.contact_current='No'";
...
<table width="1000" align="center">
  ...
  <?php do { ?>
    <tr>
      ...
      <td class="page"><a href="BBSA_contact_update.php?contactid=<?php echo $row_contact['contact_id']; ?>"><img src="../../Admin_Images/edit_butt.fw.png" width="25" /></a></td>
      <td class="page"><a href="BBSA_contact_delete.php?contactid=<?php echo $row_contact['contact_id']; ?>"><img src="../../Admin_Images/Trash.fw.png" width="25" /></a></td>
    </tr>
