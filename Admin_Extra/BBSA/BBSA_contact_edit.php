...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE BBSA_contact SET contact_name=%s, contact_phone=%s, contact_position=%s, contact_email=%s, contact_order=%s, contact_current=%s WHERE contact_id=%s",
...
$colname_update = "-1";
if (isset($_GET['BBSA'])) {
  $colname_update = $_GET['BBSA'];
}
mysql_select_db($database_connvbsa, $connvbsa);
$query_update = sprintf("SELECT * FROM BBSA_contact WHERE contact_id = %s", GetSQLValueString($colname_update, "int"));
...
<table width="800" align="center">
  <tr>
    <td><span class="red_bold">Update the selected contact on the BBSA &quot;Contact Us&quot; page</span></td>
