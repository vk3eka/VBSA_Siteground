...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE RSL_contact SET contact_name=%s, contact_phone=%s, contact_phone2=%s, contact_fax=%s, contact_position=%s, contact_email=%s, contact_current=%s, contact_order=%s WHERE contact_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_update = sprintf("SELECT * FROM RSL_contact WHERE contact_id = %s", GetSQLValueString($colname_update, "int"));
...
<table width="800" align="center">
  <tr>
    <td><span class="red_bold">Update the selected contact on the RSL &quot;Contact Us&quot; page</span></td>
