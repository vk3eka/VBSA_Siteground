...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE RSL SET pagezone_header=%s WHERE RSL_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_pghead_edit = sprintf("SELECT RSL_id, pagezone_header_desc, pagezone_header FROM RSL WHERE RSL_id = %s", GetSQLValueString($colname_pghead_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  ...
  <input type="hidden" name="RSL_id" value="<?php echo $row_pghead_edit['RSL_id']; ?>" />
