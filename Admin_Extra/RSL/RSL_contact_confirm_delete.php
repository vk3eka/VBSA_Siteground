...
$query_BoardMembers = sprintf("SELECT * FROM RSL_contact WHERE contact_id = %s", GetSQLValueString($colname_BoardMembers, "int"));
...
<form id="form1" name="form1" method="post" action="">
  <table width="982" align="center">
    ...
    <tr>
      ...
      <td width="69"><a href="RSL_contact_delete.php?contactid=<?php echo $row_BoardMembers['contact_id']; ?>"><img src="../../Admin_Images/Yes.jpg" /></a></td>
