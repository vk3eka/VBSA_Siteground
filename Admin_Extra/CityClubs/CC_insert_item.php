...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO CC (CC_id, CC_type, item_title, `current`, list_order, uploaded_on) VALUES (%s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_zone = "SELECT * FROM CC WHERE CC_type = '$item'";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <input type="hidden" name="CC_type" value="<?php echo $colname_zone = $_GET['item']; ?>" />
