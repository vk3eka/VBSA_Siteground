...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE CC_contact SET contact_name=%s, contact_phone=%s, contact_position=%s, contact_email=%s, contact_order=%s, contact_current=%s WHERE contact_id=%s",
