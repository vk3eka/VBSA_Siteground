...
$query_team_photo = sprintf("SELECT * FROM gallery_team_photos WHERE gallery_team_photos.id <>1 AND gallery_team_photos.year_photo=%s AND Current ='Yes' ORDER BY season, grade, 1or2 ASC", GetSQLValueString($colname_team_photo, "date"));
...
<table width="1000" align="center" cellpadding="5">
  <tr>
    <td width="887" align="left"><span class="red_bold">Team Photo Gallery for <?php echo $row_team_photo['year_photo']; ?></span></td>
...
<div id="gallery_content">
  ...
  <div class="about"><?php echo $row_team_photo['year_photo']; ?> &nbsp;&nbsp;&nbsp;Grade:<?php echo $row_team_photo['grade']; ?> &nbsp;&nbsp;&nbsp;Season:<?php echo $row_team_photo['season']; ?>&nbsp;&nbsp;&nbsp;<?php echo $row_team_photo['1or2']; ?>
  </div>
