...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE O55 SET item_title=%s, news_content=%s WHERE O55_id=%s",
...
;mysql_select_db($database_connvbsa, $connvbsa);
$query_O55edit = "SELECT O55_id,  item_title, news_content FROM O55 WHERE O55_id = 7";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr>
      ...
      <td><textarea name="news_content" cols="80" rows="6"><?php echo htmlentities($row_O55edit['news_content'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
    </tr>
    <tr>
