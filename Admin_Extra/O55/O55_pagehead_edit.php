...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE O55 SET pagezone_header=%s WHERE O55_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_pghead_edit = sprintf("SELECT O55_id, pagezone_header_desc, pagezone_header FROM O55 WHERE O55_id = %s", GetSQLValueString($colname_pghead_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  ...
  <input type="hidden" name="O55_id" value="<?php echo $row_pghead_edit['O55_id']; ?>" />
