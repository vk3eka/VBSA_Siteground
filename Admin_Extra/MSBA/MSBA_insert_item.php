...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO MSBA (MSBA_id, MSBA_type, item_title, `current`, list_order, uploaded_on) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "../MSBA/MSBA_index_admin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_zone = "SELECT * FROM MSBA WHERE MSBA_type = '$item'";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <input type="hidden" name="MSBA_type" value="<?php echo $colname_zone = $_GET['item']; ?>" />
