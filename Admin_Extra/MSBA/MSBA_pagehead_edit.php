...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE MSBA SET pagezone_header=%s WHERE MSBA_id=%s",
...
$query_pghead_edit = sprintf("SELECT MSBA_id, pagezone_header_desc, pagezone_header FROM MSBA WHERE MSBA_id = %s", GetSQLValueString($colname_pghead_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  ...
  <input type="hidden" name="MSBA_id" value="<?php echo $row_pghead_edit['MSBA_id']; ?>" />
