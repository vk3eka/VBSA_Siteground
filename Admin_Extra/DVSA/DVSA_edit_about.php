...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE DVSA SET item_title=%s, news_content=%s WHERE DVSA_id=%s",
...
;mysql_select_db($database_connvbsa, $connvbsa);
$query_DVSAedit = "SELECT DVSA_id,  item_title, news_content FROM DVSA WHERE DVSA_id = 7";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr>
      ...
      <td><textarea name="news_content" cols="80" rows="6"><?php echo htmlentities($row_DVSAedit['news_content'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
    </tr>
    <tr>
