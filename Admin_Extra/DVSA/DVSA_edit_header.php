...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE DVSA SET pagezone_header_desc=%s, pagezone_header=%s, item_title=%s, news_content=%s WHERE DVSA_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_DVSAedit = "SELECT DVSA_id,  item_title, news_content, pagezone_header_desc, pagezone_header FROM DVSA WHERE DVSA_id = 8";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr>
      ...
      <td><input type="text" name="item_title" value="<?php echo htmlentities($row_DVSAedit['item_title'], ENT_COMPAT, 'utf-8'); ?>" size="60" /></td>
    </tr>
    <tr>
      <td align="right">Subtitle (Large Page):</td>
      <td><input name="news_content" type="text" value="<?php echo htmlentities($row_DVSAedit['news_content'], ENT_COMPAT, 'utf-8'); ?>" size="80" /></td>
    </tr>
    <tr>
      <td align="right">Title (Small Page):</td>
      <td><input type="text" name="pagezone_header" value="<?php echo htmlentities($row_DVSAedit['pagezone_header'], ENT_COMPAT, 'utf-8'); ?>" size="60" /></td>
    </tr>
    <tr>
      <td align="right">Title Explanation (Small Page)</td>
      <td><input type="text" name="pagezone_header_desc" value="<?php echo htmlentities($row_DVSAedit['pagezone_header_desc'], ENT_COMPAT, 'utf-8'); ?>" size="60" /></td>
    </tr>
    <tr>
      <td align="right">Subtitle (Small Page):</td>
      <td><?php echo $row_DVSAedit['news_content']; ?> Same as Subtitle (Large Page)</td>
    </tr>
    <tr>
