...
$query_BoardMembers = sprintf("SELECT * FROM DVSA_contact WHERE contact_id = %s", GetSQLValueString($colname_BoardMembers, "int"));
...
<form id="form1" name="form1" method="post" action="">
  <table width="982" align="center">
    ...
    <tr>
      ...
      <td width="69"><a href="DVSA_contact_delete.php?contactid=<?php echo $row_BoardMembers['contact_id']; ?>"><img src="../../Admin_Images/Yes.jpg" /></a></td>
      <td width="61"><a href="DVSA_index_admin.php"><img src="../../Admin_Images/No.jpg" width="50" height="15" class="greenbg" /></a></td>
      <td width="663">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
