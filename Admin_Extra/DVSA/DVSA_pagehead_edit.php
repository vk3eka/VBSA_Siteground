...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE DVSA SET pagezone_header=%s WHERE DVSA_id=%s",
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_pghead_edit = sprintf("SELECT DVSA_id, pagezone_header_desc, pagezone_header FROM DVSA WHERE DVSA_id = %s", GetSQLValueString($colname_pghead_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  ...
  <input type="hidden" name="DVSA_id" value="<?php echo $row_pghead_edit['DVSA_id']; ?>" />
