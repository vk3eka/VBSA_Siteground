...
$query_qual_play = "SELECT scrsID, scrs.MemberID, FirstName, LastName, MobilePhone, Email, team_grade, team_id, game_type, count_played, captain_scrs, scr_season FROM scrs LEFT JOIN members ON members.MemberID = scrs.MemberID WHERE count_played>3 AND scr_season = '$season' AND current_year_scrs = YEAR(CURDATE( )) AND scrs.MemberID != 1 ORDER BY team_grade, team_id, FirstName";
