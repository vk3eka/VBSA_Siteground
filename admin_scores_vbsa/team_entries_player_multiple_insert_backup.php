...
mysql_select_db($database_connvbsa, $connvbsa);
$query_players = "SELECT scrsID, scrs.MemberID, team_grade, team_id, members.MemberID, members.FirstName, members.LastName, scrs.captain_scrs, Club, members.MobilePhone, members.Email FROM scrs, members WHERE scrs.team_id='$team_id' AND scrs.MemberID=members.MemberID";
...
<tr>
    ...
    <input type="hidden" name="scrsID_mihidden_<?php echo $RepeatSelectionCounter_1; ?>" id="scrsID_mihidden_<?php echo $RepeatSelectionCounter_1; ?>" value="1" />
      ...
      <input type="hidden" name="team_grade_<?php echo $RepeatSelectionCounter_1; ?>" value="<?php echo $team_grade; ?>" />
        ...
        <table align="left" cellpadding="3" cellspacing="3"><tr>
          ...
          <?php do { ?>
            <tr>
              ...
              <td nowrap="nowrap"><?php echo $row_players['FirstName']; ?> <?php echo $row_players['LastName']; ?> <?php if($row_players['captain_scrs']>0) echo " (Capt)"; else echo ""; ?></td>
              <td nowrap="nowrap" class="greenbg"><a href="user_files/scrs_player_capt_edit.php?scrsID=<?php echo $row_players['scrsID']; ?>&team_id=<?php echo $team_id ?>&season=<?php echo $season ?>&club_id=<?php echo $club_id; ?>" >Edit / Select Captain</a></td>
              </tr>
