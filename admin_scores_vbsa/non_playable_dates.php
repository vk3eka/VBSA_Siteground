...
if(isset($_POST['ButtonName']) && (($_POST['ButtonName']) == 'UpdateChanges'))
{
  ...
  for ($i = 0; $i < count($packeddata); $i++) 
  {
      ...
      $sql = "Update tbl_ics_dates Set donotuse = " . $dates[1] . " Where id = " . $dates[0];
      $update = mysql_query($sql, $connvbsa) or die(mysql_error());
  }
}
...
else
{
    ...
    echo("</tr>");
    echo("<tr>");
    echo("<td align=center><b><font color=red>Please note: any existing public holiday dates for " . $current_year . " will be deleted.</b></font></td>");
    echo("</tr>");
    echo("<tr>");
    echo("<td align=center>&nbsp;</td>");
    echo("</tr>");
...
$result_date = mysql_query($sql, $connvbsa) or die(mysql_error());
?>
<form name="ics_data" id="ics_data" method="post" action="non_playable_dates.php">
