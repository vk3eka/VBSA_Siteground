...
mysql_select_db($database_connvbsa, $connvbsa);
$query_Tot_Inc = "SELECT SUM(players*9*15) AS TotInc FROM Team_entries WHERE team_grade <> 'Bye' AND team_season='$season' AND team_cal_year = YEAR( CURDATE( ) )";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_Tot_Players = "SELECT SUM(players) AS TotPositions FROM Team_entries WHERE team_grade <> 'Bye' AND team_season='$season' AND team_cal_year = YEAR( CURDATE( ) )";
...
<table width="900" align="center" cellpadding="3" cellspacing="3" class="greenbg">
    ...
    <table width="1120" align="center">
      ...
      <tr>
        <td class="greenbg_menu"><a href="generate_fixtures.php?DayPlayed=Mon&season=<?php echo $season; ?>">Generate Fixtures for Next Season (Mon) </a></td>
        <td class="greenbg_menu">Generate Fixtures for all grades playing next season</td>
      </tr>
      <tr>
        <td class="greenbg_menu"><a href="generate_fixtures.php?DayPlayed=Wed&season=<?php echo $season; ?>">Generate Fixtures for Next Season (Wed) </a></td>
        <td class="greenbg_menu">Generate Fixtures for all grades playing next season</td>
      </tr>
      <tr>
        <td class="greenbg_menu"><a href="../admin_scores/team_entries.php?season=<?php echo $season; ?>">View all teams - <?php echo $season; ?> Season only</a></td>
      ...
      <tr>
        ...
        <td class="greenbg_menu">View and edit Team Grade structure for season <?php echo $season; ?>, upload fixtures</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
