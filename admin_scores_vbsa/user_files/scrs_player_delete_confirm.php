...
<form id="form1" name="form1" method="post" action="">
  <table align="center">
    ...
    <tr>
      <td align="left" class="red_bold">Delete a player from a team</td>
    ...
    <tr>
      <td align="right">Scores ID Number to be deleted:</td>
    ...
    <tr>
      ...
      <td class="greenbg"><a href="scrs_player_delete.php?grade=<?php echo $grade; ?>&team_id=<?php echo $team_id; ?>&season=<?php echo $season; ?>&comptype=<?php echo $comptype; ?>&scrsID=<?php echo $scrsID; ?>">Yes</a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
