...
// need to get correct season

mysql_select_db($database_connvbsa, $connvbsa);
$query_grades_S1 = "SELECT grade, grade_name FROM Team_grade WHERE `current`='Yes' AND season='S2' ORDER BY season, type, grade";
...
do {  
?>
        <option value="<?php echo $row_grades_S1['grade']?>"<?php if (!(strcmp($row_grades_S1['grade'], $row_breaks['grade']))) {echo "selected=\"selected\"";} ?>><?php echo $row_grades_S1['grade']?></option>
        <?php
