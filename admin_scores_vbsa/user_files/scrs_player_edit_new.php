...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) 
{
  ...
  /*
  if(($scrs_captain->num_rows > 0) && ($row_scrs_captain['captain_scrs'] == 1))
  {
    //echo("Captain exists in scrs<br>");
    //echo("Database Captain " . $row_scrs_captain['captain_scrs'] . "<br>");
  }
  else if(($scrs_captain->num_rows > 0) && ($row_scrs_captain['authoriser_scrs'] == 1))
  {
    //echo("Authoriser exists in scrs<br>");
    //echo("Database Authoriser " . $row_scrs_captain['authoriser_scrs'] . "<br>");
  }
  //echo("<br>");
  */
  ...
  //if((isset($_POST['captain_scrs'])) && ($row_scrs_authorise['Access'] == 'Team Captain'))
  {
    ...
    //echo("Update team name, access in tbl_authorise - " . $sql_insert_capt . "<br>"); 
  ...
  //if((isset($_POST['captain_scrs']) && (!isset($row_scrs_authorise['Access']))))
  {
    ...
    $sql_insert_capt = "Insert into tbl_authorise (Name, Password, Access, Team_1, PlayerNo, Email, Active) VALUES ('" . $_POST['fullname'] . "', '" . password_hash($password, PASSWORD_DEFAULT) . "', '" . $access . "', '" . $row_team_name['team_name'] . "', " . $_POST['MemberID'] . ", '" . $row_email['Email'] . "', 1)";  
    $update = mysql_query($sql_insert_capt, $connvbsa) or die(mysql_error());
  ...
  else if(($authoriser_scrs == 1) && (!isset($row_scrs_authorise['Access'])) && ($select_rows == 0)) // add if not an authosiser for any team
  {
    ...
    $password = generatePassword(10);
    // send email to new captain
    $sql_insert_auth = "Insert into tbl_authorise (Name, Password, Access, Team_1, PlayerNo, Email, Active) VALUES ('" . $_POST['fullname'] . "', '" . password_hash($password, PASSWORD_DEFAULT) . "', '" . $access . "', '" . $row_team_name['team_name'] . "', " . $_POST['MemberID'] . ", '" . $row_email['Email'] . "', 1)";  
