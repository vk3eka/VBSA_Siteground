...
<?php include '../admin_xx_includes/db_srch.php';?>
    ...
    <table align="center">
      ...
      <tr>
        <td class="red_bold">All Snooker players in the current year (players may appear multiple times if playing in more than one grade) </td>
