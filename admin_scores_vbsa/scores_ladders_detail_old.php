      ...
      <td><table border="1">
        ...
        <?php do { ?>
          <tr>
            ...
            <td align="left" nowrap="nowrap"><?php echo $row_ladd_det['FirstName']; ?> <?php echo $row_ladd_det['LastName']; ?> <?php if($row_ladd_det['captain_scrs']>0) echo " (Capt)"; else echo ""; ?></td>
