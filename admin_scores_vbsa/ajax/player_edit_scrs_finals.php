...
$editFormAction = "ajax/player_edit_scrs_finals.php";
if (isset($_SERVER['QUERY_STRING'])) {
  $editFormAction .= "?" . htmlentities($_SERVER['QUERY_STRING']);
}

if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE scrs SET SF1=%s, SF2=%s, GF=%s, SF1_pos=%s, SF2_pos=%s, GF_pos=%s WHERE scrsID=%s",
...
<body>
  ...
  <table width="800" border="0" align="center">
    <tr>
      <td align="center">Edit a player score details: Player ID - <?php echo $row_Scrs_Edit['MemberID']; ?></td>
    </tr>
    <tr>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="return doit()">
    <table width="240" border="1" align="center">
      ...
      <tr>
        ...
        <td width="40" align="center"><input type="text" name="SF2" value="<?php echo htmlentities($row_Scrs_Edit['SF2'], ENT_COMPAT, 'utf-8'); ?>" size="3" /></td>
        <td width="40" align="center"><input type="text" name="GF" value="<?php echo htmlentities($row_Scrs_Edit['GF'], ENT_COMPAT, 'utf-8'); ?>" size="3" /></td>
      </tr>
      <tr>
        <td align="right">        Position</td>
        <td width="40" align="center"><input type="text" name="SF1_pos" value="<?php echo htmlentities($row_Scrs_Edit['SF1_pos'], ENT_COMPAT, 'utf-8'); ?>" size="3" /></td>
        <td width="40" align="center"><input type="text" name="SF2_pos" value="<?php echo htmlentities($row_Scrs_Edit['SF2_pos'], ENT_COMPAT, 'utf-8'); ?>" size="3" /></td>
        <td width="40" align="center"><input type="text" name="GF_pos" value="<?php echo htmlentities($row_Scrs_Edit['GF_pos'], ENT_COMPAT, 'utf-8'); ?>" size="3" /></td>
      </tr>
    </table>
    <table align="center">
      <tr>
