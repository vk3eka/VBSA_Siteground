...
$editFormAction = "ajax/Ladders_team_score_edit.php";
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1"  onsubmit="return doit()">
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="Result_pos" value="<?php echo htmlentities($row_Team_scr_edit['Result_pos'], ENT_COMPAT, 'utf-8'); ?>" size="32" /> 
          Sets the position this team will display in the match repport</td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Round Score</td>
        <td><input type="text" name="Result_score" value="<?php echo htmlentities($row_Team_scr_edit['Result_score'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">High Break</td>
        <td><input type="text" name="HB" value="<?php echo htmlentities($row_Team_scr_edit['HB'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
...
<?php
mysql_free_result($Team_scr_edit);
?>
