...
$colname_brkdel = "-1";
if (isset($_GET['brkdel'])) {
  $colname_brkdel = $_GET['brkdel'];
}
...
<form id="form1" name="form1" method="post" action="">
  <table align="center">
    ...
    <tr>
      ...
      <td class="greenbg"><a href="ajax/break_delete.php?break=<?php echo $row_brkdel['Break_ID']; ?>">Yes</a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
