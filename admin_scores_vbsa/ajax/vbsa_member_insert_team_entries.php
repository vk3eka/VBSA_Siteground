...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "../team_entries_player_multiple_insert.php?season=".$season."&team_club=".$team_club."&team_id=".$team_id;
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <table align="center" width="1000">
      ...
      <tr valign="baseline">
        ...
        <td colspan="2"><select name="Club">
          ...
          <option value="CamberwellCue">Camberwell Cue Club</option>
          <option value="Cheltenham">Cheltenham</option>
          <option value="Cue8Bar">Cue 8 Bar</option>
          <option value="DandClub">Dand Club</option>
          <option value="DandRSL">Dand RSL</option>
          <option value="FastEddies">Fast Eddies</option>
          <option value="FrankstonRSL">Frankston RSL</option>
          <option value="Geelong">Geelong</option>
          <option value="HitBilliards">Hit Billiards</option>
          <option value="Kooyong">Kooyong</option>
          <option value="Kings">Kings</option>
          <option value="Legends">Legends</option>
          <option value="Maccabi">Maccabi</option>
          <option value="Masters">Masters</option>
          <option value="MulgraveCC">Mulgrave CC</option>
          <option value="NthBrighton">North Brighton</option>
          <option value="RACV">RACV</option>
          <option value="SOC">SOC</option>
          <option value="StarEnt">Star Ent</option>
