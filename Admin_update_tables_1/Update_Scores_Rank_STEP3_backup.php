...
<body>
  <table align="center">
    ...
    <tr>
      <td colspan="4" align="center">STEP 3 of the calculation process - please complete all steps nn</td>
    </tr>
    <tr>
...
if(isset($_POST["submit"]))
{
  ...
  echo "<font face='arial' size='3'>STEP 3 completed go to ".'<span class="greenbg"><a href="Update_Scores_Rank_STEP4.php">'. "STEP 4". '</a></spsn>';
  echo '<br/><br/>';
  echo '<br/>';
  echo "<font face='arial'>Updated Team Entries table - Calculated Finals scores";
  ...
  echo '<br/>'.'<br/>';
  echo "<font face='arial'>Update Members table - Set Matches played (Snooker & Billiards), Junior Age Group and Clear previous year financial members";
  ...
  for($i = $last_round_snooker_s1; $i < 18; $i++)
  {
    ...
    $count_text_3 = $count_text_3 . " COUNT(r" . $rnd_no . "s) + ";
  }
  ...
  echo("Season (1) " . $season_1 . "<br>");

  echo("Year (2) " . $year_2 . "<br>");
  echo("Season (2) " . $season_2 . "<br>");

  echo("Year (3) " . $year_3. "<br>");
  echo("Season (3) " . $season_3 . "<br>");
  */
  ...
  */
  /*
  $querytoexecute = "Update vbsa3364_vbsa2.members, (SELECT (SELECT " . $count_text_2 . ") AS Sprev, scrs.MemberID FROM scrs WHERE current_year_scrs = 2022 AND game_type='Snooker' AND scr_season = 'S2' GROUP BY scrs.MemberID) AS played SET members.totplayed_prev = played.Sprev WHERE members.MemberID = played.MemberID";
  ...
  if (isset($result)) echo "<br><br><font face='arial' color='green'> 1. Set totplayed_prev - Snooker matches played in current year in members table successfully</font>";

  $querytoexecute = "Update vbsa3364_vbsa2.members, (SELECT (SELECT " . $count_text_1 . ") AS Scurr, scrs.MemberID FROM scrs WHERE current_year_scrs = 2023 AND game_type='Snooker' AND scr_season = 'S1' GROUP BY scrs.MemberID) AS played SET members.totplayed_curr = played.Scurr WHERE members.MemberID = played.MemberID";
  */
  ...
  if (isset($result)) echo "<br><br><font face='arial' color='green'> 2. Set totplayed_curr - Snooker matches played in current year in members table successfully</font>";
  ...
  */
  ...
  /*
  $result=mysql_query($querytoexecute, $connvbsa) or die("<br><br><font face='arial' color='red'>2. Error - Not Set totplaybill_curr - Billiard matches in current year in members table</font>");

  if (isset($result)) echo "<br><br><font face='arial' color='green'>2. Set totplaybill_curr - Billiard matches played in current year in members table successfully</font>";
  */
