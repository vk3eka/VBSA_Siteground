...
// ************************
  ...
  // get old and new rankning totals, maybe need to do individual ranks........
  ...
  if($total_new != $total_previous)
  {
    ...
    */
    ...
    $sql_exist = "Select * From temp_weekly_snooker_ranking Order By memb_id";
  ...
  if($total_new != $total_previous)
  {
    ...
    */
    ...
    $sql_exist = "Select * From temp_open_snooker_ranking Order By memb_id";
    $result_exist = mysql_query($sql_exist, $connvbsa) or die(mysql_error());
    while($row_exist = mysql_fetch_assoc($result_exist))
    {
  ...
  */
    $sql_exist = "Select * From temp_womens_snooker_ranking Order By memb_id";
    $result_exist = mysql_query($sql_exist, $connvbsa) or die(mysql_error());
    while($row_exist = mysql_fetch_assoc($result_exist))
    {
  ...
  */
    $sql_exist = "Select * From temp_junior_snooker_ranking Order By memb_id";
    $result_exist = mysql_query($sql_exist, $connvbsa) or die(mysql_error());
    while($row_exist = mysql_fetch_assoc($result_exist))
    {
  ...
  */
    $sql_exist = "Select * From temp_open_billiards_ranking Order By memb_id";
    $result_exist = mysql_query($sql_exist, $connvbsa) or die(mysql_error());
    while($row_exist = mysql_fetch_assoc($result_exist))
    {
  ...
  */
    $sql_exist = "Select * From temp_womens_billiards_ranking Order By memb_id";
    $result_exist = mysql_query($sql_exist, $connvbsa) or die(mysql_error());
    while($row_exist = mysql_fetch_assoc($result_exist))
    {
  ...
  */
    $sql_exist = "Select * From temp_junior_billiards_ranking Order By memb_id";
    $result_exist = mysql_query($sql_exist, $connvbsa) or die(mysql_error());
    while($row_exist = mysql_fetch_assoc($result_exist))
    {
