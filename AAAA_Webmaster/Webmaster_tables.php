...
<table width="600" align="center">
  <tr>
    <td align="center" class="red_bold">List of Database tables</td>
  </tr>
  <tr>
    ...
    <div class="DB_tables">
    <p>Complete list of tables in the database</p>
<?php require_once('../Connections/connvbsa.php'); ?>
<?php
mysql_select_db($database_connvbsa, $connvbsa) or die(mysql_error("no connection"));
