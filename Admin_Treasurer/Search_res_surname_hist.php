...
$page = "http://www.vbsa.org.au/Admin_Treasurer/Search_res_surname_hist.php?searchthis=$searchthis"  ;
$_SESSION['page'] = $page;
...
$query_memb = "SELECT MemberID, LastName, FirstName, HomePhone, WorkPhone, MobilePhone, Email, ReceiveEmail, Club, LastUpdated, UpdateBy, entered_on, memb_by FROM members WHERE LastName LIKE CONCAT('$searchthis','%') ORDER BY LastName ASC";
//$query_memb = "SELECT MemberID, LastName, FirstName, MobilePhone, members.Email, Club, LifeMember, paid_memb FROM members WHERE LastName LIKE '$searchthis%' ORDER BY LastName";
...
<center>
  <table width="1000" border="0" align="center">
    ...
    <tr>
      <td align="center" class="red_bold">You searched Surname  for:  <?php echo $searchthis ?></td>
