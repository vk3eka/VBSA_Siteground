...
$query_RPALL = "SELECT ranknum, memb_id, FirstName, LastName, total_weekly_rp, date_format(last_update,'%D %b %Y') AS last_update FROM rank_B_open_weekly LEFT JOIN members ON MemberID = memb_id  WHERE memb_id = '$rank'";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_RP_by_year = "SELECT scr_curr_S1, scr_curr_S2, scr_1yr_S1, scr_1yr_S2, scr_2yr_S1, scr_2yr_S2, weekly_total FROM rank_a_billiards_master WHERE memb_id='$rank'";
