...
<?php include '../admin_xx_includes/db_srch.php';?>
    ...
    <table align="center" cellpadding="5" cellspacing="5">
      ...
      <tr>
        <td colspan="7" class="page">This information appears on<a href="http://www.vbsa.org.au/Rankings/rankings_index.php" target="_blank"> this page</a> please check after update or insert</td>
      ...
      <tr>
        ...
        <td><a href="rank_exp_update.php?comp_type=<?php echo $row_exp_rank['rank_exp_type']; ?>"><img src="../Admin_Images/edit_butt.fw.png" width="25" height="25" title="Upload a new pdf" /></a></td>
