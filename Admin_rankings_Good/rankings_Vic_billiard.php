...
$query_RPall = "SELECT ranknum, previous_rank, memb_id, FirstName, LastName, Email, MobilePhone, total_rp, date_format(last_update,'%D %b %Y') AS last_update FROM rank_Billiards LEFT JOIN members ON MemberID = memb_id ORDER BY total_rp DESC";
...
<table align="center" cellpadding="5" cellspacing="5">
  <tr>
    ...
    <td align="center">Previously ranked</td>
  ...
  <tr>
    ...
    <td align="center"><?php echo $row_RPall['previous_rank']; ?></td>
    <td align="center"><?php echo $row_RPall['total_rp']; ?></td>
    <!--<td align="center" class="page"><a href="rankings_Vic_billiards_detail.php?rank=<?php echo $row_RPall['memb_id']; ?>">How awarded</a></td>-->
    </tr>
