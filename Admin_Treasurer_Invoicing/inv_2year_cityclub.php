...
$page = "inv_cityclubs_2year.php?inv_type=$inv_type";
$_SESSION['page'] = $page;

$inv_page = "../inv_cityclubs_2year.php?inv_type=$inv_type";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_create_inv = "SELECT ClubNumber, ClubTitle, MAX(inv_date) AS lastinv  FROM clubs  LEFT JOIN inv_to ON inv_to.club_id  = club_id WHERE CityClubTeam=1 GROUP BY ClubNumber ORDER BY ClubTitle";
...
<table align="center">
  ...
  <tr>
    <td colspan="4" align="center"><span class="red_bold">All <?php echo date("Y")?> or <?php echo date("Y")-1 ?> City Club Invoices - Important: To complete any updated or inserted invoices you MUST recalculate</span></td>
  </tr>
  <tr>
    <td colspan="4" align="center" class="red_bold">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="4" align="center" valign="middle" class="red_text">List contains all Invoices made out in the last 2 years to a Club that has &quot;City Clubs&quot; checked in the Club Directory. </td>
  </tr>
  <tr>
...
<table align="center">
  ...
  <tr>
    <td align="center">List contains all City Clubs  - Total Clubs : <?php echo $totalRows_create_inv ?></td>
  </tr>
  <tr>
