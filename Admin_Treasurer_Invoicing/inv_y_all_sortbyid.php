...
$page = "inv_y_all_sortbytitle.php";
$_SESSION['page'] = $page;

$inv_page = "../inv_y_all_sortbytitle.php";
...
$query_all_invoices = "SELECT inv_id, club_id, inv_busname, inv_to, inv_email, inv_phone, inv_date, inv_paid_amount, inv_total_all, inv_status, inv_bad_debt, inv_type FROM inv_to ORDER BY inv_id DESC";
...
<table align="center">
  ...
  <tr>
    <td align="center" class="red_text">All Invoices since the inception of database invoicing. Sorted by Invoice ID (Newest first)</td>
  </tr>
  <tr>
