...
$page = "inv_x_bad_debt.php";
$_SESSION['page'] = $page;

$inv_page = "../inv_x_bad_debt.php";
...
$query_all_invoices = "SELECT inv_id, club_id,  inv_busname, inv_to, inv_email, inv_phone, inv_date, inv_paid_amount, inv_total_all,  inv_status, inv_bad_debt, inv_type FROM inv_to  LEFT JOIN clubs ON club_id=ClubNumber WHERE inv_status='Bad Debt' ORDER BY inv_busname";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_all = "SELECT SUM(inv_total_all) AS allinv FROM inv_to WHERE inv_status='Bad Debt'";
...
<table align="center">
  ...
  <tr>
    <td align="center" class="red_text"><span class="red_bold">Invoices that have been set as Bad Debt- Important: To complete any updated or inserted invoices you MUST recalculate</span></td>
  </tr>
  <tr>
...
<table align="center" cellpadding="3" cellspacing="3">
  <tr>
    <td class="red_text">There are no Bad Debt invoices</td>
  </tr>
</table>
<?php } else { ?>
