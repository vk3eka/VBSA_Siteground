...
$page = "inv_y_all_prev_year.php";
$_SESSION['page'] = $page;

$inv_page = "../inv_y_all_prev_year.php";
...
$query_all_invoices = "SELECT inv_id, club_id, inv_busname, inv_to, inv_email, inv_phone, inv_date, inv_paid_amount, inv_total_all, inv_status, inv_bad_debt, inv_type FROM inv_to WHERE YEAR(inv_date) = YEAR( CURDATE( ))-1 ORDER BY inv_busname";
...
<table align="center">
  ...
  <tr>
    <td align="center" class="red_text">All Invoices for <?php echo date("Y")-1 ?></td>
  </tr>
  <tr>
