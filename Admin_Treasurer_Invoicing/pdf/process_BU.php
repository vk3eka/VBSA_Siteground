...
mysql_select_db($database_connvbsa, $connvbsa) or die("Error ".mysql_error());
...
$row_invtot = mysql_fetch_assoc($invtot) or die("Error 1".mysql_error());
...
/**/	$instruction="Payment Details- By Cheque or Money order, please make payable to VBSA. Post to: VBSA Treasurer, George Hoy, 31 Speakmen St, Kensington, 3031. To pay moneys directly to the VBSA by bank transfer - Our Account is with the ANZ bank - our BSB number is 013236 - Our Account Number is 297730994 Account Name VBSA When you transfer money to our account we need to know who has sent it and what it is for so please email treasurer@vbsa.org.au with the details of the transfer.";
...
<table style='font-size:10px;width:850px;margin-left:10px;cellspacing=5px;'>
			<tr>
				<th style='width:350px;text-align:left'>Item description</th>
...
$html .="<div style='border:1px solid #dadada; height:20px; width:850px;margin-top:20px;font-size:12px;'>
