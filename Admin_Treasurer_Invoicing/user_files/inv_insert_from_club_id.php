...
mysql_select_db($database_connvbsa, $connvbsa);
$query_create_inv = "SELECT ClubNumber, ClubTitle, FirstName, LastName, Email, MobilePhone, inv_type FROM clubs  LEFT JOIN clubs_contact ON clubs_contact.club_id=ClubNumber AND cont_type='Invoice to'  LEFT JOIN members ON cont_memb_id=MemberID  LEFT JOIN inv_to ON inv_to.club_id=clubs_contact.club_id WHERE clubs.ClubNumber='$club_id'";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  <table width="900" align="center" cellpadding="5" cellspacing="5">
    <tr>
      <td><span class="red_bold">You are about to create an invoice to the following:</span></td>
      <td align="right"><input type="button" value="Return to previous page" onclick="history.go(-1)"/></td>
    </tr>
    <tr>
      <td colspan="2" align="left"><?php echo $_SESSION['inv_page']; ?></td>
    </tr>
    <tr>
