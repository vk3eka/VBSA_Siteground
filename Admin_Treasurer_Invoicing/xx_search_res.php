...
if (isset($_GET['INVsearch'])) {
  $INVsearch = $_GET['INVsearch'];
}

$page = "../xx_search_res.php?INVsearch=$INVsearch"  ;
$_SESSION['page'] = $page;
...
$colname_all_invoices = "-1";
if (isset($_GET['INVsearch'])) {
  $colname_all_invoices = $_GET['INVsearch'];
}
mysql_select_db($database_connvbsa, $connvbsa);
$query_all_invoices = sprintf("SELECT * FROM inv_to WHERE inv_busname LIKE %s ORDER BY inv_to.inv_id DESC", GetSQLValueString($colname_all_invoices . "%", "text"));
...
$queryString_all_invoices = "";
if (!empty($_SERVER['QUERY_STRING'])) {
  $params = explode("&", $_SERVER['QUERY_STRING']);
  $newParams = array();
  foreach ($params as $param) {
    if (stristr($param, "pageNum_all_invoices") == false && 
        stristr($param, "totalRows_all_invoices") == false) {
      array_push($newParams, $param);
    }
  }
  if (count($newParams) != 0) {
    $queryString_all_invoices = "&" . htmlentities(implode("&", $newParams));
  }
}
$queryString_all_invoices = sprintf("&totalRows_all_invoices=%d%s", $totalRows_all_invoices, $queryString_all_invoices);
?>
...
<table border="1" align="center" cellpadding="5" cellspacing="5">
  <tr>
    ...
    <td>
    	<form id="form2" name="form2" method="get" action="xx_search_res.php">
...
<table align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td colspan="2" align="center" class="red_bold">All Customer invoices that match , Search results for &quot;<?php echo $colname_all_invoices; ?>&quot;</td>
  </tr>
  <tr>
    <td align="right" class="red_bold">important: To complete any updated or inserted invoices you MUST recalculate</td>
    <td align="left" class="greenbg"><a href="../Admin_update_tables/UpdateInvoiceTables.php">Recalculate the Invoice tables</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center" valign="middle"><strong>Invoice Status:</strong> &nbsp;<img src="../Admin_Images/tick.JPG" height="20" />&nbsp;= Fully paid, &nbsp;&nbsp;<img src="../Admin_Images/cross.JPG" height="18" /> = unpaid or part paid,&nbsp;&nbsp; <img src="../Admin_Images/unsent.JPG" height="20"/>&nbsp;= unsent, &nbsp;&nbsp;<img src="../Admin_Images/bad_debt.JPG" width="20" /> = bad debt</td>
  </tr>
  <tr>
    <td align="right" class="red_bold">&nbsp;</td>
    <td align="left" class="greenbg">&nbsp;</td>
...
<table border="1" align="center">
  <tr>
    ...
    <td align="center" nowrap="nowrap">Invoice Type</td>
  ...
  <tr>
    ...
    <td align="center"><?php 
	  ...
	  echo $newDate;
	   ?></td>
    <td align="center"><a href="user_files/inv_edit.php?inv_id=<?php echo $row_all_invoices['inv_id']; ?>"><img src="../Admin_Images/edit_butt.fw.png" alt="1" height="20" title="Edit Address or insert paid amount" /></a></td>
    <td><a href="user_files/inv_print_detail.php?inv_id=<?php echo $row_all_invoices['inv_id']; ?>"><img src="../Admin_Images/detail.fw.png" alt="" width="20" height="20" title="View invoice" /></a></td>
    <td>
    ...
    <td><a href="user_files/inv_delete_confirm.php?inv_id=<?php echo $row_all_invoices['inv_id']; ?>"><img src="../Admin_Images/Trash.fw.png" height="22" alt="trash" /></a></td>
  </tr>
