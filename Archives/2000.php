...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Archives for 2000</div>
  </div>  	
  ...
  <div class="table-responsive center-block" style="max-width:700px; font-style:italic"> <!-- class table-responsive -->
    <table class="table" style=" text-align:left">
        ...
        <tr>
            ...
            <td>A Premier</td>
            <td>Yarraville</td>
            <td><em>Brunswick</em> Blue</td>
      </tr>
            <tr>
            <td>B Premier</td>
            <td>Brunswick</td>
            <td>Yarraville Blue</td>
      </tr>
            <tr>
            <td>C Premier</td>
            <td>Yarraville Red</td>
            <td><em>Brunswick</em> Red</td>
      </tr>
            <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
