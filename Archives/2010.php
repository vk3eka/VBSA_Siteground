...
<div id="Wrapper"><!-- Wrapper contains content to a max width of 1200px--> 
  ...
  <div class="Page_heading_container">
 		<div class="page_title">Archives for 2010</div>
  </div>  	
  ...
  <div class="table-responsive center-block" style="max-width:700px; font-style:italic"> <!-- class table-responsive -->
    <table class="table" style=" text-align:left">
        ...
        <tr>
          <td align="center"><a href="arch_reports_pdf/2010 Pennant Finals Results.pdf" target="_blank">Final Results</a></td>
          <td colspan="2" align="center"><a href="arch_reports_pdf/2010PennantRes18.pdf" target="_blank">Final Ladders &amp; Ind. Results</a></td>
        </tr>
        <tr>
            <th>Grade</th>
            <th>Winners</th>
...
<div class="table-responsive center-block" style="max-width:700px; font-style:italic"> <!-- class table-responsive -->
    <table class="table" style=" text-align:left">
        ...
        <tr>
          ...
          <td colspan="2" align="center"><a href="arch_reports_pdf/2010 B&amp;W Finals.pdf">Final Ladders &amp; Ind. Results</a><a href="2009/09 B&amp;W res.pdf" target="_blank"></a></td>
        </tr>
        <tr>
            <th>Grade</th>
            <th>Winners</th>
  ...
  <div class="table-responsive center-block" style="max-width:700px; font-style:italic"> <!-- class table-responsive -->
    <table class="table" style=" text-align:left">
      ...
      <tr>
        ...
        <td>Dave Disley Snr</td>
        <td>Peter Bruenjes</td>
      </tr>
      <tr>
