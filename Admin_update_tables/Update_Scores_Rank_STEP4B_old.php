...
{
  echo "<font face='arial'>STEP 4B completed go to ".'<span class="greenbg"><a href="Update_Scores_Rank_STEP4C.php">'. "STEP 4C". '</a></span>';
  echo '<br/><br/>';
...
{
  echo '<center/>';
  echo "<form id='form1' name='form1' method='post' action='../Admin_update_tables/Update_Scores_Rank_STEP4B.php?submit=1'>";
