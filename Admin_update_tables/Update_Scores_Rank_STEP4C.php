...
if(isset($_POST["submit"]))
{
  ...
  echo "<font face='arial'>STEP 4C completed go to ".'<span class="greenbg"><a href="Update_Scores_Rank_STEP7.php?season=' . $season . '">STEP 7</a></span>';
...
echo "<form id='form1' name='form1' method='post' action='../Admin_update_tables/Update_Scores_Rank_STEP4C.php?submit=1&season=" . $season . "'>";
