...
echo "<font face='arial' size='3'>STEP 2 completed go to ".'<span class="greenbg"><a href="Update_Scores_Rank_STEP3.php?season=' . $season . '">STEP 3</a></spsn>';
echo '<br/><br/>';
...
echo "<form id='form1' name='form1' method='post' action='../Admin_update_tables/Update_Scores_Rank_STEP2.php?submit=1&season=" . $season . "'>";
