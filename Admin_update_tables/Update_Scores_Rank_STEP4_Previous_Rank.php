...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( ))-2 and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Vic Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
SET T1.tourn_2 = T2.RP_Yr2";
/*
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( ))-1 and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Vic Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
SET T1.tourn_1 = T2.RP_Yr1";
/*
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( )) and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Vic Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
SET T1.tourn_curr = T2.RPCurr";
/*
...
echo '<br/>'.'<br/>';
echo "<font face='arial'>Open snooker weekly rankings, Open snooker tournament rankings, Womens snooker, junior snooker and Billiards Open, Womens and Juniors tables and copy data from Master tables";

//START empty ranking tables then insert updated data from master tables
//FOR open snooker weekly rankings, open snooker tournament rankings, womens snooker, junior snooker and Billiards open, womens and junior.
...
echo("<br>Open Total Previous " . $total_previous . "<br>");
...
echo("<br>Open Total New " . $total_new . "<br>");
...
//{
  ...
  if (isset($result)) echo "<br><font face='arial' color='green'> 3. Truncated rank_Billiards table - Billiards Rankings successfully</font>";
...
$row_total = mysql_fetch_assoc($result);
$total_previous  = $row_total['previous_total_rp'];
echo("<br>Womens Total Previous " . $total_previous . "<br>");
...
$total_new  = $row_total['grand_total'];
echo("<br>Womens Total New " . $total_new . "<br>");
...
//{
  ...
  $result = mysql_query($querytoexecute, $connvbsa) or die("<br><br><font face='arial' color='red'>8. Error - rank_B_womens table - Billiard Rankings data not inserted</font>");

  if (isset($result)) echo "<br><br><font face='arial' color='green'> 8. Data inserted to rank_B_womens table - Billiard Rankings successfully</font>";
...
$row_total = mysql_fetch_assoc($result);
$total_previous  = $row_total['previous_total_rp'];
echo("<br>Junior Total Previous " . $total_previous . "<br>");
...
echo("<br>Juniors Total New " . $row_total_junior['grand_total'] . "<br>"); // not working......................
...
//{
  ...
  $result = mysql_query($querytoexecute, $connvbsa) or die("<br><br><font face='arial' color='red'>3. Error - rank_B_junior table - Billiards Rankings not truncated</font>");

  if (isset($result)) echo "<br><font face='arial' color='green'> 3. Truncated rank_B_junior table - Billiards Rankings successfully</font>";
  ...
  CURRENT_TIMESTAMP
  FROM rank_a_billiards_master
  LEFT JOIN members T1 ON T1.MemberID = rank_a_billiards_master.memb_id where (Junior = 'U15' OR Junior = 'U17' OR Junior = 'U18') and Gender != 'Female'
  GROUP BY rank_a_billiards_master.memb_id
  ORDER BY total_rp DESC";
  //echo("Junior Billiards " . $querytoexecute . "<br>");
  $result = mysql_query($querytoexecute, $connvbsa) or die("<br><br><font face='arial' color='red'>8. Error - rank_B_junior table - Billiard Rankings data not inserted</font>");

  if (isset($result)) echo "<br><br><font face='arial' color='green'> 8. Data inserted to rank_B_junior table - Billiard Rankings successfully</font><br>";
...
// *****************************************
// Add Womens and Juniors Snooker Rank Table
// *****************************************
...
$result=mysql_query($querytoexecute, $connvbsa) or die("<br><br><font face='arial' color='red'>4. Error - rank_S_womens table -  Womens Snooker Rankings
 not truncated</font>");
...
// ***********************************************
// Add Womens and Juniors Billiards Ranking Points
// ***********************************************
echo '<br/>'.'<br/>';
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( )) and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Womens Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( ))-1 and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Womens Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( ))-2 and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Womens Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( )) and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Junior Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( ))-1 and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Junior Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
...
FROM tourn_entry 
LEFT JOIN tournaments ON tournaments.tourn_id = tourn_entry.tournament_number
WHERE entry_cal_year=YEAR(CURDATE( ))-2 and tournaments.tourn_type = 'Billiards' and tournaments.ranking_type = 'Junior Rank' 
GROUP BY tourn_memb_id 
) T2 ON T1.memb_id= T2.tourn_memb_id
...
if (isset($result)) echo "<br><br><font face='arial' color='green'>3. Year 2 tournament junior ranking points updated successfully</font>";
  ...
  echo '<br/>'.'<br/>';
  echo "<font face='arial'>End of Junior Billiard Rankings";


// *********************************************
// Add Womens and Juniors Snooker Ranking Points
// *********************************************
echo '<br/>'.'<br/>';
...
if (isset($result)) echo "<br><br><font face='arial' color='green'>3. Year 2 tournament junior ranking points updated successfully</font>";
  ...
  echo '<br/>'.'<br/>';
  echo "<font face='arial'>End of Junior Snooker Rankings";


// ********************************
// Add Billiards points for/against
// ********************************
echo '<br/>'.'<br/>';
...
//if($max_round_history <= $last_round)
