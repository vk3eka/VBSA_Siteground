...
echo '<font face="arial" size="3">STEP 4 completed go to <span class="greenbg"><a href="Update_Scores_Rank_STEP4B.php?season=' . $season . '">STEP 4B</a></span>';
echo '<br/><br/>';
...
brks_2+brks_1+brks_curr_S1+tourn_2+tourn_1+tourn_curr
";
...
// may need to differentiate between billiards grades if more than one grade.
...
echo "<form id='form1' name='form1' method='post' action='../Admin_update_tables/Update_Scores_Rank_STEP4.php?submit=1&season=" . $season . "'>";
