...
echo "<font face='arial' size='3'>Test calculations completed ".'<span class="greenbg"><a href="Update_Scores_Rank_STEP4C.php?season=' . $season . '">STEP 4C</a></spsn>';
echo '<br/><br/>';
...
else
{
  ...
  echo "<form id='form1' name='form1' method='post' action='../Admin_update_tables/Update_Scores_Rank_STEP4A.php?submit=1&season=" . $season . "'>";
