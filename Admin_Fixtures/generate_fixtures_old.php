...
while($build_data_grades = $result_grades->fetch_assoc())
{
 ...
 ?>
    ...
    */
    ...
    echo("</tr>");
    echo("<tr>");
    echo("<td align='center' colspan='2' class='greenbg' style='height: 20px'><a href='create_pdf_content.php?Year=" . $year . "&Season=" . $season . "&Team_Grade=" . $team_grade . "&DayPlayed=" . $dayplayed . "&CompType=" . $comptype . "';>Generate Fixtures PDF for " . $team_grade . "</a></td>");
