...
{
    alert("here");
    //alert(document.getElementById("round" + r + "_date").value);
}
...
if($_POST['Select'] == 'true')
{
    ...
    if($num_rows > 0)
    {
        ...
        for($r = 0; $r < ($no_of_rounds); $r++)
        {
            ...
            echo("<td colspan=2 class='text-left'><input type='text' id='round" . $r . "_date'  value='" . $fixture_date . "' style='width:100px' onchange='DateChange(" . $r . ")'></td></tr>");
