...
$query_RP_weekly = "SELECT ranknum, memb_id, FirstName, LastName, total_weekly_rp, date_format(last_update,'%D %b %Y') AS last_update FROM rank_B_open_weekly LEFT JOIN members ON MemberID = memb_id WHERE total_weekly_rp>0 ORDER BY ranknum";
...
<table align="center">
  ...
  <tr>
    <td align="left" class="red_bold">
      Rankings for Pennant, Willis &amp; State Grade Billiards      </td>
    ...
    <table align="center" cellpadding="3" cellspacing="3">
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="center" class="page"><a href="rankings_billiards_weekly_detail.php?rank=<?php echo $row_RP_weekly['memb_id']; ?>">how awarded</a></td>
      </tr>
