...
<table width="746" align="center">
  ...
  <tr>
    <td align="center" ><span class="red_bold"><?php echo date("Y"); ?> Victorian Tournament Snooker (Open) Rankings</span> Last updated: <?php echo $row_RPall['last_update']; ?></td>
  ...
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr>
      ...
      <td align="center" class="page"><a href="rankings_vic_snooker_detail.php?rank=<?php echo $row_RPall['memb_id']; ?>&cohort=all">How awarded</a></td>
    </tr>
