...
$query_RPall = "Select 
        ...
        rank_a_billiards_master.memb_id, FirstName, LastName, junior, Female, last_update  
        FROM rank_a_billiards_master 
        LEFT JOIN members ON rank_a_billiards_master.memb_id = MemberID
        where Female = 1 ORDER BY total_rp DESC";
...
<table width="746" align="center">
  ...
  <tr>
    <td align="center" ><span class="red_bold"><?php echo date("Y"); ?> Victorian Tournament Billiards (Womens) Rankings</span> Last updated: <?php echo $row_RPall['last_update']; ?></td>
...
<table align="center" cellpadding="5" cellspacing="5">
  ...
  <tr>
    ...
    <td align="center" class="page"><a href="rankings_vic_billiards_detail.php?rank=<?php echo $row_RPall['memb_id']; ?>&cohort=woman">How awarded</a></td>
    </tr>
  <?php 
$i++;
