...
<table width="1000" align="center" class="greenbg_menu">
  ...
  <tr>
    <td width="300" align="left"><a href="team_assessment.php">Pennant Snooker Team & Player Assessment</a></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td width="300" align="left"><a href="rank_exp_update.php?comp_type=Snooker">Upload/Modify Snooker Rankings Explained</a></td>
    <td>&nbsp;</td>
    <td>Upload/Modify Snooker Rankings Explained</td>
  </tr>
</table>
<table width="1000" border="0" align="center" cellpadding="8" cellspacing="0">
  <tr>
...
<table width="1000" align="center" class="greenbg_menu">
  ...
  <tr>
    <td width="300" align="left"><a href="rank_exp_update.php?comp_type=Billiards">Upload/Modify Billiards Rankings Explained</a></td>
    <td>&nbsp;</td>
    <td>Upload/Modify Billiards Rankings Explained</td>
  </tr>
</table>
<!-- Added by Alec Spyrou 3/12/24 -->
<table width="1000" border="0" align="center" cellpadding="8" cellspacing="0">
  <tr>
    <td class="red_bold">Update Victorian Rankings</td>
  </tr>
</table>
<table width="1000" align="center" class="greenbg_menu">
  <tr>
    <td width="300" align="left"><a href="../Admin_update_tables/Update_Scores_Rank.php"><?php echo date("Y"); ?> Update Victorian Rankings</a></td>
      <td width="10">&nbsp;</td>
      <td width="690">Update all Victorian rankings.</td>
    </tr>
</table>
<!-- End of addition  by Alec Spyrou 3/12/24 -->

<!-- Added 20/04/2025 -->
<!--<table width="1000" border="0" align="center" cellpadding="8" cellspacing="0">
  <tr>
    <td class="red_bold">Temporary Update Previous Rankings</td>
  </tr>
</table>
<table width="1000" align="center" class="greenbg_menu">
  <tr>
    <td width="300" align="left"><a href="../Admin_update_tables/Update_Scores_Rank_STEP7.php"><?php echo date("Y"); ?> Update Previous Rankings</a></td>
    <td width="10">&nbsp;</td>
    <td width="690">Update all Previous rankings.</td>
  </tr>
  <tr>
    <td width="300" align="left"><a href="../PreviousRank/rankings_index.php" target='_blank'><?php echo date("Y"); ?> View Previous Rankings</a></td>
    <td width="10">&nbsp;</td>
    <td width="690">View Previous rankings.</td>
  </tr>
</table>-->
<!-- End of addition -->
