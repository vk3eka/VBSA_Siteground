...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" class="greenbg">
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td>Day 1&nbsp;<input type='text' name="matches_day_1" size='2' value="">&nbsp;Day 2&nbsp;<input type='text' name="matches_day_2" size='2' value="">&nbsp;Day 3&nbsp;<input type='text' name="matches_day_3" size='2' value="">&nbsp;Day 4&nbsp;<input type='text' name="matches_day_4" size='2' value=""></td>
    </tr>
    <tr valign="baseline">
