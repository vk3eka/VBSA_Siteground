...
$tourn_page = "http://vbsa.org.au/Admin_Tournaments/aa_tourn_index.php";
//$tourn_page = "http://vbsa.cpc-world.com/Admin_Tournaments/aa_tourn_index.php";
//$tourn_page = "http://172.16.10.32/VBSA_Siteground/Admin_Tournaments/aa_tourn_index.php";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_tourn1 = "SELECT *, tournaments.tourn_class as tourn_class, tournaments.tourn_type as comp_type FROM tournaments Left Join calendar on tournaments.tourn_id = calendar.tourn_id WHERE tourn_year = YEAR(CURDATE()) AND tournaments.tourn_type='Snooker' AND status='Open' ORDER BY startdate";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_tourn2 = "SELECT *, tournaments.tourn_class as tourn_class, tournaments.tourn_type as comp_type FROM tournaments Left Join calendar on tournaments.tourn_id = calendar.tourn_id WHERE tourn_year = YEAR(CURDATE()) AND tournaments.tourn_type='Billiards' AND status='Open' ORDER BY startdate";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_tourn_closed = "SELECT *, tournaments.tourn_class as tourn_class, tournaments.tourn_type as comp_type FROM tournaments Left Join calendar on tournaments.tourn_id = calendar.tourn_id WHERE tourn_year = YEAR(CURDATE()) AND status=('Closed') ORDER BY startdate";
...
<table width="1000" align="center" cellpadding="5" cellspacing="5">
  ...
  <tr>
    ...
    <td align="center" nowrap class="greenbg" colspan='5'><a href="../Admin_DB_VBSA/export_tournament_csv.php">Export Calendar/Tournament List (test)</a></td>
  </tr>
  <!--<tr>
