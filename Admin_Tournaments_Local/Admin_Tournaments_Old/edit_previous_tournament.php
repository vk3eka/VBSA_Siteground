...
$query_tourn1 = "Select * FROM calendar left join tournaments On tournaments.tourn_id=calendar.tourn_id WHERE calendar.event_id = '$event_id'";
...
//echo("ID " . $event_id . "<br>");
//echo("ID " . $row_tourn1['event_id'] . "<br>");
...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="2" class="greenbg">
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" >
    ...
    <tr valign="baseline">
        ...
        <td><select name="tourn_type">
          ...
          <!--<option value="<?php echo($row_tourn1['tourn_type']); ?>" selected><?php echo($row_tourn1['tourn_type']); ?></option>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Current Players:</td>
      <td>&nbsp;</td>
      <td><?= $total_players ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Current Tournament Size:</td>
      <td>&nbsp;</td>
      <td><?= $tourn_size ?></td>
    </tr>
    <tr valign="baseline">
  ...
  <table width="600" border='0' align="center" class="page">
    ...
    <tr>
      <td align="center"><input type="text" name="ave_time_best_of_128" value="<?= $row_tourn1['ave_time_best_of_128'] ?>" size="10" /></td>
      <td align="center"><input type="text" name="ave_time_best_of_64" value="<?= $row_tourn1['ave_time_best_of_64'] ?>" size="10" /></td>
      <td align="center"><input type="text" name="ave_time_best_of_32" value="<?= $row_tourn1['ave_time_best_of_32'] ?>" size="10" /></td>
      <td align="center"><input type="text" name="ave_time_best_of_16" value="<?= $row_tourn1['ave_time_best_of_16'] ?>" size="10" /></td>
      <td align="center"><input type="text" name="ave_time_best_of_8" value="<?= $row_tourn1['ave_time_best_of_8'] ?>" size="10" /></td>
      <td align="center"><input type="text" name="ave_time_best_of_semis" value="<?= $row_tourn1['ave_time_best_of_4'] ?>" size="10" /></td>
      <td align="center"><input type="text" name="ave_time_best_of_finals" value="<?= $row_tourn1['ave_time_best_of_2'] ?>" size="10" /></td>
      </td>
    </tr>-->
     <tr>
      <td align="center" colspan="8">&nbsp;</td>
...
<!--
    ...
    <tr>
      ...
      <td align="center"><input type="text" class="timepicker" name="startdate1" value="<?= $row_tourn1['time_128'] ?>" size="10" /></td>
      <td align="center"><input type="text" class="timepicker" name="startdate2" value="<?= $row_tourn1['time_64'] ?>" size="10" /></td>
      <td align="center"><input type="text" class="timepicker" name="startdate3" value="<?= $row_tourn1['time_32'] ?>" size="10" /></td>
      <td align="center"><input type="text" class="timepicker" name="startdate4" value="<?= $row_tourn1['time_16'] ?>" size="10" /></td>
      <td align="center"><input type="text" class="timepicker" name="startdate5" value="<?= $row_tourn1['time_8'] ?>" size="10" /></td>
      <td align="center"><input type="text" class="timepicker" name="startdate6" value="<?= $row_tourn1['time_4'] ?>" size="10" /></td>
      <td align="center"><input type="text" class="timepicker" name="startdate7" value="<?= $row_tourn1['time_2'] ?>" size="10" /></td>
      </td>
    </tr>-->
  </table>
  <br>
  ...
  <table width="700" style='border: 1px solid black; border-collapse: collapse' align="center" class="page">
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><select name="tourn_director">
        <?php
        // get list of members
        $query_member = 'Select MemberID, FirstName, LastName FROM members Where MemberID != 1 Order by LastName';
        $result_member = mysql_query($query_member, $connvbsa) or die(mysql_error());
        echo("<option value='" .  $row_tourn1['tourn_director'] . "'>" . $row_tourn1['tourn_director'] . "</option>");
        //echo("<option value=''>&nbsp;</option>");
        while($build_member = $result_member->fetch_assoc())
        {
           echo("<option value='" . $build_member['FirstName'] . " " . $build_member['LastName'] . "'>" . $build_member['FirstName'] . " " . $build_member['LastName'] . "</option>");
        }
        ?>
      </select></td>
    </tr>
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><select name="referee_early">
        <?php
        // get list of members
        $query_member = 'Select MemberID, FirstName, LastName FROM members Where MemberID != 1 Order by LastName';
        $result_member = mysql_query($query_member, $connvbsa) or die(mysql_error());
        echo("<option value='" .  $row_tourn1['referee_early'] . "'>" . $row_tourn1['referee_early'] . "</option>");
        while($build_member = $result_member->fetch_assoc())
        {
           echo("<option value='" . $build_member['FirstName'] . " " . $build_member['LastName'] . "'>" . $build_member['FirstName'] . " " . $build_member['LastName'] . "</option>");
        }
    ...
    <tr valign="baseline">
      ...
      <td>&nbsp;</td>
      <td><select name="referee_later">
        <?php
        // get list of members
        $query_member = 'Select MemberID, FirstName, LastName FROM members Where MemberID != 1 Order by LastName';
        $result_member = mysql_query($query_member, $connvbsa) or die(mysql_error());
        echo("<option value='" .  $row_tourn1['referee_later'] . "'>" . $row_tourn1['referee_later'] . "</option>");
        while($build_member = $result_member->fetch_assoc())
        {
           echo("<option value='" . $build_member['FirstName'] . " " . $build_member['LastName'] . "'>" . $build_member['FirstName'] . " " . $build_member['LastName'] . "</option>");
        }
