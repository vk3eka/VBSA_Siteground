...
$page = "http://www.vbsa.org.au/Admin_Tournaments/tournament_detail.php?searchthis=$searchthis"  ;
$_SESSION['page'] = $page; 
...
$query_players_confirmed = "SELECT ID, tournament_number AS TournID, MemberID, CONCAT(FirstName, ' ', LastName) AS FullName, Email, MobilePhone, amount_entry, how_paid, entry_confirmed, (CASE WHEN memb_by IS NOT NULL then 'Yes' WHEN memb_by IS NULL then 'No' end) AS memb, seed, tourn_date_ent, entered_by, ranknum, wcard, rank_pts, junior_cat FROM tourn_entry, members  LEFT JOIN rank_S_open_tourn ON memb_id=MemberID WHERE tournament_number = '$tourn_id' AND MemberID=tourn_memb_id AND entry_confirmed=1 ORDER BY FirstName, junior_cat";
...
//echo("SQL " . $query_players_confirmed . "<br>");
mysql_select_db($database_connvbsa, $connvbsa);
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_dup_seed = "SELECT tourn_entry.seed, tourn_memb_id, FirstName, LastName FROM tourn_entry LEFT JOIN members ON MemberID = tourn_memb_id  INNER JOIN (SELECT seed FROM tourn_entry WHERE tourn_entry.tournament_number= '$tourn_id' GROUP BY tourn_entry.seed HAVING count(seed) > 1) dup ON tourn_entry.seed = dup.seed";
...
<table width="1100" align="center">
  ...
  <tr>
    ...
    <td align="center" class="greenbg"><a href="<?php echo $_SESSION['tourn_page'] ?>?tourn_year=<?php echo $tourn_year; ?>">Return to Previous page</a></td>
    <td align="right">&nbsp;</td>
  </tr>
  <tr>
...
<table align="center" cellpadding="5" cellspacing="5">
      ...
      <?php do { ?>
        <tr class="page">
          ...
          <td align="center"><?php echo $row_players_confirmed['seed']; ?></td>
          ...
          <td align="center"><?php echo $row_players_confirmed['wcard']; ?></td>
          <td align="center"><?php echo $row_players_confirmed['rank_pts']; ?></td>
          <td align="center"><?php echo $row_players_confirmed['ranknum']; ?></td>
          <td align="center"><?php echo $row_players_confirmed['junior_cat']; ?></td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2">3. From the &quot;Recordset fields&quot; select &quot;Email&quot;. Click the <img src="../Admin_DB_VBSA/php_mail_merge/dynamic_e.gif" alt="1" width="17" height="17" /> button and it will add this field into the &quot;To&quot; field.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;&nbsp;&nbsp;click the <img src="../Admin_DB_VBSA/php_mail_merge/dynamic_t.gif" alt="1" /> button and it will add a field that will reflect the first name of the person to receive the email</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<?php //include("../Admin_DB_VBSA/php_mail_merge.php"); ?>
</form>
<script language="javascript" src="../Admin_DB_VBSA/php_mail_merge/php_mail_merge.js" type="text/javascript">
</script>
