...
$query_tourn1 = "Select calendar.*, tournaments.tourn_id as tournID, tournaments.tourn_type as tournType FROM calendar left join tournaments On tournaments.tourn_id=calendar.tourn_id WHERE calendar.event_id = $event_id";
