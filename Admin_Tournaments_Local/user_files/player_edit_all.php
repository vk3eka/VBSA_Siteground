...
$query_players1 = "SELECT members.MemberID, members.LastName, members.FirstName, tourn_entry.ID, tourn_entry.tourn_memb_id, tourn_entry.tournament_number, tourn_entry.amount_entry, tourn_entry.entered_by, tourn_entry.how_paid, tourn_entry.seed, tourn_entry.junior_cat, tourn_entry.tourn_date_ent, tourn_entry.ranked, tourn_entry.wcard, members.Email, members.MobilePhone, tourn_entry.rank_pts FROM tourn_entry, members WHERE tournament_number ='$tourn_id' AND members.MemberID=tourn_memb_id ORDER BY tourn_entry.junior_cat, members.FirstName";
