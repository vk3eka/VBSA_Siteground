...
$query_memb = "SELECT MemberID, LastName, FirstName, MobilePhone, Email, Club, Paid, Captain, LastUpdated, UpdateBy, Playing, Pennant, Willis, Billiards FROM XXArchive_members_2010 WHERE XXArchive_members_2010.Paid is not Null ORDER BY {$sqlorderby_memb}";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_CountMemb = "SELECT COUNT(Paid) FROM XXArchive_members_2010 WHERE XXArchive_members_2010.Paid is not Null  ";
...
<table width="715" align="center">
  <tr>
    <td width="264">Total 2010 Members</td>
