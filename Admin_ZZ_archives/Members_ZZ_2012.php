...
$query_memb = "SELECT MemberID, LastName, FirstName, MobilePhone, Email, Club, Paid, Captain, LastUpdated, UpdateBy, Playing, Pennant, Willis, Billiards FROM XXArchive_members_2012 WHERE XXArchive_members_2012.Paid is not Null ORDER BY {$sqlorderby_memb}";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_CountMemb = "SELECT COUNT(Paid) FROM XXArchive_members_2012 WHERE XXArchive_members_2012.Paid is not Null  ";
...
<table width="715" align="center">
  <tr>
    <td width="264">Total 2012 Members</td>
...
<tr>
    <td width="2500"><table border="1" align="center" class="page">
      ...
      <tr>
        ...
        <td><?php echo $row_memb['MobilePhone']; ?></td>
