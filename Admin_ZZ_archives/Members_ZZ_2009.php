...
$query_memb = "SELECT MemberID, LastName, FirstName, MobilePhone, Email, Club, Paid, Captain, LastUpdated, UpdateBy, Playing, Pennant, Willis, Billiards FROM XXArchive_members_2009 WHERE XXArchive_members_2009.Paid is not Null ORDER BY {$sqlorderby_memb}";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_CountMemb = "SELECT COUNT(Paid) FROM XXArchive_members_2009 WHERE XXArchive_members_2009.Paid is not Null  ";
...
<table width="715">
  <tr>
    <td width="264">Total 2009 Members</td>
...
<tr>
    <td width="2500"><table border="1" class="page">
      <tr>
        ...
        <td>Mobile Phone</td>
        <td>Email</td>
        <td><a href="<?Php echo ($tfm_orderbyURL); ?>Club">Club</a></td>
