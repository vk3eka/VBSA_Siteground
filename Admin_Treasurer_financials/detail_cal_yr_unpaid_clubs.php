...
$query_inv_det = sprintf("SELECT * FROM inv_to WHERE inv_cal_year = %s AND inv_status<> 'Paid' AND club_id is not null ORDER BY {$sqlorderby_inv_det}", GetSQLValueString($colname_inv_det, "date"));
