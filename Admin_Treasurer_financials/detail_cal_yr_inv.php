...
$query_inv_det = sprintf("SELECT * FROM inv_to WHERE inv_cal_year = %s AND inv_to.inv_paid_amount=inv_amount_total AND club_id is null ORDER BY {$sqlorderby_inv_det}", GetSQLValueString($colname_inv_det, "date"));
...
<table width="1000" align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td align="center" class="red_bold"><?php echo $row_fin_cal_year['cal_year']; ?> CALENDAR YEAR INVOICES (Not Clubs)</td>
