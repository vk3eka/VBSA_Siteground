...
$query_teamSnook = "Select COUNT( Team_entries.team_grade ) AS teams, team_grade, day_played, grade_name, fix_upload, team_season, comptype, current FROM Team_entries LEFT JOIN Team_grade ON grade=team_grade AND season=team_season AND team_cal_year=fix_cal_year WHERE team_season ='$season' AND include_draw = 'Yes'  AND type='Snooker' AND team_cal_year = YEAR( CURDATE( ) ) AND current = 'Yes' GROUP BY team_grade, day_played, team_season, comptype ORDER BY day_played, team_grade";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_teamBill = "Select COUNT( Team_entries.team_grade ) AS teams, team_grade, day_played, grade_name, fix_upload, team_season, comptype, current FROM Team_entries LEFT JOIN Team_grade ON grade=team_grade AND season=team_season AND team_cal_year=fix_cal_year WHERE team_season = '" . $season . "' AND include_draw = 'Yes' AND type='Billiards' AND team_cal_year = YEAR( CURDATE( ) ) AND current = 'Yes' GROUP BY team_grade, day_played, team_season, comptype ORDER BY day_played, team_grade";
...
mysql_select_db($database_connvbsa, $connvbsa);
$query_Tot_Inc = "Select SUM(players*9*14) AS TotInc FROM Team_entries WHERE team_name != 'Bye' AND team_season='$season' AND team_cal_year = YEAR( CURDATE( ) )";
...
<table width="700" align="center">
  ...
  <tr>
    <td colspan='5' align="center">Total Playing Positions = <?php echo $row_Tot_Players['TotPositions']; ?>. Total Teams = <?php echo $row_team_count['totalteams']; ?>. Total Approx Income $<?php echo $row_Tot_Inc['TotInc']; ?> (Based on $9 per player per round over 14 rounds)</td>
    ...
    <td>$<?php echo $row_Tot_Inc['TotInc']; ?> (Based on $9 per player per round over 14 rounds)</td>-->
  </tr>
  <!--<tr>
    <td align="right">Total Playing Positions </td>
    <td><?php echo $row_Tot_Play_Positions['TotPositions']; ?></td>
...
<table width="900" align="center" cellpadding="3" cellspacing="3" class="greenbg">
    ...
    <table width="1120" align="center">
      ...
      <tr>
        <td class="greenbg_menu"><a href="../Admin_update_tables/Update_Scores_Rank.php?season=<?php echo $season; ?>">Calculate  tables</a></td>
      ...
      <tr>
        <td class="greenbg_menu" width="300" align="left"><a href="../admin_scores/team_rego_fees.php?season=<?php echo $season; ?>&year=<?php echo date('Y'); ?>">Pennant Billing Reports</a></td>
        <td>Pennant Billing Reports for all teams/clubs for <?php echo $season; ?>.</td>
      </tr>
      <tr>
        <td colspan="2" align="left" class="red_bold">&nbsp;</td>
      </tr>
      <tr>
        <td class="greenbg_menu" width="300" align="left"><a href="../Admin_rankings/team_assessment.php?season=<?php echo $season; ?>">Pennant Snooker Team & Player Assessment</a></td>
        <td><?php echo $season; ?> snooker team assessment for all players.</td>
      </tr>
      <!--<tr>
      ...
      <!--<tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures_Orig/fixture_data_object_ai.php?DayPlayed=Mon&season=<?php echo $season; ?>">Test (AI) Generated Fixtures for <?php echo $season; ?> (Mon)</a></td>
        <td class="greenbg_menu">Generate Fixtures for all grades playing Monday for <?php echo $season; ?>. Fixtures alogrithm for 6, 8, 10, 12 and 14 teams available with 4 or 6 team finals.</td>
      </tr>-->


      <tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures/fixture_data_object.php?DayPlayed=Mon&season=<?php echo $season; ?>">Generate Fixtures for <?php echo $season; ?> (Mon)</a></td>
        <td class="greenbg_menu">Generate Fixtures for all grades playing Monday for <?php echo $season; ?>. Fixtures alogrithm for 6, 8, 10, 12 and 14 teams available with 4 or 6 team finals.</td>
      </tr>
      <tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures/fixture_data_object.php?DayPlayed=Wed&season=<?php echo $season; ?>">Generate Fixtures for <?php echo $season; ?> (Wed)</a></td>
        <td class="greenbg_menu">Generate Fixtures for all grades playing Wednesday for <?php echo $season; ?>. Fixtures alogrithm for 6, 8, 10, 12 and 14 teams available with 4 or 6 team finals.</td>
      </tr>
      <tr>
        <td colspan="2" align="left" class="red_bold">&nbsp;</td>
      </tr>
      <tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures/generate_fixtures.php?DayPlayed=Mon&season=<?php echo $season; ?>">Refine/Review Fixtures for <?php echo $season; ?> (Mon)</a></td>
        <td class="greenbg_menu">Refine/Review Fixtures for all grades playing Monday for <?php echo $season; ?></td>
      </tr>
      <tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures/generate_fixtures.php?DayPlayed=Wed&season=<?php echo $season; ?>">Refine/Review Fixtures for <?php echo $season; ?> (Wed)</a></td>
        <td class="greenbg_menu">Refine/Review Fixtures for all grades playing Wednesday for <?php echo $season; ?></td>
      </tr>
      <!--<tr>
        <td colspan="2" align="left" class="red_bold">&nbsp;</td>
      </tr>
      <tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures/fixture_data_object.php?DayPlayed=Wed&season=<?php echo $season; ?>">Generate Fixtures for <?php echo $season; ?> (Wed)</a></td>
        <td class="greenbg_menu">Generate Fixtures for all grades playing Wednesday for <?php echo $season; ?>. Fixtures alogrithm for 6, 8, 10 and 14 teams available with 4 or 6 team finals.</td>
      </tr>
      <tr>
        <td colspan="2" align="left" class="red_bold">&nbsp;</td>
      </tr>
      ...
      <tr>
        <td class="greenbg_menu"><a href="../Admin_Fixtures/edit_fixtures.php?season=<?php echo $season; ?>">Edit Published Fixtures for <?php echo $season ?></a></td>
        <td class="greenbg_menu">Edit Published Fixtures for all grades for <?php echo $season ?></td>
      </tr>
      <tr>
        <td colspan="2" align="left" class="red_bold">&nbsp;</td>
      </tr>
      ...
      <tr>
        <td class="greenbg_menu"><a href="non_playable_dates.php?year=<?php echo date('Y'); ?>&season=<?php echo $season; ?>">Non Playable Dates </a></td>
