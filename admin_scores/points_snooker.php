...
$query_Points_B = "SELECT scrsID, scrs.MemberID, LastName, FirstName, team_grade, team_id, pts_won, count_played, percent_won, scr_season FROM scrs  LEFT JOIN members ON members.MemberID = scrs.MemberID WHERE current_year_scrs = YEAR( CURDATE( ) )  AND game_type = 'Snooker' AND pts_won >0 AND scr_season='$season' ORDER BY pts_won DESC";
$Points_B = mysql_query($query_Points_B, $connvbsa) or die(mysql_error());

//echo("Order " . $query_Points_B . "<br>");
...
<?php include '../admin_xx_includes/db_srch.php';?>
  ...
  <table width="800" border="0" align="center">
    <tr>
      <td align="left" class="red_bold">Frames Won - All players Snooker <?php echo $season ?> (where points won &gt;0)</td>
