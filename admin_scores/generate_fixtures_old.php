...
function SetDate(form_no, rounds)
{
    ...
    document.getElementById('D_' + form_no + '_date_0').value = document.getElementById('startdate_' + form_no).value;
    for(i = 0; i < rounds; i++)
    {
        document.getElementById('A_' + form_no + '_date_' + (i+1)).value = addDays(document.getElementById('A_' + form_no + '_date_' + i).value, 7).toISOString().substring(0, 10);
         document.getElementById('D_' + form_no + '_date_' + (i+1)).value = addDays(document.getElementById('A_' + form_no + '_date_' + i).value, 7).toISOString().substring(0, 10);
    }
}
...
function CountHomeGames($team_grades, $year, $season, $dayplayed)
{
    ...
    while($build_home_games = $result_home_games->fetch_assoc())
    {
        ...
        //echo("Count = " . $count[$team_name] . " for " . $team_name . "<br>");
        ...
        //echo("Count = " . $numOfTrue . " for " . $team_name . "<br>");
...
{   
    ...
    foreach($HomeTeamArray as $arr)
    {
        if(($team == $arr) && ($team != ''))
        {
            ...
            //echo("Count = " . $numOfTrue . " for home " . $arr . ", away " . $AwayTeamArray[$r] . " R = " . $r . "<br>");
        }
        $r++;
    }
    return ($numOfTrue);
