...
$page = "../admin_scores/players_qual_finals.php?season=$season";
$_SESSION['page'] = $page;
...
$query_qual_play = "SELECT scrsID, scrs.MemberID, FirstName, LastName, MobilePhone, Email, scrs.team_grade, scrs.team_id, game_type, count_played,  captain_scrs, scr_season, audited, team_name, team_club, byes_to_date FROM scrs  LEFT JOIN members ON members.MemberID = scrs.MemberID  LEFT JOIN Team_entries ON Team_entries.team_id=scrs.team_id WHERE scr_season = '$season' AND current_year_scrs = YEAR(CURDATE( )) AND scrs.MemberID != 1 HAVING audited='No' ORDER BY team_grade, team_id, FirstName, LastName";
//echo("Current " . $query_qual_play . "<br>");
...
<?php include '../admin_xx_includes/db_srch.php';?>
    ...
    <table align="center" cellpadding="3" cellspacing="3">
      ...
      <tr>
        <td class="red_bold">All <?php echo $season ?> (Billiards &amp; Snooker) qualified for finals in the current year</td>
      ...
      <tr>
        <td align="center">Total qulified players: <?php echo $totalRows_qual_play ?></td>
        <td align="right">&nbsp;</td>
      </tr>
    </table>
<table align="center" cellpadding="5" cellspacing="5" class="page">
      ...
      <?php do { 
        ...
        <tr>
          ...
          <td align="left"><?php echo $row_qual_play['team_club']; ?></td>
          <td align="left"><a ><?php echo $row_qual_play['team_name']; ?></a><a target="_blank"></a></td>
