...
if (isset($_GET['clubid'])) {
  $colname_vbsaclubs = $_GET['clubid'];
}
mysql_select_db($database_connvbsa, $connvbsa);
$query_vbsaclubs = sprintf("SELECT ClubNumber, ClubTitle, ClubNameVBSA, ClubContact, ClubTables, VBSAteam FROM clubs WHERE VBSAteam=1 AND ClubNumber=%s ORDER BY ClubTitle", GetSQLValueString($colname_vbsaclubs, "int"));
...
$editFormAction = 'ajax/team_entries_insert.php';
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="return doit()">
  <table align="center" cellpadding="5" cellspacing="5">
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" class="pagetitle">This will insert a team for  <?php echo $row_vbsaclubs['ClubTitle']; ?> into Season <?php echo $season; ?></td>
    </tr>
    <tr valign="baseline">
