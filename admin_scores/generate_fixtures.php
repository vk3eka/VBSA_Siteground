...
echo("</tr>");
echo("<tr>");
echo('<td colspan="8" align="center">' . $team_grade . ' Table Sort By:-&nbsp;');
echo('<select name="sort_order" id="sort_order" onchange="GetSort(this, $form_no, $season, $year , $dayplayed. $team_grade)">');   
if(!isset($_POST['Sortby']))
{
    echo('<option value="fix_sort" selected>Table Sort</option>');
}
...
echo('<td colspan="7" align="center">Table Sort By:-&nbsp;');
echo('<select name="sort_order" id="sort_order" onchange="GetSort(this, $form_no, $season, $year , $dayplayed. $team_grade)">');   
if(!isset($_POST['Sortby']))
{
    echo('<option value="fix_sort" selected>Table Sort</option>');
