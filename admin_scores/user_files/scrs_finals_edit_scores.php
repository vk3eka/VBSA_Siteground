...
if(isset($_POST["SF1"])) {
    ...
    SF2_pos = %s,
		GF_pos = %s
		WHERE scrsID = %d",
		GetSQLValueString($_POST["EF1"][$i], "int"),
		GetSQLValueString($_POST["EF2"][$i], "int"),
    GetSQLValueString($_POST["SF1"][$i], "int"),
    GetSQLValueString($_POST["SF2"][$i], "int"),
		GetSQLValueString($_POST["GF"][$i], "int"),
		GetSQLValueString($_POST["EF1_pos"][$i], "int"),
		GetSQLValueString($_POST["EF2_pos"][$i], "int"),
  ...
  $Result1 = mysql_query($updateSQL, $connvbsa) or die(mysql_error());
    //echo("Scores update ". $updateSQL . "<br>");
...
<table width="800" border="0" align="center">
  <tr>
    <td align="left" class="red_bold">Edit Finals scores</td>
  ...
  do { ?>
      ...
      <table width="425" border="1" align="center">
        ...
        <tr>
          ...
          {
          ?>
            <td width="40"><input name="EF1[]" type="text" id="EF1<?php echo($counter);?>" value="<?php echo $row_Team_Score_Edit['EF1']; ?>" size="2" /></td>
            <td width="40"><input name="EF2[]" type="text" id="EF2<?php echo($counter);?>" value="<?php echo $row_Team_Score_Edit['EF2']; ?>" size="2" /></td>
          <?php 
          }
          else
          {
          ?>
            <input name="EF1[]" type="hidden" id="EF1<?php echo($counter);?>">
            <input name="EF2[]" type="hidden" id="EF2<?php echo($counter);?>">
          <?php
          }
          ?>
        ...
        <tr>
          ...
          {
          ?>
            <td width="40"><input name="EF1_pos[]" type="text" id="EF1_pos<?php echo($counter);?>" value="<?php echo $row_Team_Score_Edit['EF1_pos']; ?>" size="2" /></td>
            <td width="40"><input name="EF2_pos[]" type="text" id="EF2_pos<?php echo($counter);?>" value="<?php echo $row_Team_Score_Edit['EF2_pos']; ?>" size="2" /></td>
          <?php 
          }
          else
          {
          ?>
            <input name="EF1_pos[]" type="hidden" id="EF1_pos<?php echo($counter);?>">
            <input name="EF2_pos[]" type="hidden" id="EF2_pos<?php echo($counter);?>">
          <?php
          }
          ?>
   ...
   <div align="center"> <input name="submit" value="Update finals scores" type="submit" /></div>
</form>
