...
// get bye id
$query_byes = "SELECT ClubTitle, ClubNumber FROM clubs WHERE ClubTitle='Bye'";
$byes = mysql_query($query_byes, $connvbsa) or die(mysql_error());
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Team_entries (team_id, team_name, team_grade, team_club, team_club_id, team_season, day_played, players, Final5, include_draw, audited, team_cal_year, comptype) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
             GetSQLValueString($_POST['team_id'], "int"),
             GetSQLValueString($_POST['team_name'], "text"),
             GetSQLValueString($_POST['team_grade'], "text"),
             GetSQLValueString($_POST['club_name'], "text"),
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="club_id" value="<?= $row_byes['ClubNumber'] ?>" size="5" readonly/> (Auto entered)</td>
      <!--<td name="club_id"><?php echo $row_byes['ClubNumber']?>  (Auto entered)</td>-->
    </tr>

    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Club Title</td>
      <td><input type="text" name="club_name" value="<?= $row_byes['ClubTitle'] ?>" size="5" readonly/> (Auto entered)</td>
      <!--<td name="club_name"><?php echo $row_byes['ClubTitle']?>  (Auto entered)</td>-->
    </tr>
    <tr valign="baseline">
