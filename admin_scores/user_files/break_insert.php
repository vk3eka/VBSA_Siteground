...
if ((((isset($_POST["Submit"]))?$_POST["Submit"]:"") != "")) // Trigger
{
  ...
  $WA_table = "breaks";
  $WA_redirectURL = "../scores_ladders.php?&grade=".$grade."&comptype=".$comptype."&season=".$season;
...
<table align="center">
  ...
  <tr>
    <td align="center" class="red_bold">Insert <?php echo $row_breaks_ins['comptype']; ?> Breaks for:<?php echo $row_breaks_ins['team_name']; ?> (Team ID: <?php echo $row_breaks_ins['team_id']; ?> ) in <?php echo $row_breaks_ins['team_grade']; ?> Season : <?php echo $season; ?></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
...
?>
      <tr>
        ...
        <td><input name="brk_<?php echo $RepeatSelectionCounter_1; ?>" type="text" id="brk_<?php echo $RepeatSelectionCounter_1; ?>" size="10" />
          ...
          <input name="finals_brk_<?php echo $RepeatSelectionCounter_1; ?>" type="hidden" value="No" />
