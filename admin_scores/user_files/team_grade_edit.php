...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("Update Team_grade SET grade_name=%s, season=%s, type=%s, RP=%s, fix_upload=%s, fix_cal_year=%s, current=%s, finals_teams=%s, dayplayed=%s, min_breaks=%s, no_of_matches=%s, no_of_rounds=%s, no_of_players=%s, games_round=%s, tier1_rp=%s, tier2_rp=%s, tier3_rp=%s, tier4_rp=%s, tier5_rp=%s, tier6_rp=%s, tier7_rp=%s, tier8_rp=%s, tier9_rp=%s, tier10_rp=%s, tier11_rp=%s, tier12_rp=%s WHERE grade=%s",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1"  >
  <table align="center" cellpadding="5" cellspacing="5">
    ...
    <tr valign="baseline">
      ...
      <td><input type='text' name='RP' id='RP' style='width : 30px;' value='<?= $row_teamgrades_fix['RP'] ?>'></td>
    </tr>
    </table>
    ...
    <tr>
      <td align='center'><input type='text' name='rank_points_7' id='rank_points_7' style='width : 30px;' value='<?= $row_teamgrades_fix['tier7_rp'] ?>'></td>
      <td align='center'><input type='text' name='rank_points_8' id='rank_points_8' style='width : 30px;' value='<?= $row_teamgrades_fix['tier8_rp'] ?>'></td>
      <td align='center'><input type='text' name='rank_points_9' id='rank_points_9' style='width : 30px;' value='<?= $row_teamgrades_fix['tier9_rp'] ?>'></td>
      <td align='center'><input type='text' name='rank_points_10' id='rank_points_10' style='width : 30px;' value='<?= $row_teamgrades_fix['tier10_rp'] ?>'></td>
      <td align='center'><input type='text' name='rank_points_11' id='rank_points_11' style='width : 30px;' value='<?= $row_teamgrades_fix['tier11_rp'] ?>'></td>
      <td align='center'><input type='text' name='rank_points_12' id='rank_points_12' style='width : 30px;' value='<?= $row_teamgrades_fix['tier12_rp'] ?>'></td>
    </tr>
  </table>
  <table align="center" cellpadding="5" cellspacing="5" width='500px'>
    <tr>
